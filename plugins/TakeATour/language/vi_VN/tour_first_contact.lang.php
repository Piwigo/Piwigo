...
// | USA.                                                                  |
// +-----------------------------------------------------------------------+
$lang['first_contact_stp1'] = 'Hi! Tôi sẽ hướng dẫn bạn về piwigo. Hãy làm theo hướng dẫn, ấn nút Next(Hoặc sử dụng phím mũi tên trên bàn phím) để điều hướng. Nếu bạn đi đến một trang khác thuộc quyền của bạn, bạn sẽ được chuyển đến trang hiện tại, nếu bạn không thể kết thúc phần tìm hiểu bạn hãy vào <em>Plugin >> Take A tour </em> để kết thúc . Nào, giờ ta bắt đầu bằng việc Thêm hình ảnh!';
$lang['first_contact_stp2'] = 'Liên kết ở đây, ấn vào đây hoặc ấn vào Next để tiếp tục';
$lang['first_contact_stp18'] = 'Để thấy làm sao quản lý album. Ấn vào <em>On album » Manage</em> or chọn Next';
$lang['first_contact_stp22'] = 'Như cho hình ảnh, tại đây có thể chỉnh sữa thuộc tính của album';
$lang['first_contact_stp28'] = 'Giờ chúng ta thấy những lựa chọn để cấu hình Piwigo hoạt động theo cách của bạn. Ấn vào cấu hình -> lựa chọn hoặc chỉ ấn Next';
$lang['first_contact_stp30'] = 'Hãy bắt đầu để thay đổi tiêu đề';
$lang['first_contact_stp16'] = '...trong đó một album( hoặc nhiều album) là hình ảnh.<br><br> vì vậy bạn có thể thêm hoặc bớt hình ảnh trong albums. liên kết không có thật. Không hình ảnh sẽ không hiển thị khi di chuyển qua nó.';
...
$lang['first_contact_stp4'] = 'Đầu tiên chọn một album, nếu chưa có bạn nên tạo một album mới';
...
$lang['first_contact_stp7'] = 'Tại đây là tóm tắt các hình bạn tải lên. Ta thấy Piwigo có tự tạo ra những hình thu nhỏ. Bạn có thể:<ul><li> Quản lý tất cả những bức hình tải lên tại khu quản lý toàn bộ</li><li>chỉnh sửa thuộc tính của hình ảnh bằng cách ấn vào nó</li><li> thêm nhiều hình ảnh</li>';