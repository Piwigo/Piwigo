...
$lang['first_contact_stp14'] = '现在让我们来看看单张图片的编辑页面。该页面可以从这里进入，也可以从公开的图片展示页面进入（在以管理员身份登陆的情况下）。点击 编辑 或进入下一步。';
...
$lang['privacy_descrp'] = '本导览向您展示通过涵盖每个相册及每张图片的许可体系保护您的图片免于公共访问的各种方法，以及通过图片保护防止拷贝。';