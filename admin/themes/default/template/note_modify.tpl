...
<form action="{$F_ACTION}" method="post" id="pictureModify" class='note-modify-form'>
<!--
{if $INTRO.is_svg}
...
-->
  <div id='picture-content' class='note-modify-content'>
...
-->
      <div id='picture-preview'>
        <div class='picture-preview-actions'>
          ...
          <img src="{$TN_SRC}" alt="{'Thumbnail'|translate}" class="other-image-format" style="width:auto; height:auto; position:static; transform:none; padding: 2em;">
      </div>
