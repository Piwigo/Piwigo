  ...
  $service->addMethod(
      ...
      array_merge(array(
        ...
        'recursive' =>  array('default'=>false,
                              'type'=>WS_TYPE_BOOL),
        'derivatives' => array('default'=>true,
                              'type'=>WS_TYPE_BOOL,
                              'info'=>"if false, the derivatives won't be returned (default is true)"),
        'categories' =>  array('default'=>true,
                              'type'=>WS_TYPE_BOOL,
                              'info'=>"if false, the categories won't be returned (default is true)"),
