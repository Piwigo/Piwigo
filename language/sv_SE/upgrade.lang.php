...
$lang['This page proposes to upgrade your database corresponding to your old version of Piwigo to the current version. The upgrade assistant thinks you are currently running a <strong>release %s</strong> (or equivalent).'] = 'Denna sida föreslår att du ska uppgradera databasen från din gamla versionen till den nya versionen. Uppgraderingsassistenten tycker att du för närvarande kör en <strong>versionen %s </strong> (eller motsvarande).';
...
$lang['Only thumbnails prefix and webmaster mail address have been saved from previous configuration'] = 'Endast miniatyrbilder prefix och webmaster e-postadress har sparats från tidigare konfiguration';
$lang['In <i>%s</i>, before <b>?></b>, insert:'] = 'I <i>%s</i>, innan <b>?></b>, infoga:';
$lang['As a precaution, following themes have been deactivated. You must check for themes upgrade before reactiving them:'] = 'Som en försiktighetsåtgärd, har följande teman har avaktiverats. Du måste kolla tema uppgraderingar innan du aktiverar dem:';
