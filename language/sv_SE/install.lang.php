...
$lang['Default gallery language'] = 'Standardspråk för galleriet';
...
$lang['Visitors will be able to contact site administrator with this mail'] = 'Besökare kommer att kunna kontakta sidans administratör med denna e-postadress';
$lang['PHP 5 is required'] = 'PHP 5 krävs';
$lang['PHP version %s required (you are running on PHP %s)'] = 'PHP version %s krävs (du använder just nu PHP %s)';
