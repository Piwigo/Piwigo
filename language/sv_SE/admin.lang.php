...
$lang['A photo library administrator has created the following account for you:'] = 'En bildbiblioteksadministratör har skapat följande konto åt dig:';
$lang['An activation link valid for %s has been sent to "%s". If the user doesn\'t receive the link, you can generate and copy a new one by editing the user and managing her password.'] = 'En aktiveringslänk som är giltig för %s har skickats till "%s". Om länken inte tas emot kan en ny genereras och kopieras genom att redigera användaren och hantera deras lösenord.';
$lang['An activation link valid for %s was created but could not be sent. You can now copy the link below and send it to the user.'] = 'En aktiveringslänk som är giltig för %s skapades men kunde inte skickas. Du kan nu kopiera länken nedan och skicka den till användaren.';
$lang['This link is valid for %s. After this time, you will need to request a new link.'] = 'Denna länk är giltig för %s. Efter denna tid måste du begära en ny länk.';
...
$lang['user_status_normal'] = 'Enkel';
$lang['Change logo'] = 'Ändra logo';
$lang['Dark mode'] = 'Mörkt läge';
$lang['Display Gallery title'] = 'Visa gallerititel';
$lang['Light mode'] = 'Ljust läge';
$lang['Personalization settings'] = 'Personlighetsinställningar';
$lang['Select a color theme for standard pages'] = 'Välj ett färgtema för standardsidor';
$lang['Standard pages'] = 'Standardsidor';
$lang['Standard pages aren\'t activated, however you have %d active themes that will still use them. These themes are:'] = 'Standardsidor är inte aktiverade men du har dock %d aktiva teman som fortfarande använder dem. Dessa teman är:';
$lang['Standard pages header'] = 'Standard sidhuvud';
$lang['Use Piwigo logo'] = 'Använd Piwigo logo';
$lang['Use custom logo (png, jpeg or svg)'] = 'Använd egen logo (png, jpeg eller svg)';
$lang['Two container updates are available'] = 'Två containeruppdateringar är tillgängliga';
$lang['Follow the update guide'] = 'Följ uppdateringsguiden';
$lang['You are about to delete %s groups, are you sure?'] = 'Du kommer att radera %s grupper, är du säker?';