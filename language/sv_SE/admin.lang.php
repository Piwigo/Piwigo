...
$lang['Use the default photo sort order'] = 'Använd standard ordning för bild sortering)';
...
$lang['File'] = 'Fil';
$lang['first photo added on %s'] = 'första elementet tillagt på %s';
...
$lang['Include display of recent photos grouped by dates'] = 'Inkludera display av tidigare bilder grupperat efter datum';
...
$lang['photos updated in the database'] = 'element i databasen uppdaterade';
...
$lang['Purge history detail'] = 'Rensa historik detaljer';
...
$lang['%s must be to set to false in your local/config/config.inc.php file'] = '%s måste ställas in som falsk i din lokala konfigurationsfil: /config/config.inc.php';
...
$lang['add new photos to caddie'] = 'lägg till nytt element till korg';
