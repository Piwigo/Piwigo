...
$lang['Bad status for user "guest", using default status. Please notify the webmaster.'] = 'dålig status för användare \"gäst\", default status kommer används Vänligen meddela webmastern..';
...
$lang['Tag'] = 'Tagg';
$lang['Tags'] = 'Tags';
$lang['The RSS notification feed provides notification on news from this website : new pictures, updated categories, new comments. Use a RSS feed reader.'] = 'Den RSS-flöde ger information om nya händelser från denna webbplats: nya bilder, uppdaterad kategorier, nya kommentarer. Användas med en RSS-läsare.';
...
$lang['display best rated items'] = 'Visa bäst betygsatta bilderna';
$lang['caddie'] = 'Caddie';
...
$lang['Maximum height of the pictures'] = 'Maxhöjd på bilderna';
$lang['Maximum height must be a number superior to 50'] = 'Maximal höjd måste vara större än 50';
$lang['Maximum width of the pictures'] = 'Maximan bredd på bilderna';
...
$lang['Rate this picture'] = 'Betygsätt den här bilden';
$lang['Next'] = 'Nästa';
...
$lang['mail address must be like xxx@yyy.eee (example : jack@altern.org)'] = 'e-postadress måste vara som xxx@yyy.eee (exempel: jack@altern.org)';
...
$lang['%d comment to validate'] = '%d inlägg att validera';
$lang['%d comments to validate'] = '%d inlägg att validera';
$lang['N/A'] = 'N/A';
$lang['New on %s'] = 'Nya på %s';
$lang['set as category representative'] = 'Ange som kategorin företrädare';
...
$lang['the filesize of the picture must not exceed :'] = 'bildens filstorlek får inte överstiga :';
...
$lang['Optional, but recommended : choose a thumbnail to associate to'] = 'valfrit, men rekommenderad: Välj en miniatyrbild för att associera till';
...
$lang['A picture\'s name already used'] = 'Bildnamnet används redan';
...
$lang['(!) This comment requires validation'] = '(!) Denna inlägg kräver validering';
...
$lang['... or please deactivate this message, I will find my way by myself'] = '... eller vänligen avaktivera detta meddelande kommer jag hittar själv';
...
$lang['Email address is missing. Please specify an email address.'] = 'E-postadress saknas. Vänligen ange en e-postadress.';
