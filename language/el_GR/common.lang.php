...
$lang['Public key copied.'] = 'Το δημόσιο κλειδί ΑΡΙ αντιγράφτηκε.';
...
$lang['Save your secret Key and ID'] = 'Σώστε το κρυφό σας Κλειδί και την ταυτότητά σας';
$lang['Secret key copied. Keep it in a safe place.'] = 'Το κρυφό κλειδί αντιγράφτηκε. Φυλάξτε το σε ένα σίγουρο μέρος.';
...
$lang['This will not be displayed again. You must copy it to continue.'] = 'Αυτό δεν θα απεικονιστεί ξανά. Πρέπει να το αντιγράψετε για να συνεχίσετε.';
