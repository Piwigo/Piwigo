...
$lang['Picture uploaded by %s'] = 'resimı Gönderen %s';
...
$lang['the filesize of the picture must not exceed :'] = 'resimın dosya büyüklüğü sınırı aşmaktadır :';
$lang['the picture must be to the fileformat jpg, gif or png'] = 'resim dosya formatı jpg, gif or png olmalıdır';
$lang['the height of the picture must not exceed :'] = 'resimın boy ebadı sınırı aşmaktadır :';
$lang['Optional, but recommended : choose a thumbnail to associate to'] = 'isteğe bağlıdır, fakat tavsiye edilen : mutlaka küçük resimı bağlantılandırın';
$lang['the width of the picture must not exceed :'] = 'resimın en ebadı sınırı aşmaktadır. :';
