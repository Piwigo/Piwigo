...
$lang['By default, Piwigo will create a new websize from the HD (high definition) version of your photo.'] = 'Varsayılan olarak, Piwiho HD (yüksek çözünürlük) resimleri için yeni bir web boyutu oluşturacak.';
...
$lang['Manage Permissions'] = 'İzinlerini Yönet';
...
$lang['Maximum file size: %sB.'] = 'En büyük dosya boyutu: %sB.';
...
$lang['%u users have automatic permission because they belong to a granted group.'] = '%u kullanıcılar otomatik izine sahiptir, çünkü izin verilmiş bir gruba ait oldukları için.';
...
$lang['A locked gallery is only visible to administrators'] = 'Kilit bir galeri sadece yöneticiler tarafından görülebilinir';
...
$lang['By default, the center of interest is placed in the middle of the photo.'] = 'Genelde, fotoğrafın odak noktası, fotoğrafın ortasında yer almaktadır.';
$lang['Cancel'] = 'İptal';
$lang['Center of interest'] = 'Odak noktası';
$lang['Default comments order'] = 'Varsayılan yorum sırası';
$lang['Delete multiple size images'] = 'Çoklu ebat görüntüleri sil';
$lang['Features include gallery browsing, album creation and photo upload.'] = 'İçerdiği özellikler, galeri göz atmak, albüm yaratmak ve fotoğraf karşıya yüklemek.';
$lang['For photo sizes with crop, such as "Square", Piwigo will do its best to include the center of interest.'] = 'Fotoğraf kırpmayla boyutlandırılır seçeneği için, örneğin "Kare", Piwigo odak noktasını içerebilmek için elinden geleni yapmaya çalışacaktır.';
...
$lang['Notify administrators when a comment is'] = 'Yöneticileri uyarı durumu: yorum';
...
$lang['Original Size'] = 'Orjinal ebat';
$lang['Permission granted for groups'] = 'Gruplar için izin verilmiştir';
$lang['Permission granted for users'] = 'Kullanıcılar için izin verilmiştir';
$lang['Permission management'] = 'İzinler yönetimi';
$lang['Photo sizes with crop'] = 'Fotoğraf kırpmayla boyutlandırılır';
...
$lang['ReGalAndroid (RemoteGallery client for Android) is an open source (GPL v3) Piwigo client for the Android platform.'] = 'ReGalAndroid (RemoteGallery client for Android) Android platformu için yazılmış açık kaynak kodlu (GPL v3) bir Piwigo istemcidir.';
...
$lang['registered users'] = 'kayıtlı kullanıcıları';
