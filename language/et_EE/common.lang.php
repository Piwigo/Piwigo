...
$lang['Return to <a href="identification.php" title="Sign in">Sign in</a>'] = 'Tagasi <a href="identification.php" title="Logi sisse">Sign in</a> lehele';
$lang['The secret key can no longer be displayed.'] = 'Salajast võtit ei saa enam kuvada.';
$lang['The email %s will be used to notify you when your API key is about to expire.'] = 'Meiliaadressi %s kasutatakse selleks, et teid teavitada, kui teie API-võti hakkab aeguma.';
$lang['The api key has been successfully created.'] = 'API-võti on edukalt loodud.';
$lang['Show expired keys'] = 'Kuva aegunud võtmed';
$lang['Set my password'] = 'Määra minu parool';
$lang['Secret copied. Keep it in a safe place.'] = 'Salajane kopeering. Hoidke seda kindlas kohas.';
$lang['Save your ID and secret'] = 'Salvesta oma ID ja salasõna';
$lang['Revoked'] = 'Tühistatud';
$lang['Revoke'] = 'Tühista';
$lang['Return to the gallery'] = 'Tagasi galeriisse';
$lang['Options'] = 'Valikud';
$lang['No expiration'] = 'Aegumistähtaega pole';
$lang['New API Key'] = 'Uus API-võti';
$lang['Never'] = 'Mitte kunagi';
$lang['Manage your account'] = 'Halda oma kontot';
$lang['Last use'] = 'Viimane kasutuskord';
$lang['Invalid verification code'] = 'Kehtetu kinnituskood';
$lang['Impossible to copy automatically. Please copy manually.'] = 'Automaatne kopeerimine pole võimalik. Palun kopeeri käsitsi.';
$lang['If your account exists, a verification code has been sent to your email address.'] = 'Kui teie konto on olemas, siis saadeti teie e-posti aadressile  kinnituskood.';
$lang['You can manage your API keys in your <a href="%s">account settings.</a>'] = 'Saate oma API-võtmeid hallata <a href="%s">konto seadetes.</a>';
$lang['You have no email address, so you will not be notified when your API key is about to expire.'] = 'Teil puudub e-posti aadress, seega ei teavitata teid, kui teie API-võti hakkab aeguma.';
$lang['Your API key will expire in %d day.'] = 'Teie API-võti aegub %d päeva pärast.';
$lang['Your API key will expire in %d days.'] = 'Teie API-võti aegub %d päeva pärast.';
$lang['Your API key will expire soon'] = 'Teie API-võti aegub peagi';
$lang['Your changes have been applied.'] = 'Teie muudatused on rakendatud.';
$lang['Your password was successfully reset'] = 'Teie parool on edukalt lähtestatud';
$lang['Your password was successfully set'] = 'Teie parool on edukalt määratud';
$lang['Your verification code'] = 'Teie kinnituskood';
$lang['edit user preferences'] = 'muuda kasutaja eelistusi';
$lang['must not be empty'] = 'ei tohi olla tühi';
$lang['When enabled, a common template is used for the login and registration pages, regardless of the theme.'] = 'Kui see on lubatud, kasutatakse sisselogimis- ja registreerimislehtede jaoks ühist malli, olenemata teemast.';
$lang['Verify'] = 'Kinnita';
$lang['Verification successful! You can now choose a new password.'] = 'Kinnitamine õnnestus! Nüüd saate valida uue parooli.';
$lang['Verification code'] = 'Kinnituskood';
$lang['Too many attempts, please try later..'] = 'Liiga palju katseid, palun proovi hiljem uuesti.';
$lang['To manage your API keys, please log in with your username/password.'] = 'API-võtmete haldamiseks logige sisse oma kasutajanime/parooliga.';
$lang['To continue using the API, please renew your key before it expires.'] = 'API kasutamise jätkamiseks palun uuendage oma võtit enne selle aegumist.';
$lang['This API key was manually revoked on %s'] = 'See API-võti tühistati käsitsi kuupäeval %s';
$lang['The secret will no longer be displayed. You must copy it to continue.'] = 'Saladust enam ei kuvata. Jätkamiseks peate selle kopeerima.';
$lang['you must choose a date'] = 'peate valima kuupäeva';
$lang['If you do not receive the email, please contact your webmaster.'] = 'Kui te e-kirja ei saa, võtke palun ühendust oma veebihalduriga.';
$lang['If you changed your password because you think it was stolen, we recommend revoking your %d API keys <a href="%s">in your profile</a>.'] = 'Kui muutsite oma parooli, kahtlusega, et see varastati, soovitame teil oma %d API-võtit <a href="%s">profiilis tühistada</a>.';
$lang['If this wasn\'t you, please change your password immediately or contact your webmaster.'] = 'Kui see ei olnud teie, siis palun muutke kohe oma parool või võtke ühendust oma veebihalduriga.';
$lang['ID copied.'] = 'ID kopeeritud.';
$lang['Hide expired keys'] = 'Peida aegunud võtmed';
$lang['Here is your verification code:'] = 'Siin on teie kinnituskood:';
$lang['Hello <em>%s</em>, enter your new password below.'] = 'Tere <em>%s</em>, sisesta allpool oma uus parool.';
$lang['Generate key'] = 'Võtme genereerimine';
$lang['Generate API Key'] = 'API-võtme genereerimine';
$lang['Expires in'] = 'Aegub pärast';
$lang['Expired on'] = 'Aegunud';
$lang['Expired'] = 'Aegunud';
$lang['Expert mode'] = 'Ekspertrežiim';
$lang['Edit API Key'] = 'Muuda API-võtit';
$lang['Duration'] = 'Kestus';
$lang['Done'] = 'Valmis';
$lang['Don\'t have an account yet ?'] = 'Sul pole veel kontot?';
$lang['Do you really want to revoke the "%s" API key?'] = 'Kas sa tõesti tahad API-võtme "%s" tühistada?';
$lang['Custom date'] = 'Kohandatud kuupäev';
$lang['Created at'] = 'Loodud kell';
$lang['Create an account'] = 'Loo konto';
$lang['Create a new API key to secure your account.'] = 'Looge oma konto kaitsmiseks uus API-võti.';
$lang['Create API Keys to secure your acount'] = 'Loo API-võtmed oma konto kaitsmiseks';
$lang['Confirm new password'] = 'Kinnitage uus parool';
$lang['Confirm my new password'] = 'Kinnita minu uus parool';
$lang['Choose how you want to see your gallery'] = 'Valige, kuidas soovite oma galeriid näha';
$lang['Check your inbox'] = 'Kontrollige oma postkasti';
$lang['Change your password'] = 'Muutke oma parool';
$lang['An error has occured please got back to <a href="identification.php" title="Sign in">Sign in</a> or <a href="register.php">Register</a>'] = 'Tekkis viga. Palun <a href="identification.php" title="logi uuesti sisse">Sign in</a>  või <a href="register.php">registreeruge</a>';
$lang['An email has been sent with a link to reset your password'] = 'Parooli lähtestamise lingiga on saadetud e-kiri';
$lang['Already have an account ?'] = 'Kas sul on juba konto?';
$lang['Account'] = 'Konto';
$lang['API Keys'] = 'API-võtmed';
$lang['API Key not found'] = 'API-võtit ei leitud';
$lang['API Key name'] = 'API-võtme nimi';
$lang['API Key has been successfully revoked.'] = 'API-võti on edukalt tühistatud.';
$lang['API Key has been successfully edited.'] = 'API-võtit on edukalt muudetud.';
$lang['4xlarge'] = '4XL - hiiglaslik';
$lang['3xlarge'] = '3XL - eriti suur';