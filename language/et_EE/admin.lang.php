...
$lang['An activation link valid for 1 hour has been sent to "%s". If the user doesn\'t receive the link, you can generate and copy a new one by editing the user and managing her password.'] = '1 tund kehtiv aktiveerimislink on saadetud aadressile "%s". Kui kasutaja linki ei saa, saate kasutajat muutes ja tema parooli haldades luua ja kopeerida uue.';
$lang['An activation link valid for 1 hour was created but could not be sent. You can now copy the link below and send it to the user.'] = 'Loodi 1 tund kehtiv aktiveerimislink, kuid seda ei saanud saata. Nüüd saate kopeerida alloleva lingi ja saata selle kasutajale.';
