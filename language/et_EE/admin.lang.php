...
$lang['Select or create an album'] = 'Valige või looge album';
$lang['Select groups or type them'] = 'Valige rühmad või tippige need';
$lang['Select an album... or type it!'] = 'Valige album... või tippige see!';
$lang['Select all %d tags'] = 'Valige kõik %d silti';
$lang['Search tips'] = 'Otsimise näpunäited';
$lang['Save'] = 'Salvesta';
$lang['Root'] = 'Juur';
$lang['Review'] = 'Ülevaade';
$lang['Resend password link'] = 'Saada parooli link uuesti';
$lang['Read the release note'] = 'Lugege väljalaskemärkust';
$lang['Please complete all fields'] = 'Palun täitke kõik väljad';
$lang['Group(s) \{%s1\} succesfully merged into "%s2"'] = 'Grupp(id) \{%s1\} ühendati edukalt rühmaga "%s2"';
$lang['Has access to administration. Can only manage content: photos/albums/users/tags/groups.'] = 'Juurdepääs administratsioonile. Saab hallata ainult sisu: fotod/albumid/kasutajad/sildid/rühmad.';
$lang['Installed on %s, %s'] = 'Installitud: %s, %s';
$lang['Last revision date is newer than'] = 'Viimase läbivaatamise kuupäev on uuem kui';
$lang['Locked albums are disabled for maintenance. Only administrators can view them in the gallery. Lock this album will also lock his Sub-albums'] = 'Lukustatud albumid on hoolduseks keelatud. Ainult administraatorid saavad neid galeriis vaadata. Selle albumi lukustamisel lukustatakse ka selle alamalbumid.';
$lang['No research in progress'] = 'Uuringuid pole pooleli';
$lang['No access to administration, can see private content with appropriate permissions.'] = 'Juurdepääs administratsioonile puudub, näeb privaatset sisu sobivate lubadega.';
$lang['Metadata sync complete'] = 'Metaandmete sünkroonimine on lõpetatud';
$lang['Memories'] = 'Suveniirid';
$lang['Main user'] = 'Peamine kasutaja';
$lang['No search in progress'] = 'Otsingut pole pooleli';
$lang['Ok, got it!'] = 'Ok, sain aru!';
$lang['Object'] = 'Objekt';
$lang['Line View'] = 'Joonvaade';
$lang['Image'] = 'Pilt';
$lang['First choose an album, then add your files'] = 'Esmalt valige album ja seejärel lisage failid';
$lang['During upload, if Piwigo detects the photo already exists, associate the existing photo to the destination album, without duplicating file'] = 'Kui Piwigo tuvastab üleslaadimise ajal, et foto on juba olemas, seostage olemasolev foto sihtalbumiga ilma faili dubleerimata';
$lang['Drag and drop to reorder albums'] = 'Albumite ümberjärjestamiseks pukseerige';
$lang['Display'] = 'Ekraan';
$lang['Discover'] = 'Avastage';
$lang['Delete them'] = 'Kustutage need';
$lang['Delete tag "%s"?'] = 'Kas kustutada silt "%s"?';
$lang['Delete %s format ?'] = 'Kas kustutada %s vorming?';
$lang['Currently running version %s'] = 'Praegu töötab versioon %s';
$lang['Creation mode'] = 'Loomisrežiim';
$lang['Created on %s'] = 'Loodi %s';
$lang['Create your first album'] = 'Looge oma esimene album';
$lang['Create and select'] = 'Looge ja valige';
$lang['Create a root album'] = 'Loo juuralbum';
$lang['Cannot send an email to this user because he doesn\'t have an email address'] = 'Sellele kasutajale ei saa meili saata, kuna tal pole meiliaadressi';
$lang['Copy the link below and send it to the user so the password can be set.'] = 'Kopeerige allolev link ja saatke see kasutajale, et saaks parooli määrata.';
$lang['Copy the password link'] = 'Kopeerige parooli link';
$lang['Core'] = 'Tuum';
$lang['Copy password'] = 'Kopeeri parool';
$lang['Copied link'] = 'Kopeeritud link';
$lang['Changing the main user'] = 'Peakasutaja muutmine';
$lang['Changes saved'] = 'Muudatused salvestatud';
$lang['%s is the new main user'] = '%s on uus põhikasutaja';
$lang['Add a sub-album to “%s”'] = 'Lisa alamalbum albumisse “%s”';
$lang['An error has occured'] = 'Ilmnes viga';
$lang['Auto-update'] = 'Automaatne värskendus';
$lang['The other tags will be removed'] = 'Ülejäänud sildid eemaldatakse';
$lang['The passwords do not match'] = 'Paroolid ei ühti';
$lang['This albums is already in related categories list'] = 'See album on juba seotud albumite loendis';
$lang['This link is valid for %s. After this time, you will need to request a new link.'] = 'See link kehtib %s. Pärast seda aega peate taotlema uut linki.';
$lang['This photo is an orphan'] = 'See foto on üksik';
$lang['The best is to have them made automatically on a regular basis.'] = 'Parim on lasta neid regulaarselt teha automaatselt.';
$lang['The original picture will be detected with the filename (without extension).'] = 'Algne pilt tuvastatakse failinimega (ilma laiendita).';
$lang['Tag name'] = 'Sildi nimi';
$lang['System Activities'] = 'Süsteemi tegevused';
$lang['Some photos are missing from your file system. Details provided by plugin Check Uploads'] = 'Mõned fotod puuduvad teie failisüsteemist. Üksikasjad, mida pakub pistikprogramm, Kontrolli üleslaadimisi';
$lang['Synchronization'] = 'Sünkroonimine';
$lang['Shrink'] = 'Kahanema';
$lang['Showing %s users out of %s'] = 'Kuvatakse %s kasutajat %s-st';
$lang['Show sub-albums'] = 'Kuva alamalbumid';
$lang['Show beta test plugins'] = 'Kuva beetatesti pistikprogrammid';
$lang['Set as main user'] = 'Määra põhikasutajaks';
$lang['Set as group for new users'] = 'Määra uute kasutajate rühmaks';
$lang['Piwigo core'] = 'Piwigo tuum';
$lang['Picture to associate formats with'] = 'Pilt, millega vorminguid seostada';
$lang['Photos per page'] = 'Fotosid lehel';
$lang['This user must first be defined as the webmaster before it can be upgraded to the main user'] = 'See kasutaja tuleb esmalt määratleda veebihaldurina, enne kui seda saab põhikasutajaks täiendada';
$lang['Tile View'] = 'Plaadivaade';
$lang['To be sure, please rewrite the word “%s” below'] = 'Et olla kindel, kirjutage sõna "%s" allpool ümber';
$lang['To set your password, visit the following address:'] = 'Parooli määramiseks külastage järgmist aadressi:';
$lang['Understood, do not show again'] = 'Sai aru, enam ei näita';
$lang['Unlock it'] = 'Avage see';
$lang['Unset as group for new users'] = 'Tühista uute kasutajate grupiks määramine';
$lang['Upload Formats'] = 'Laadi vormingud üles';
$lang['Username successfully modified'] = 'Kasutajanime muutmine õnnestus';
$lang['Users not logged in will have these settings applied, these settings are used by default for new users'] = 'Kasutajatele, kes pole sisse logitud, rakendatakse neid sätteid. Neid seadeid kasutatakse vaikimisi uute kasutajate puhul';
$lang['This plugin is incompatible with your version'] = 'See pistikprogramm ei ühildu teie versiooniga';
$lang['This plugin have no update since 3 years ! It may be outdated'] = 'Sellel pistikprogrammil pole värskendusi 3 aastat! See võib olla aegunud';
$lang['This plugin have been updated recently'] = 'Seda pistikprogrammi on hiljuti värskendatud';
$lang['This plugin has no recent update'] = 'Sellel pistikprogrammil pole uusi värskendusi';
$lang['This picture is physically linked to this album, you can\'t dissociate them'] = 'See pilt on selle albumiga füüsiliselt lingitud, te ei saa neid lahutada.';
$lang['You are not authorised to change the main user, please ask your webmaster'] = 'Teil ei ole õigust põhikasutajat vahetada, küsige oma veebihaldurilt';
$lang['You are about to set %s as main user instead of %s, do you wish to continue ?'] = 'Seadistate peakasutajaks %s, mitte %s, kas soovite jätkata?';
$lang['Yes, let\'s proceed'] = 'Jah, jätkame';
$lang['Who can see ?'] = 'Kes näeb?';
$lang['What\'s new in version %s'] = 'Mis on uut versioonis %s?';
$lang['You can now change the main user from %s to %s.'] = 'Nüüd saate muuta põhikasutaja %s kasutajaks %s.';
$lang['You cannot copy the password if the connection to this site is not secure.'] = 'Te ei saa parooli kopeerida, kui ühendus selle saidiga pole turvaline.';
$lang['You have unsaved changes'] = 'Teil on salvestamata muudatusi';
$lang['between %d and %d'] = 'vahemikus %d kuni %d';
$lang['level of confidentiality'] = 'konfidentsiaalsuse tase';
$lang['image(s) contains unsaved changes'] = 'pilt sisaldab salvestamata muudatusi';
$lang['to'] = 'to';
$lang['was succesfully deleted'] = 'kustutati edukalt';
$lang['Password copied'] = 'Parool kopeeritud';
$lang['Pagination has changed and needs to be reloaded !'] = 'Leheküljed on muutunud ja tuleb uuesti laadida!';
$lang['Page Visited'] = 'Lehekülge külastatud';
$lang['Page Visited in %s'] = 'Lehekülge külastatud %s';
$lang['Only admins in a specific group'] = 'Ainult teatud grupi administraatorid';
$lang['On %d rating(s)'] = '%d hinnangul';
