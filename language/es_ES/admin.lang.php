...
$lang['Use the default photo sort order (defined in the configuration file)'] = 'Utilizar el orden de selección de las fotos por defecto (definido en el fichero de configuración)';
