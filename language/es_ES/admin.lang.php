...
$lang['cat_inclu_part1_S'] = '%d categoría de la que están ';
$lang['cat_inclu_part1_P'] = '%d categorías entre las que están ';
...
$lang['Categories ordered alphanumerically'] = 'Categorías ordenadas alphabético - numéricamente';
...
$lang['Check for upgrade failed for unknown reasons.'] = 'La comprobación de la última versión sobre el servidor fue suspendido por una razón desconocida.';
$lang['Check for upgrade'] = 'Última versión ?';
$lang['Comments for all'] = 'Comentarios para ellos todos';
$lang['Controversy'] = 'Controversia';
$lang['Creation date'] = 'Data de creación';
$lang['Current name'] = 'Nombre que corre';
$lang['Database'] = 'Base de datos';
$lang['Deactivate'] = 'Desactivar';
$lang['Delete Representant'] = 'Suprimir al representante';
$lang['Delete selected tags'] = 'Suprimir los tags seleccionadas';
...
$lang['History'] = 'histórica';
$lang['Informations'] = 'Informaciones';
$lang['Install'] = 'Instalar';
$lang['Link all category elements to a new category'] = 'Asociar todos los elementos de la categoría con una nueva categoría';
...
$lang['Manage permissions for a category'] = 'Administrar los autorizaciones para una categoría';
$lang['Manage permissions for group "%s"'] = 'Administrar los autorizaciones para el grupo "%s"';
$lang['Manage permissions for user "%s"'] = 'Administrar los autorizaciones para el utilizador "%s"';
...
$lang['Only private categories are listed'] = 'Las únicas las categorías particulares son puestas en una lista';
$lang['Operating system'] = 'System de explotación';
$lang['Options'] = 'Opciones';
$lang['Order alphanumerically'] = 'Ordenar alphabético - numéricamente';
...
$lang['Permalink %s is already used by category %s'] = 'El lazo permanente %s es dèja utilizado por la categoría %s';
...
$lang['Site manager'] = 'Gerente de las sitios';
...
$lang['The %d following tag were deleted'] = 'El tag siguiente ha sido suprimida';
...
$lang['group "%s" updated'] = 'grupo "%s" mi al día';
$lang['group'] = 'grupo';
...
$lang['group_id URL parameter is missing'] = 'El parámetro de URL "group_id" es faltante';
$lang['groups'] = 'Grupos';
...
$lang['nbm_col_check_user_send_mail'] = '¿ Al enviar?';
...
$lang['nbm_content_subscribe_by_admin'] = 'Usted acaba de ser inscrito por el webmestre de la sitio para recibir la notificación por mail.';
...
$lang['nbm_content_unsubscribe_by_admin'] = 'Usted acaba de ser désinscrit por el webmestre de la sitio para recibir la notificación por mail.';
...
$lang['nbm_content_unsubscribe_link'] = 'Para usted désinscrire';
...
$lang['nbm_send_check_all'] = 'Todo cochero';
...
$lang['nbm_title_subscribe'] = 'Inscribir / désinscrire a los utilizadores';
...
$lang['nbm_warning_subscribe_unsubscribe'] = 'Atención, la inscripción o el désincription entraine el envío de mails a los utilizadores concernidos';
...
$lang['permuser_info'] = 'Las únicas las categorías particulares son puestas en una lista.';
...
$lang['remote_site_generate_hint'] = 'generar el fichero listing.xml sobre la sitio distante';
$lang['remote_site_local_create'] = 'Crear esta sitio';
...
$lang['remote_site_test_hint'] = 'testar esta sitio distante';
$lang['remote_site_uncorrect_url'] = 'EL URL de el sitio distante debe comenzar para "http " o "https" y debe contener carácteres sólo entre "/", " a- zA-Z0-9 ", "-" o "_"';
$lang['remove keyword'] = 'suprimir palabra-llave';
...
$lang['site_already_exists'] = 'Esta sitio ya existe';
$lang['site_create'] = 'Crear una nueva sitio distante: (dar su URL hacia create_listing_file.php)';
$lang['site_created'] = 'Creado';
$lang['site_delete'] = 'suprimir';
$lang['site_delete_hint'] = 'suprimir esta sitio y todas las informaciones asociadas';
$lang['site_deleted'] = 'suprimido';
$lang['site_err'] = 'Un error sobrevino';
$lang['site_err_remote_file_not_found'] = 'el fichero create_listing_file.php es imposible de encontrar sobre la sitio distante';
...
$lang['stats_global_graph_title'] = 'Páginas vistas por el mes';
$lang['stats_hour'] = 'Hora';
$lang['stats_login'] = 'Identificando';
$lang['stats_month_title'] = 'Estadísticas mensuales';
$lang['stats_monthly_graph_title'] = 'Páginas vistas por el día';
...
$lang['tn_dirs_alone'] = 'imagenes sin miniatura';
$lang['tn_dirs_title'] = 'Lista repertorios';
...
$lang['update_err_pwg_version_differs'] = 'La versión PhpWebGallery sobre la sitio distante es differente';
...
$lang['update_err_remote_listing_not_found_info'] = 'el fichero listing.xml es imposible de encontrar sobre la sitio distante. Este fichero es generé escogiendo el encargo " generar el listado " en el gerente de sitios';
...
$lang['update_nb_new_categories'] = 'categorías añadidas en la base de datos';
$lang['update_nb_new_elements'] = 'elementos añadidos en la base de datos';
...
$lang['update_sync_metadata_new'] = 'ùnicamente los elementos jamás sincronizados';
$lang['update_used_metadata'] = 'Méta-données empleadas';
...
$lang['Restrict access to'] = 'Acceso restringe a';
$lang['Returned images limit'] = 'Límite de transmision';
$lang['Comment to identify your partner clearly'] = 'Comentario a el que permite usted identificar a su compañero fácilmente';
...
$lang['Web Services under control'] = 'Los Servicios Web de PhpWebGallery totalmente son operationnels y todas las demandas son controladas.';
$lang['special_admin_menu'] = 'Classes de matemáticas superiores';
$lang['pictures_menu'] = 'Imágenes';
...
$lang['%d member: %s'] = '%d iembro: %s';
$lang['%d members: %s'] = '%d miembros: %s';
...
$lang['c13y_Correction_applied_success'] = 'Corrección aplicada con succés';
$lang['c13y_Correction_applied_error'] = 'Corrección aplicada con error';
