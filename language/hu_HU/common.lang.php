...
$lang['Tag'] = 'Címke';
$lang['Tags'] = 'Címkék';
$lang['The RSS notification feed provides notification on news from this website : new pictures, updated categories, new comments. Use a RSS feed reader.'] = 'Az RSS értesítő a következő -az oldallal kapcsolatos- információkat tartalmazza: új fotók, új kategóriák, új kommentek.';
...
$lang['display best rated items'] = 'megjeleníti a legjobbra értékelteket';
$lang['caddie'] = 'Kosár';
...
$lang['shows images at the root of this category'] = 'képek mutatása a kategória gyökeréből';
...
$lang['set as category representative'] = 'Beállítás kategória-képviselőként';
...
$lang['SQL queries in'] = 'SQL lekérdezés';
...
$lang['%d image']='%d kép';
$lang['%d images']='%d kép';
$lang['%d image is also linked to current tags'] = 'A kép jelenlegi címkéje %d';
$lang['%d images are also linked to current tags'] = 'A kép jelenlegi címkéje %d';
$lang['See images linked to this tag only'] = 'A címkéhez kapcsolódó képek';
