...
$lang['Add detailed content'] = 'Részletes tartalom hozzáadása';
...
$lang['%d photo was deleted'] = '%d fotó törölve';
$lang['%d photos were deleted'] = '%d fotó törölve';
...
$lang['%d photos uploaded'] = '%d fotó feltöltve';
...
$lang['Add another set of photos'] = 'További fotók hozzáadása';
...
$lang['Add as filter'] = 'Hozzáadás szűrőként';
...
$lang['Copied link'] = 'Másolt link';
$lang['Copy password'] = 'Jelszó másolása';
$lang['Changes saved'] = 'Módosítások mentve';
$lang['Change logo'] = 'Logó módosítása';
$lang['Cannot send an email to this user because he doesn\'t have an email address'] = 'Nem lehet e-mailt küldeni ennek a felhasználónak, mert nincs e-mail címe';
$lang['Auto-update'] = 'Automatikus frissítés';
$lang['An error has occured'] = 'Hiba történt';
$lang['Activate create mode to create and select an album'] = 'Aktiválja a létrehozási módot az album létrehozásához és kiválasztásához';
$lang['%s pixels, %.2f MB'] = '%s pixel, %.2fMB';
$lang['%s is the new main user'] = '%s az új fő felhasználó';
$lang['%d files'] = '%d fájl';
$lang['Tag name'] = 'Címke név';
$lang['Show plugins compatible with previous version of Piwigo'] = 'Előző verziójú Piwigo-val kompatibilis plug-inok megjelenítése';
$lang['Show beta test plugins'] = 'Béta teszt plug-inok megjelenítése';
$lang['Set as main user'] = 'Beállítás fő felhasználóként';
$lang['Save all photos'] = 'Minden fotó mentése';
$lang['Save'] = 'Mentés';
$lang['Purge Cache'] = 'Cache ürítése';
$lang['Piwigo is also on mobile.'] = 'Piwigo mobilon is elérhető.';
$lang['Please complete all fields'] = 'Kérem minden mezőt töltsön ki';
$lang['Personalization settings'] = 'Testreszabási beállítások';
$lang['Password copied'] = 'Jelszó másolva';
$lang['No comments selected, no actions possible.'] = 'Nincs hozzászólás kiválasztva, tevékenység nem lehetséges.';
$lang['Main user'] = 'Fő felhasználó';
$lang['Metadata sync complete'] = 'Metaadat szinkronizáció kész';
$lang['Edit photo #%s'] = '#%s kép szerkesztése';
$lang['Locked album'] = 'Album zárolva';
$lang['Light mode'] = 'Világos mód';
$lang['First choose an album, then add your files'] = 'Először válassza ki az albumot, utána adja hozzá a fájljait';
$lang['Delete %s format ?'] = '%s formátum törlése?';
$lang['Create your first album'] = 'Hozza létre első albumát';
$lang['Created'] = 'Létrehozva';
$lang['Creation mode'] = 'Létrehozás mód';
$lang['Dark mode'] = 'Sötét mód';
$lang['Copy the link below and send it to the user so the password can be set.'] = 'Másolja ki az alábbi linket, és küldje el a felhasználónak, hogy beállíthassa a jelszót.';
$lang['Are you sure you want to delete "%d" comments?'] = 'Biztosan törölni szeretne "%d" hozzászólást?';
$lang['Are you sure you want to delete comment #%s?'] = 'Biztosan törölni szeretné a(z) #%s hozzászólást?';
$lang['Changing the main user'] = 'Fő felhasználó módosítása';
$lang['Certification higher or equal to'] = 'Tanúsítvány nagyobb vagy egyenlő, mint';
$lang['%d photos were moved from the upload lounge to their albums'] = '%d fotót áthelyeztünk a feltöltési váróból az albumokba';
$lang['Authorize comments'] = 'Hozzászólások jóváhagyása';
$lang['Added on %s'] = 'Hozzáadva ekkor: %s';
$lang['Admins only'] = 'Csak adminoknak';
$lang['was succesfully deleted'] = 'sikeresen törölve';
$lang['Read the release note'] = 'Olvassa el a kiadási jegyzéket';
$lang['System Activities'] = 'Rendszeraktivitások';
$lang['The best is to have them made automatically on a regular basis.'] = 'A legjobb, ha ezeket rendszeresen, automatikusan készítik el.';
$lang['Use Piwigo logo'] = 'Piwigo logó használata';
$lang['This plugin was updated less than 6 months ago'] = 'Ez a plug-in kevesebb, mint 6 hónapja frissült';
$lang['This plugin is incompatible with your version'] = 'Ez a plug-in nem kompatibilis az Ön verziójával';
$lang['This photo no longer exists'] = 'Ez a fotó már nem létezik';
$lang['Use custom logo (png, jpeg or svg)'] = 'Egyedi logó használata (png, jpeg vagy svg)';
$lang['A photo library administrator has created the following account for you:'] = 'A fotókönyvtár adminisztrátora létrehozta Önnek a következő fiókot:';
$lang['%s status is required to edit parameters.'] = 'A paraméterek szerkesztéséhez %s állapot szükséges.';
$lang['%d formats uploaded for %d photos'] = '%d formátum feltöltve %d fotóhoz';
$lang['Resend password link'] = 'Jelszó link újraküldése';
$lang['Expand'] = 'Kibontás';
$lang['Detect and avoid duplicates during upload'] = 'Duplikátumok észlelése és elkerülése feltöltés közben';
$lang['Create and select'] = 'Létrehozás és kiválasztás';
$lang['action successfully performed.'] = 'művelet sikeresen végrehajtva.';
$lang['and %d more'] = 'és %d több';
$lang['level of confidentiality'] = 'titoktartási szint';
$lang['since the beginning'] = 'kezdetektől fogva';
$lang['You have unsaved changes'] = 'Nem mentett módosításai vannak';
$lang['What\'s new in version %s'] = 'Újdonságok a %s verzióban';
$lang['Visited'] = 'Megtekintve';
$lang['Visit history'] = 'Megtekintési előzmény';
$lang['Version %s'] = '%s verzió';
$lang['Understood, do not show again'] = 'Megértve, nem lesz megjelenítve még egyszer';
$lang['Try now !'] = 'Próbálja meg most!';
$lang['This album is currently locked, visible only to administrators.'] = 'Ez az album jelenleg zárolt, csak az adminisztrátok számára látható.';
$lang['The passwords do not match'] = 'A jelszavak nem egyeznek';
$lang['Standard pages'] = 'Standard oldalak';
$lang['Ok, got it!'] = 'Ok, megértve!';
$lang['Modified'] = 'Módosítva';
$lang['Display Gallery title'] = 'Galéria címének megjelenítése';