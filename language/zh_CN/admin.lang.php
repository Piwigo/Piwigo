...
$lang['Page banner'] = '页面横幅';
$lang['Parent album'] = '父相册';
$lang['Path'] = '路径';
$lang['Permalink'] = '永久链接';
$lang['Permalink %s has been previously used by album %s. Delete from the permalink history first'] = '永久链接 %s 已被相册 %s 使用，需先从永久链接历史记录中删除。';
...
$lang['High definition enabled'] = '允许下载';
$lang['File'] = '文件';
$lang['Forbidden'] = '禁止';
...
$lang['Subscribe to notification by mail'] = '通过邮件订阅通知';
...
$lang['private'] = '非公开';
$lang['public'] = '公开';
$lang['Purge never used notification feeds'] = '清理从未使用的通知订阅源';
...
$lang['Image id'] = '图片id';
$lang['Summary'] = '概述';
$lang['%d line filtered'] = '已筛选 %d 行';
$lang['%d lines filtered'] = '已筛选 %d 行';
$lang['%d guest'] = '%d位访客';
$lang['%d guests'] = '%d位访客';
$lang['Hour'] = '小时';
$lang['guest'] = '访客';
...
$lang['Guest cannot be deleted'] = '访客用户无法删除';
...
$lang['Main "guest" user does not exist'] = '主“访客”用户不存在';
$lang['Main "guest" user status is incorrect'] = '主“访客”用户状态异常';
...
$lang['Everybody'] = '每个人';
$lang['Who can see these photos?'] = '谁可以查看这些图片？';
$lang['Settings'] = '设置';
$lang['Resize'] = '修改尺寸';
...
$lang['This theme was not designed to be directly activated'] = '该主题不支持直接启用';
$lang['Who can see this photo?'] = '谁可以查看这张图片？';
...
$lang['Zoom'] = '缩放';
$lang['A locked gallery is only visible to administrators'] = '图库锁定后，仅管理员可查看';
...
$lang['Save visits in history for'] = '保存以下对象的访问历史记录';
...
$lang['Duplicate selected tags'] = '标记选中的重复项';
$lang['Name of the duplicate'] = '重复项名称';
$lang['Source tag'] = '源标签';
$lang['Tag "%s" is now a duplicate of "%s"'] = '标签"%s"现已标记为"%s"的重复项';
...
$lang['The settings for the guest are from the %s user'] = '访客的配置继承自%s用户';
...
$lang['Recipients'] = '收件人';
$lang['Y Repeat'] = 'Y轴平铺';
$lang['Delete %d orphan photos'] = '删除%d张没有任何关联的图片';
$lang['Orphans'] = '没有任何关联';
$lang['delete album and all %d photos, even the %d associated to other albums'] = '删除相册以及全部 %d 张图片，包括 %d 张已关联到其他相册的图片';
$lang['checksum'] = '校验码';
$lang['Time has come to update your Piwigo with version %s, go to %s'] = '现可将您的 Piwigo 升级至 %s 版本，请访问地址：%s';
...
$lang['Running on an up-to-date Piwigo is important for security.'] = '保持 Piwigo 版本为最新，对系统安全至关重要。';
...
$lang['Piwigo %s is available, please update'] = 'Piwigo %s 版本已发布，敬请更新';
$lang['No tags selected, no actions possible.'] = '未选择标签，无法执行操作。';
$lang['No filter on album. Select one or type to search'] = '相册未设置筛选条件，请选择筛选项或输入关键词搜索';
$lang['It only takes a few clicks.'] = '仅需几步点击，即可完成升级。';
...
$lang['%d photos'] = '%d张图片';
$lang['add'] = '添加';
$lang['<b>%d+</b> albums found, try to refine the search'] = '找到<b>%d+</b>个相册，请细化搜索范围';
$lang['<b>%d</b> albums found'] = '找到<b>%d</b>个相册';
$lang['<b>%d</b> tag found'] = '找到<b>%d</b>个标签';
$lang['<b>%d</b> tag selected'] = '已选择<b>%d</b>个标签';
$lang['<b>%d</b> tags found'] = '找到<b>%d</b>个标签';
$lang['<b>1</b> album found'] = '找到<b>1</b>个相册';
...
$lang['%d album deleted'] = '已删除%d个相册';
$lang['%d albums added'] = '已添加%d个相册';
$lang['%d albums deleted'] = '已删除%d个相册';
...
$lang['Are you sure you want to lock the gallery?'] = '确定要锁定图库吗？';
...
$lang['Are you sure you want to unlock the gallery?'] = '确定要解锁图库吗？';
...
$lang['%d pictures in sub-albums'] = '子相册中有%d张图片';
...
$lang['Activity peak in the last weeks'] = '近几周活跃度峰值';
...
$lang['Discover'] = '发现';
$lang['Display'] = '显示';
$lang['Displays a banner to install or open the official Piwigo app'] = '展示横幅以安装或打开 Piwigo 官方应用';
$lang['Dissociate user from this group'] = '将用户移出该用户组';
$lang['Edit guest user'] = '编辑访客用户';
...
$lang['action successfully performed.'] = '操作执行成功';
...
$lang['Promote mobile app on mobile devices'] = '在移动设备端推广手机应用';
$lang['Registered'] = '已注册';
...
$lang['Showing %s users out of %s'] = '当前显示%s位用户，共%s位';
$lang['Some photos are missing from your file system. Details provided by plugin Check Uploads'] = '文件系统中部分图片缺失，详情请查看插件 Check Uploads';
$lang['Open in gallery'] = '在图库中打开';
...
$lang['Line View'] = '行视图';
$lang['Locked albums are disabled for maintenance. Only administrators can view them in the gallery. Lock this album will also lock his Sub-albums'] = '锁定的相册将因维护功能禁用，仅管理员可在图库内查看。锁定此相册的同时，其子相册也将被一并锁定。';
...
$lang['Global Gallery Actions'] = '图库全局操作';
...
$lang['Comments disallowed for sub-albums'] = '禁止对子相册发表评论';
...
$lang['Unlock it'] = '解锁';
$lang['This album is currently locked, visible only to administrators.'] = '此相册当前已锁定，仅管理员可见。';
...
$lang['%d Activities'] = '%d次活跃';
$lang['%d Activity'] = '%d次活跃';
$lang['Activity'] = '活跃度';
$lang['Activity time from'] = '活跃时段起始';
$lang['Download all activities'] = '导出全部活跃度数据';
...
$lang['Create your first album'] = '创建你的第一个相册';
...
$lang['We have found %d duplicate paths. Details provided by plugin Check Uploads'] = '检测到 %d 个重复路径，详情由 Check Uploads 插件提供';
...
$lang['user_status_normal'] = '普通用户';
$lang['Change logo'] = '更换标识';
$lang['Dark mode'] = '深色模式';
$lang['Display Gallery title'] = '显示图库标题';
$lang['Light mode'] = '浅色模式';
$lang['Personalization settings'] = '个性化设置';
$lang['Select a color theme for standard pages'] = '为标准页面选择配色主题';
$lang['Standard pages'] = '标准页面';
$lang['Standard pages aren\'t activated, however you have %d active themes that will still use them. These themes are:'] = '标准页面尚未启用，但你目前有 %d 个已激活的主题仍会调用该功能。涉及的主题如下：';
$lang['Standard pages header'] = '标准页面头部';
$lang['Use Piwigo logo'] = '使用 Piwigo 标识';
$lang['Use custom logo (png, jpeg or svg)'] = '使用自定义标识（支持 PNG、JPEG、SVG 格式）';
$lang['Follow the update guide'] = '参考更新指南';
$lang['Two container updates are available'] = '有2项容器更新待处理';
$lang['You are about to delete %s groups, are you sure?'] = '你即将删除%s个分组，确定要执行此操作吗？';