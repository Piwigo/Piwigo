...
$lang['on the %d selected photos'] = '于所选的 %d 张图片';
...
$lang['<em>Piwigo for iOS</em> application empowers you to connect to your Piwigo gallery from your iPhone, iPad or iPod Touch, create some albums and upload several photos at once.'] = '您可以在iPhone、iPad或iPod Touch上安装<em>Piwigo iOS版</em>，以便随时随地连接到您的Piwigo图库，创建相册和上传图片。';
