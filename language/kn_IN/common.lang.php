...
$lang['Anti-flood system : please wait for a moment before trying to post another comment'] = 'Anti-flood system: please wait a moment before trying to post another ಟಿಪ್ಪಣಿ';
...
$lang['Bad status for user "guest", using default status. Please notify the webmaster.'] = "Bad status for ಬಳಕೆದಾರ \"guest\", default status will be used. Please notify the webmaster.";
