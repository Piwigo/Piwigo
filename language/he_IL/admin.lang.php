...
$lang['%sMB'] = '%s MB';
$lang['%s status is required to edit parameters.'] = 'סטטוס %s דרוש כדי לערוך פרמטרים';
$lang['%s pixels, %.2f MB'] = '%s פיקסלים, %.2f MB';
$lang['%s MB'] = '%s MB';
...
$lang['%s file type'] = '%s סוג קובץ';
$lang['%s is the new main user'] = '%s הוא המשתמש הראשי החדש';
$lang['%s line'] = '%s שורה';
$lang['%s lines'] = '%s שורות';
$lang['%s other tags available..'] = '%s תגים נוספים זמינים';
$lang['%s plugin found'] = '<b>%s</b> תוסף נמצא';
$lang['%s plugins found'] = '<b>%s</b> תוספים נמצאו';
