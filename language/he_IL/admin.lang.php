...
$lang['Group'] = 'קבוצה';
$lang['%s value is not correct file because exif are not supported'] = 'ערך %s אינו נכון כי exif אינם נתמכים';
$lang['Hello,'] = 'שלום,';
$lang['See you soon.'] = 'נתראה בקרוב.';
...
$lang['%s must be to set to false in your local/config/config.inc.php file'] = 'יש להגדיר את %s ל-false בקובץ local/config/config.inc.php שלכם';
...
$lang['%s photos can not be regenerated'] = 'לא ניתן לחדש %s תמונות';
...
$lang['%d year'] = '%d שנה';
$lang['%d years'] = '%d שנים';
$lang['%s has been successfully updated.'] = '%s עודכן בהצלחה.';
...
$lang['List'] = 'רשימה';
$lang['%s ago'] = 'לפני %s';
$lang['%u users have automatic permission because they belong to a granted group.'] = 'ל-%u משתמשים יש הרשאה אוטומטית כי הם שייכים לקבוצה מורשית.';
...
$lang['or'] = 'או';
$lang['Group renamed'] = 'שם הקבוצה שונה';
$lang['Has access to administration. Can only manage content: photos/albums/users/tags/groups.'] = 'יש לו גישה לממשק הניהול. הוא יכול לנהל רק תוכן: תמונות/אלבומים/משתמשים/תגים/קבוצות.';
$lang['Has access to all administration functionnalities. Can manage both configuration and content.'] = 'יש לו גישה לכל פונקציות הניהול. הוא יכול לנהל גם את ההגדרות וגם את התוכן';
$lang['Hide sub-albums'] = 'הסתר תתי-אלבומים';
$lang['If anything bad happens during the update, you would be able to restore a backup.'] = 'אם יקרה משהו רע במהלך העדכון, תוכל לשחזר גיבוי';
$lang['Image'] = 'תמונה';
$lang['Install Piwigo on mobile'] = 'התקן את Piwigo על מכשיר נייד';
$lang['Installed on %s, %s'] = 'הותקן ב-%s, %s';
$lang['Jan'] = 'ינואר';
$lang['Jul'] = 'יולי';
$lang['Jun'] = 'יוני';
$lang['Keep them'] = 'שמור אותם';
$lang['Language'] = 'שפה';
$lang['Last revision date is newer than'] = 'תאריך הגרסה האחרונה מאוחר יותר מ';
$lang['Last visit'] = 'ביקור אחרון';
$lang['Latest Piwigo news'] = 'חדשות Piwigo האחרונות';
$lang['Line View'] = 'תצוגת שורה';
$lang['Locked album'] = 'אלבום נעול';
$lang['During upload, if Piwigo detects the photo already exists, associate the existing photo to the destination album, without duplicating file'] = 'במהלך ההעלאה, אם Piwigo מזהה שהתמונה כבר קיימת, יש לחבר את התמונה הקיימת לאלבום היעד, מבלי לשכפל את הקובץ';
$lang['Edit'] = 'ערוך';
$lang['Edit guest user'] = 'ערוך משתמש אורח';
$lang['Edit photo #%s'] = 'ערוך תמונה #%s';
$lang['Edited on %s'] = 'נערך ב-%s';
$lang['Email'] = 'דוא"ל';
$lang['Email Adress'] = 'כתובת דוא"ל';
$lang['Equivalent to deactivation. The user is still in the list, but can no longer log in.'] = 'שווה לשבתה. המשתמש עדיין ברשימה, אך לא יכול להתחבר יותר.';
$lang['Error when trying to detect formats'] = 'שגיאה בניסיון לזהות פורמטים';
$lang['Expand'] = 'הרחב';
$lang['Extensions'] = 'הרחבות';
$lang['Feb'] = 'פברואר';
$lang['File type: %s'] = 'סוג קובץ: %s';
$lang['Filters'] = 'סינונים';
$lang['First choose an album, then add your files'] = 'בחר אלבום קודם, ואז הוסף את הקבצים שלך';
$lang['Formats'] = 'פורמטים';
$lang['Generate random password'] = 'צור סיסמה אקראית';
$lang['Global Gallery Actions'] = 'פעולות גלריה כלליות';
$lang['Group "%s" succesfully deleted'] = 'הקבוצה "%s" נמחקה בהצלחה';
$lang['Group added'] = 'הקבוצה נוספה';
$lang['Deactivated'] = 'מושבת';
$lang['Dec'] = 'דצמבר';
$lang['Delete %s format ?'] = 'האם למחוק את פורמט %s?';
$lang['Delete album'] = 'מחק אלבום';
$lang['Delete orphan tags ?'] = 'האם למחוק תגים יתומים?';
$lang['Delete tag "%s"?'] = 'האם למחוק את התג "%s"?';
$lang['Delete tags \{%s\}?'] = 'האם למחוק את התגים \{%s\}?';
$lang['Delete them'] = 'מחק אותם';
$lang['Delete these sizes'] = 'מחק את הגדלים האלה';
$lang['Delete user'] = 'מחק משתמש';
$lang['Details'] = 'פרטים';
$lang['Detect and avoid duplicates during upload'] = 'גלה והימנע מכפילויות במהלך ההעלאה';
$lang['Disallow comments for sub-albums'] = 'אסור להגיב על תתי-אלבומים';
$lang['Discover'] = 'גלה';
$lang['Display'] = 'הצג';
$lang['Displays a banner to install or open the official Piwigo app'] = 'מציג באנר להתקנה או פתיחה של אפליקציית Piwigo הרשמית';
$lang['Dissociate user from this group'] = 'הסר את המשתמש מקבוצה זו';
$lang['Download all activities'] = 'הורד את כל הפעילויות';
$lang['Downloaded'] = 'הורד';
$lang['Drag and drop to reorder albums'] = 'גרור ושחרר על מנת לסדר מחדש את האלבומים';
$lang['Close'] = 'סגור';
$lang['Comments allowed for sub-albums'] = 'תגובות מותרות עבור תתי-אלבומים';
$lang['Comments disallowed for sub-albums'] = 'תגובות אסורות עבור תתי-אלבומים';
$lang['Compact View'] = 'תצוגה דחוסה';
$lang['Compare mode'] = 'מצב השוואה';
$lang['Copied link'] = 'קישור הועתק';
$lang['Copy password'] = 'העתק סיסמה';
$lang['Copy the link below and send it to the user so the password can be set.'] = 'העתק את הקישור למטה ושלח אותו למשתמש כדי שהסיסמה תוכל להתקבע.';
$lang['Copy the password link'] = 'העתק את קישור הסיסמה';
$lang['Core'] = 'ליבה';
$lang['Create a new album at root'] = 'צור אלבום חדש בשורש';
$lang['Create a root album'] = 'צור אלבום ראשי';
$lang['Create a sub-album of "%s"'] = 'צור תת-אלבום של "%s"';
$lang['Create and select'] = 'צור ובחר';
$lang['Create your first album'] = 'צור את האלבום הראשון שלך';
$lang['Created'] = 'נוצר';
$lang['Created on %s'] = 'נוצר ב-%s';
$lang['Creation mode'] = 'מצב יצירה';
$lang['Current Version'] = 'גירסה נוכחית';
$lang['Currently running version %s'] = 'הגירסה שרצה כרגע היא %s';
$lang['Are you sure you want to restore to default settings?'] = 'האם אתה בטוח שברצונך לשחזר את ההגדרות לברירות מחדל?';
$lang['Are you sure you want to uninstall the plugin "%s"?'] = 'האם אתה בטוח שברצונך להסיר את התוסף "%s"?';
$lang['Are you sure you want to unlock the gallery?'] = 'האם אתה בטוח שברצונך לפתוח את נעילת הגלריה?';
$lang['Are you sure you want to update all extensions?'] = 'האם אתה בטוח שברצונך לעדכן את כל התוספים?';
$lang['Associate User'] = 'קשר משתמש';
$lang['At least 2 selected tags are needed to merge'] = 'יש לבחור לפחות 2 תגים על מנת למזג';
$lang['Aug'] = 'אוגוסט';
$lang['Authorize comments'] = 'אשר תגובות';
$lang['Auto-update'] = 'עדכון אוטומטי';
$lang['Average last 12 months'] = 'ממוצע 12 החודשים האחרונים';
$lang['Cache'] = 'מטמון';
$lang['Cache size'] = 'גודל המטמון';
$lang['Can be shared by several individuals without conflict (they cannot change the password).'] = 'ניתן לשתף עם מספר אנשים ללא התנגשויות (הם לא יכולים לשנות את הסיסמה).';
$lang['Cannot send an email to this user because he doesn\'t have an email address'] = 'לא ניתן לשלוח דוא"ל למשתמש הזה מכיוון שאין לו כתובת דוא"ל';
$lang['Certification higher or equal to'] = 'הסמכה גבוהה או שווה ל';
$lang['Change Password'] = 'שנה סיסמה';
$lang['Changes saved'] = 'השינויים נשמרו';
$lang['Changing the main user'] = 'שינוי המשתמש הראשי';
$lang['Choose which tag to merge these tags into'] = 'בחר את התג שאליו יש למזג את התגים האלה';
$lang['Clear Selection'] = 'נקה בחירה';
$lang['An error has occured'] = 'חלה שגיאה';
$lang['Apply an automatic order to root albums'] = 'החל סדר אוטומטי לאלבומים הראשיים';
$lang['Apply to direct sub-albums'] = 'החל על תתי-אלבומים ישירים';
$lang['Apply to root albums'] = 'החל על אלבומים ראשיים';
$lang['Apply to the whole hierarchy'] = 'החל על כל ההיררכיה';
$lang['Apr'] = 'אפריל';
$lang['Are you sure you want to delete all sizes?'] = 'האם אתה בטוח שברצונך למחוק את כל הגדלים?';
$lang['Are you sure you want to delete group "%s"?'] = 'האם אתה בטוח שברצונך למחוק את הקבוצה "%s"?';
$lang['Are you sure you want to delete the language "%s"?'] = 'האם אתה בטוח שברצונך למחוק את השפה "%s"?';
$lang['Are you sure you want to delete the plugin "%s"?'] = 'האם אתה בטוח שברצונך למחוק את התוסף "%s"?';
$lang['Are you sure you want to delete the ratings of the user "%s"?'] = 'האם אתה בטוח שברצונך למחוק את הדירוגים של המשתמש "%s"?';
$lang['Are you sure you want to delete the theme "%s"?'] = 'האם אתה בטוח שברצונך למחוק את העיצוב "%s"?';
$lang['Are you sure you want to delete the user "%s"?'] = 'האם אתה בטוח שברצונך למחוק את המשתמש "%s"?';
$lang['Are you sure you want to delete this site?'] = 'האם אתה בטוח שברצונך למחוק את האתר הזה?';
$lang['Are you sure you want to delete this theme?'] = 'האם אתה בטוח שברצונך למחוק את העיצוב הזה?';
$lang['Are you sure you want to delete this?'] = 'האם אתה בטוח שברצונך למחוק את זה?';
$lang['Are you sure you want to install the plugin "%s"?'] = 'האם אתה בטוח שברצונך להתקין את התוסף "%s"?';
$lang['Are you sure you want to lock the gallery?'] = 'האם אתה בטוח שברצונך לנעול את הגלריה?';
$lang['Are you sure you want to restore the plugin "%s"?'] = 'האם אתה בטוח שברצונך לשחזר את התוסף "%s"?';
$lang['Are you sure you want to restore this plugin?'] = 'האם אתה בטוח שברצונך לשחזר את התוסף הזה?';
$lang['Activity peak in the last weeks'] = 'שיא פעילות בשבועות האחרונים';
$lang['Activity time from'] = 'זמן פעילות מ';
$lang['Add Album'] = 'הוסף אלבום';
$lang['Add New Plugin'] = 'הוסף תוסף חדש';
$lang['Add User'] = 'הוסף משתמש';
$lang['Add a new user'] = 'הוסף משתמש חדש';
$lang['Add a sub-album to “%s”'] = 'הוסף תת-אלבום ל-“%s”';
$lang['Add another set of formats'] = 'הוסף סט נוסף של פורמטים';
$lang['Add as filter'] = 'הוסף כפילטר';
$lang['Add formats'] = 'הוסף פורמטים';
$lang['Added on %s'] = 'הוסף ב-%s';
$lang['Additional filters'] = 'פילטרים נוספים';
$lang['Advanced filters'] = 'פילטרים מתקדמים';
$lang['Album name must not be empty'] = 'שם אלבום לא יכול להיות ריק';
$lang['Album search tool'] = 'כלי חיפוש אלבומים';
...
$lang['<b>%d</b> filtered users'] = '<b>%d</b> משתמשים מסוננים';
$lang['<b>%d</b> tag found'] = '<b>%d</b> תג נמצא';
$lang['<b>%d</b> tag selected'] = '<b>%d</b> תג נבחר';
$lang['<b>%d</b> tags found'] = '<b>%d</b> תגים נמצאו';
$lang['<b>1</b> album found'] = '<b>1</b> אלבום נמצא';
$lang['Activate button "%s"'] = 'הפעל כפתור "%s"';
$lang['Activate create mode to create and select an album'] = 'הפעל מצב יצירה כדי ליצור ולבחור אלבום';
$lang['Activated'] = 'הופעל';
$lang['Activated plugin list'] = 'רשימת התוספים שהופעלו';
$lang['Activity'] = 'פעילות';
$lang['%sMB'] = '%s מגה-בייט';
$lang['%s status is required to edit parameters.'] = 'נדרש סטטוס %s כדי לערוך פרמטרים.';
$lang['%s pixels, %.2f MB'] = '%s פיקסלים, %.2f מגה-בייט';
$lang['%s MB'] = '%s MB';
$lang['%s MB used'] = '%s MB בשימוש';
$lang['%s GB used'] = '%s GB בשימוש';
$lang['%sGB'] = '%s ג\'יגה-בייט';
$lang['%d tags moved'] = '%d תגים הוזזו';
$lang['%d user added'] = '%d משתמש נוסף';
$lang['%d user edited'] = '%d משתמש נערך';
$lang['%d user logged in'] = '%d משתמש התחבר';
$lang['%d user logged out'] = '%d משתמש נותק';
$lang['%d users added'] = '%d משתמשים נוספו';
$lang['%d users edited'] = '%d משתמשים נערכו';
$lang['%d users logged in'] = '%d משתמשים התחברו';
$lang['%d users logged out'] = '%d משתמשים נותקו';
$lang['%s file type'] = 'סוג קובץ %s';
$lang['%s is the new main user'] = '%s הוא המשתמש הראשי החדש';
$lang['%s line'] = 'שורה %s';
$lang['%s lines'] = 'שורות %s';
$lang['%s other tags available..'] = '%s תגיות נוספות זמינות..';
$lang['%s plugin found'] = 'נמצא תוסף <b>%s</b>';
$lang['%s plugins found'] = 'נמצאו תוספים <b>%s</b>';
$lang['%d in whole branch'] = '%d בכל הענף';
$lang['%d including sub-albums'] = '%d כולל תתי-אלבומים';
$lang['%d photo added'] = '%d תמונה נוספה';
$lang['%d photo deleted'] = '%d תמונה נמחקה';
$lang['%d photo edited'] = '%d תמונה נערכה';
$lang['%d photo moved'] = '%d תמונה הוזזה';
$lang['%d photos'] = '%d תמונות';
$lang['%d photos added'] = '%d תמונות נוספו';
$lang['%d photos deleted'] = '%d תמונות נמחקו';
$lang['%d photos edited'] = '%d תמונות נערכו';
$lang['%d photos moved'] = '%d תמונות הוזזו';
$lang['%d pictures in sub-albums'] = '%d תמונות בתתי-אלבומים';
$lang['%d sub-albums'] = '%d תתי-אלבומים';
$lang['%d tag added'] = '%d תגית נוספה';
$lang['%d tag deleted'] = '%d תגית נמחקה';
$lang['%d tag edited'] = '%d תגית נערכה';
$lang['%d tag moved'] = '%d תגית הוזזה';
$lang['%d tags added'] = '%d תגיות נוספו';
$lang['%d tags deleted'] = '%d תגיות נמחקו';
$lang['%d tags edited'] = '%d תגיות נערכו';
$lang[' (copy %s)'] = '(העתק %s)';
$lang[' (copy)'] = '(העתק)';
$lang['%d Activities'] = '%d פעילויות';
$lang['%d Activity'] = '%d פעילות';
$lang['%d album added'] = '%d אלבום נוסף';
$lang['%d album deleted'] = '%d אלבום נמחק';
$lang['%d album edited'] = '%d אלבום נערך';
$lang['%d albums added'] = '%d אלבומים נוספים';
$lang['%d albums deleted'] = '%d אלבומים נמחקים';
$lang['%d albums edited'] = '%d אלבומים נערכו';
$lang['%d files'] = '%d קבצים';
$lang['%d formats uploaded for %d photos'] = '%d פורמטים הועלו עבור %d תמונות';
$lang['%d group added'] = '%d קבוצה נוספה';
$lang['%d group deleted'] = '%d קבוצה נמחקה';
$lang['%d group edited'] = '%d קבוצה נערכה';
$lang['%d group moved'] = '%d קבוצה הוזזה';
$lang['%d groups added'] = '%d קבוצות נוספו';
$lang['%d groups deleted'] = '%d קבוצות נמחקו';
$lang['%d groups edited'] = '%d קבוצות נערכו';
$lang['%d groups moved'] = '%d קבוצות הוזזו';
$lang['since the beginning'] = 'מההתחלה';
$lang['to'] = 'אל';
$lang['was succesfully deleted'] = 'נמחק בהצלחה';
$lang['action successfully performed.'] = 'הפעולה בוצעה בהצלחה.';
$lang['add'] = 'הוסף';
$lang['and %d more'] = 'ועוד %d';
$lang['and %s others'] = 'ועוד %s אחרים';
$lang['between %d and %d'] = 'בין %d ל-%d';
$lang['between %s and %s'] = 'בין %s ל-%s';
$lang['calculated'] = 'חושבו';
$lang['deletion'] = 'מחיקה';
$lang['edit'] = 'ערוך';
$lang['image(s) contains unsaved changes'] = 'התמונה(ות) מכילה שינויים שלא נשמרו';
$lang['in administration'] = 'בניהול';
$lang['in gallery'] = 'בגלריה';
$lang['level of confidentiality'] = 'רמת סודיות';
$lang['login'] = 'התחברות';
$lang['logout'] = 'התנתקות';
$lang['months ago'] = 'חודשים';
$lang['move'] = 'העבר';
$lang['never calculated'] = 'מעולם לא חושב';
$lang['no photo'] = 'אין תמונה';
$lang['right now'] = 'ברגע זה';
$lang['Group(s) \{%s1\} succesfully merged into "%s2"'] = 'הקבוצות {\%s1}\ אוחדו בהצלחה ל-"%s2"';
$lang['Groups \{%s\} succesfully deleted'] = 'הקבוצות {\%s}\ נמחקו בהצלחה';
$lang['Webmaster status required'] = 'נדרש מעמד Webmaster';
$lang['What\'s new in version %s'] = 'מה חדש בגרסה %s?';
$lang['While restoring this plugin, it will be reset to its original parameters and associated data is going to be reset'] = 'בעת שחזור התוסף, הוא יתאפס לפרמטרים המקוריים ונתונים משויכים יתאפסו';
$lang['Who can see ?'] = 'מי יכול לראות?';
$lang['Yes, I am sure'] = 'כן, אני בטוח';
$lang['Yes, delete'] = 'כן, למחוק';
$lang['Yes, let\'s proceed'] = 'כן, נמשיך';
$lang['Yes, rename'] = 'כן, לשנות שם';
$lang['You are about to set %s as main user instead of %s, do you wish to continue ?'] = 'אתה עומד להגדיר את %s כמשתמש הראשי במקום %s, האם ברצונך להמשיך?';
$lang['You are not authorised to change the main user, please ask your webmaster'] = 'אינך מורשה לשנות את המשתמש הראשי, אנא פנה למנהל האתר שלך';
$lang['You can now change the main user from %s to %s.'] = 'כעת תוכל לשנות את המשתמש הראשי מ-%s ל-%s.';
$lang['You cannot copy the password if the connection to this site is not secure.'] = 'אינך יכול להעתיק את הסיסמה אם החיבור לאתר זה אינו מאובטח.';
$lang['You don\'t have access to this photo'] = 'אין לך גישה לתמונה זו';
$lang['You have %d orphan tags %s'] = 'יש לך %d תגיות יתומות %s';
$lang['You have %s inactive plugins'] = 'יש לך %s תוספים לא פעילים';
$lang['You have %s1 orphan : %s2'] = 'יש לך %s1 יתום: %s2';
$lang['You have unsaved changes'] = 'יש לך שינויים שלא נשמרו';
$lang['Your selection'] = 'הבחירה שלך';
$lang['Unlocked album'] = 'אלבום נפתח';
$lang['Unset as group for new users'] = 'הסר כקבוצה עבור משתמשים חדשים';
$lang['Update'] = 'עדכן';
$lang['Upload Formats'] = 'העלאת פורמטים';
$lang['User "%s" dissociated from this group'] = 'המשתמש "%s" הופרד מקבוצה זו';
$lang['User associated'] = 'המשתמש שוייך';
$lang['User updated'] = 'המשתמש עודכן';
$lang['Username successfully modified'] = 'שם המשתמש שונה בהצלחה';
$lang['Users not logged in will have these settings applied, these settings are used by default for new users'] = 'המשתמשים שלא מחוברים יזכו בהגדרות אלה, הגדרות אלו משומשות כברירת מחדל עבור משתמשים חדשים';
$lang['Version %s'] = 'גרסה %s';
$lang['Videos'] = 'סרטונים';
$lang['Visit history'] = 'היסטוריית ביקורים';
$lang['Visited'] = 'ביקרו';
$lang['There is multiple image in the database with the following names : %s.'] = 'יש מספר תמונות בבסיס הנתונים עם השמות הבאים: %s.';
$lang['This album is currently locked, visible only to administrators.'] = 'האלבום הזה נעול כרגע, וניתן לראותו רק על ידי מנהלים.';
$lang['This albums is already in related categories list'] = 'האלבום הזה כבר ברשימת אלבומים קשורים';
$lang['This is already the default theme'] = 'זה כבר העיצוב ברירת המחדל';
$lang['This photo is an orphan'] = 'התמונה הזו היא יתומה';
$lang['This photo no longer exists'] = 'התמונה הזו כבר לא קיימת';
$lang['This picture is physically linked to this album, you can\'t dissociate them'] = 'תמונה זו מחוברת פיזית לאלבום הזה, אינך יכול להפריד ביניהם.';
$lang['This plugin has no recent update'] = 'לתוסף הזה אין עדכון אחרון';
$lang['This plugin have been updated recently'] = 'התוסף הזה עודכן לאחרונה';
$lang['This plugin have no update since 3 years ! It may be outdated'] = 'לתוסף הזה אין עדכון כבר 3 שנים! ייתכן שהוא מיושן';
$lang['This plugin is incompatible with your version'] = 'התוסף הזה אינו תואם לגרסה שלך';
$lang['This plugin was updated less than 6 months ago'] = 'התוסף הזה עודכן לפני פחות מ-6 חודשים';
$lang['This user must first be defined as the webmaster before it can be upgraded to the main user'] = 'המשתמש הזה חייב להיות מוגדר קודם כל כמנהל האתר לפני שניתן לשדרגו למשתמש הראשי';
$lang['Tile View'] = 'תצוגת ריבועים';
$lang['To be sure, please rewrite the word “%s” below'] = 'כדי להיות בטוח, אנא כתוב מחדש את המילה "%s" למטה';
$lang['Try now !'] = 'נסה עכשיו!';
$lang['Understood, do not show again'] = 'הבנתי, אל תראה שוב';
$lang['Unlock it'] = 'פתח אותו';
$lang['Showing %s users out of %s'] = 'מציג %s משתמשים מתוך %s';
$lang['Some photos are missing from your file system. Details provided by plugin Check Uploads'] = 'חלק מהתמונות חסרות ממערכת הקבצים שלך. פרטים מסופקים על ידי התוסף Check Uploads';
$lang['Storage'] = 'אחסון';
$lang['Synchronization'] = 'סנכרון';
$lang['System Activities'] = 'פעילויות מערכת';
$lang['Tag "%s" created'] = 'התג "%s" נוצר';
$lang['Tag "%s" succesfully deleted'] = 'התג "%s" נמחק בהצלחה';
$lang['Tag "%s1" renamed in "%s2"'] = 'התג "%s1" שונה ל-"%s2"';
$lang['Tag Manager'] = 'מנהל תגים';
$lang['Tag name'] = 'שם תג';
$lang['Tags \{%s\} succesfully deleted'] = 'התגים {\%s}\ נמחקו בהצלחה';
$lang['The %d tags on this page are selected'] = 'התגים %d בדף זה נבחרו';
$lang['The best is to have them made automatically on a regular basis.'] = 'הכי טוב שיהיו מיוצרים אוטומטית באופן קבוע';
$lang['The original picture will be detected with the filename (without extension).'] = 'התמונה המקורית תזוהה לפי שם הקובץ (ללא סיומת).';
$lang['The other tags will be removed'] = 'התגים האחרים יוסרו';
$lang['The passwords do not match'] = 'הסיסמאות אינן תואמות';
$lang['Theme'] = 'עיצוב';
$lang['Tag(s) \{%s1\} succesfully merged into "%s2"'] = 'התג(ים) {\%s1}\ מוזגו בהצלחה ל-"%s2"';
$lang['Select groups or type them'] = 'בחר קבוצות או הקלד אותן';
$lang['Select or create an album'] = 'בחר או צור אלבום';
$lang['Selected user'] = 'משתמש נבחר';
$lang['Selection mode'] = 'מצב בחירה';
$lang['Sep'] = 'ספטמבר';
$lang['Set as default'] = 'הגדר כברירת מחדל';
$lang['Set as group for new users'] = 'הגדר כקבוצה למשתמשים חדשים';
$lang['Set as main user'] = 'הגדר כמשתמש הראשי';
$lang['Show'] = 'הצג';
$lang['Show beta test plugins'] = 'הצג תוספים בבדיקת בטא';
$lang['Show inactive plugins'] = 'הצג תוספים שאינם פעילים';
$lang['Show plugins compatible with previous version of Piwigo'] = 'הצג תוספים תואמים לגרסה קודמת של Piwigo';
$lang['Show sub-albums'] = 'הצג תתי-אלבומים';
$lang['Shrink'] = 'צמצם';
$lang['Put at the root'] = 'שמור בשורש';
$lang['Rating greater than'] = 'דירוג גבוה מ';
$lang['Read the release note'] = 'קרא את הערות הגירסה';
$lang['Refresh thumbnail'] = 'רענן תמונת תצוגה';
$lang['Registered'] = 'נרשם';
$lang['Remove thumbnail'] = 'הסר תמונת תצוגה';
$lang['Rename "%s"'] = 'שנה שם ל "%s"';
$lang['Requires PHP %s'] = 'דורש PHP %s';
$lang['Resend password link'] = 'שלח קישור לאיפוס סיסמה';
$lang['Restored'] = 'שוחזר';
$lang['Review'] = 'סקירה';
$lang['Root'] = 'שורש';
$lang['Save'] = 'שמור';
$lang['Search albums'] = 'חפש אלבומים';
$lang['Search tips'] = 'טיפים לחיפוש';
$lang['Select'] = 'בחר';
$lang['Select all %d tags'] = 'בחר את כל תגי %d';
$lang['Select an album... or type it!'] = 'בחר אלבום... או הקלד אותו!';
$lang['Pagination has changed and needs to be reloaded !'] = 'הדפדוף השתנה ויש לטעון מחדש!';
$lang['Password copied'] = 'הסיסמה הועתקה';
$lang['Photos per page'] = 'תמונות לעמוד';
$lang['Picture to associate formats with'] = 'תמונה כדי לקשר פורמטים איתה';
$lang['Piwigo core'] = 'ליבת Piwigo';
$lang['Piwigo is also on mobile.'] = 'Piwigo זמין גם במובייל.';
$lang['Place first'] = 'מקום ראשון';
$lang['Place last'] = 'מקום אחרון';
$lang['Please complete all fields'] = 'אנא מלא את כל השדות';
$lang['Please upgrade your PHP version before any update.'] = 'אנא עדכן את גרסת ה-PHP שלך לפני כל עדכון.';
$lang['Plugin "%s" deleted!'] = 'התוסף "%s" נמחק!';
$lang['Plugin "%s" has been activated!'] = 'התוסף "%s" הופעל!';
$lang['Portraits'] = 'דיוקנאות';
$lang['Posted %s'] = 'פורסם %s';
$lang['Promote mobile app on mobile devices'] = 'קדם את אפליקציית המובייל במכשירים ניידים';
$lang['Properties of abums'] = 'מאפיינים של אלבומים';
$lang['Purge Actions'] = 'ניקוי פעולות';
$lang['Purge Cache'] = 'ניקוי מטמון';
$lang['No format for this picture'] = 'אין פורמט לתמונה זו';
$lang['No picture found with the following name : %s.'] = 'לא נמצאה תמונה עם השם הבא: %s.';
$lang['No plugin activated'] = 'אין תוסף מופעל';
$lang['No plugins found'] = 'לא נמצאו תוספים';
$lang['No research in progress'] = 'אין חיפוש בתהליך';
$lang['No search in progress'] = 'אין חיפוש בתהליך';
$lang['No tag found'] = 'לא נמצא תג';
$lang['No, I have changed my mind'] = 'לא, שיניתי את דעתי';
$lang['Nov'] = 'נובמבר';
$lang['Object'] = 'אובייקט';
$lang['Oct'] = 'אוקטובר';
$lang['Ok, got it!'] = 'אוקי, הבנתי!';
$lang['On %d rating(s)'] = 'על %d דירוגים';
$lang['Only admins in a specific group'] = 'רק מנהלים בקבוצה מסוימת';
$lang['Open in gallery'] = 'פתח בגלריה';
$lang['Other'] = 'אחר';
$lang['Page Visited'] = 'דף נראה';
$lang['Page Visited in %s'] = 'דף נראה ב %s';
$lang['Locked albums are disabled for maintenance. Only administrators can view them in the gallery. Lock this album will also lock his Sub-albums'] = 'אלבומים נעולים מושבתים לתחזוקה. רק מנהלי המערכת יכולים לראות אותם בגלריה. נעילת אלבום זה תנעול גם את תתי-האלבומים שלו.';
$lang['Main user'] = 'משתמש ראשי';
$lang['Manage album photos'] = 'ניהול תמונות אלבום';
$lang['Manage sub-albums'] = 'ניהול תמונות אלבום';
$lang['Manage users'] = 'ניהול משתמשים';
$lang['Manage users with user manager'] = 'ניהול משתמשים עם מנהל משתמשים';
$lang['Mar'] = 'מרץ';
$lang['May'] = 'מאי';
$lang['Memories'] = 'מזכרות';
$lang['Merge'] = 'מזג';
$lang['Metadata sync complete'] = 'סנכרון מטה-נתונים הושלם';
$lang['Modified'] = 'שונה';
$lang['More information'] = 'מידע נוסף';
$lang['Name field must not be empty'] = 'שדה השם לא יכול להיות ריק';
...
$lang['Change logo'] = 'שנה לוגו';
$lang['Dark mode'] = 'מצב כהה';
$lang['Display Gallery title'] = 'הצג כותרת גלריה';
$lang['Light mode'] = 'מצב בהיר';
$lang['Personalization settings'] = 'הגדרות התאמה אישית';
$lang['Select a color theme for standard pages'] = 'בחר ערכת צבעים עבור דפים רגילים';
$lang['Standard pages'] = 'דפים רגילים';
$lang['Standard pages aren\'t activated, however you have %d active themes that will still use them. These themes are:'] = 'דפים רגילים אינם מופעלים, אך יש לך %d ערכות נושא פעילות שעדיין ישתמשו בהם. ערכות הנושא הללו הן:';
