...
$lang['Ok, got it!'] = 'Ок, принято!';
$lang['No comments selected, no actions possible.'] = 'Комментарии не выбраны, никакие действия невозможны';
$lang['If a photo in this album has the same filename, update the file without changing the photo\'s properties'] = 'Если фото в этом альбоме имеет то же имя файла, обновите файл без изменения свойств фото';
$lang['First choose an album, then add your files'] = 'Сначала выберите альбом, затем добавьте Ваши файлы';
$lang['Create your first album'] = 'Создайте Ваш первый альбом';
$lang['Create and select'] = 'Создать и выбрать';
$lang['Create a root album'] = 'Создать корневой альбом';
$lang['Core'] = 'Ядро';
$lang['Copy the password link'] = 'Скопируйте ссылку на пароль';
$lang['Copy the link below and send it to the user so the password can be set.'] = 'Скопируйте ссылку ниже и отправьте ее пользователю для установки пароля';
$lang['Copy password'] = 'Скопировать пароль';
$lang['Copied link'] = 'Ссылка скопирована';
$lang['Changes saved'] = 'Изменения сохранены';
$lang['Cannot send an email to this user because he doesn\'t have an email address'] = 'Невозможно отправить письмо пользователю, потому что у него нет почтового адреса';
$lang['Auto-update'] = 'Авто-обновление';
$lang['Are you sure you want to delete comment #%s?'] = 'Вы уверены, что хотите удалить комментарий #%s?';
$lang['Are you sure you want to delete "%d" comments?'] = 'Вы уверены, что хотите удалить "%d"  комментариев?';
$lang['An error has occured'] = 'Произошла ошибка';
$lang['An activation link valid for %s was created but could not be sent. You can now copy the link below and send it to the user.'] = 'Ссылка для активации, действительная до  %s , была создана, но не может быть отправлена. Вы можете сейчас скопировать ссылку ниже и отправить ее пользователю.';
$lang['Admins only'] = 'Только для администраторов';
$lang['Added on %s'] = 'Добавлено %s';
$lang['Add a sub-album to “%s”'] = 'Добавьте под-альбом в "%s"';
$lang['Resend password link'] = 'Повторно отправить ссылку с паролем';
$lang['Read the release note'] = 'Прочтите сведения о версии';
$lang['Please complete all fields'] = 'Пожалуйста, заполните все поля';
$lang['Personalization settings'] = 'Персональные настройки';
$lang['Password copied'] = 'Пароль скопирован';
$lang['Metadata sync complete'] = 'Синхронизация метаданных завершена';
$lang['Main user'] = 'Главный пользователь';
$lang['Light mode'] = 'Светлый режим';
$lang['Image'] = 'Изображение';
$lang['Follow the update guide'] = 'Следуйте руководству по обновлению';
$lang['Empty lounge'] = 'Очистить зону загрузки';
$lang['Display Gallery title'] = 'Показать заголовок Галереи';
$lang['Dark mode'] = 'Темный режим';
$lang['Change logo'] = 'Изменить логотип';
$lang['An activation link valid for %s has been sent to "%s". If the user doesn\'t receive the link, you can generate and copy a new one by editing the user and managing her password.'] = 'Ссылка для активации, действительная для %s была отправлена "%s". Если ссылка не получена, новая ссылка может быть сгенерирована и скопирована при редактировании пользователя и управлении его паролем.';
$lang['%s is the new main user'] = '%s теперь новый главный пользователь';
$lang['A photo library administrator has created the following account for you:'] = 'Администратор фотогалереи создал следующий аккаунт для Вас:';
$lang['%d photos were moved from the upload lounge to their albums'] = '%d фотографий были перенесены из зоны загрузки в их альбомы';
$lang['Changing the main user'] = 'Изменение главного пользователя';
$lang['user_status_normal'] = 'Основной';
$lang['You cannot copy the password if the connection to this site is not secure.'] = 'Вы не можете скопировать пароль, если соединение с этим сайтом небезопасно.';
$lang['You have unsaved changes'] = 'У Вас есть несохраненные изменения';
$lang['between %d and %d'] = 'между %d и %d';
$lang['image(s) contains unsaved changes'] = 'изображение(я) содержит(ат) несохраненные изменения';
$lang['level of confidentiality'] = 'уровень конфиденциальности';
$lang['was succesfully deleted'] = 'был успешно удален';
$lang['You can now change the main user from %s to %s.'] = 'Теперь Вы можете изменить главного пользователя с %s на %s.';
$lang['You are not authorised to change the main user, please ask your webmaster'] = 'У Вас нет прав для изменения главного пользователя, пожалуйста, обратитесь к вебмастеру';
$lang['You are about to set %s as main user instead of %s, do you wish to continue ?'] = 'Вы собираетесь установить %s как главного пользователя вместо %s, хотите ли Вы продолжить?';
$lang['You are about to delete %s groups, are you sure?'] = 'Вы собираетесь удалить %s групп, Вы уверены?';
$lang['Yes, let\'s proceed'] = 'Да, давайте продолжим';
$lang['Who can see ?'] = 'Кто может видеть?';
$lang['When enabled, a common template is used for the login, registration and forgotten password pages, regardless of the theme. Some themes might use these templates even if you uncheck this option'] = 'Когда разрешен, общий шаблон используется для страниц входа, регистрации и страницы восстановления забытого пароля, вне зависимости от используемой темы. Некоторые темы используют общий шаблон даже, если Вы отмените эту опцию';
$lang['What\'s new in version %s'] = 'Что нового в версии %s?';
$lang['We have found %d duplicate paths. Details provided by plugin Check Uploads'] = 'Мы обнаружили %d дубликатов. Подробности представлены расширением Проверка Загрузок (Check Uploads)';
$lang['Username successfully modified'] = 'Имя пользователя успешно изменено';
$lang['Use standard Piwigo template for common pages.'] = 'Использовать стандартный шаблон Piwigo для общих страниц';
$lang['Use custom logo (png, jpeg or svg)'] = 'Использовать пользовательский логотип (файлы png, jpeg или svg)';
$lang['Use Piwigo logo'] = 'Использовать логотип Piwigo';
$lang['Two container updates are available'] = 'Два обновления контейнера доступны';
$lang['To set your password, visit the following address:'] = 'Чтобы установить Ваш пароль, перейдите по следующему адресу:';
$lang['This user must first be defined as the webmaster before it can be upgraded to the main user'] = 'Этот пользователь сначала должен быть определен как вебмастер, до того, как он будет обновлен до главного пользователя';
$lang['To be sure, please rewrite the word “%s” below'] = 'Чтобы быть уверенными, пожалуйста, перепишите слово %s” ниже';
$lang['This link is valid for %s. After this time, you will need to request a new link.'] = 'Эта ссылка действительно до %s. После этого времени Вам будет необходимо запросить новую ссылку.';
$lang['There is currently %d photos in the lounge (upload buffer)'] = 'Сейчас %d фотографий в зоне загрузки (буфере загрузки)';
$lang['The passwords do not match'] = 'Пароли не совпадают';
$lang['System Activities'] = 'Действия в системе';
$lang['The comments have been validated.'] = 'Комментарии были проверены.';
$lang['The comment has been validated.'] = 'Комментарий был проверен.';
$lang['Standard pages header'] = 'Заголовок стандартных страниц';
$lang['Standard pages aren\'t activated, however you have %d active themes that will still use them. These themes are:'] = 'Стандартные страницы не активированы, однако у Вас есть %d активных тем, которые их будут использовать. Эти темы:';
$lang['Standard pages'] = 'Стандартные страницы';
$lang['Set as main user'] = 'Установить как главного пользователя';
$lang['Pagination has changed and needs to be reloaded !'] = 'Разбиение на страницы изменилось, перезагрузите страницу!';
$lang['Select or create an album'] = 'Выбрать или создать альбом';
$lang['Select a color theme for standard pages'] = 'Выбрать цветовую тему для стандартных страниц';
