...
$lang['An error has occured please got back to <a href="identification.php" title="Sign in">Sign in</a> or <a href="register.php">Register</a>'] = 'On tapahtunut virhe, mene takaisin<a href="identification.php" title="Kirjaudu">kirjautumissivulle</a> tai <a href="register.php">rekisteröidy</a>
';
$lang['Hello <em>%s</em>, enter your new password below.'] = 'Hei <em>%s</em>, syötä salasanasi alle.';
$lang['Here is your verification code:'] = 'Tässä vahvistuskoodisi:';
$lang['Hide expired keys'] = 'Piilota vanhentuneet avaimet';
$lang['ID copied.'] = 'Tunnus kopioitu.';
$lang['Don\'t have an account yet ?'] = 'Ei vielä tiliä?';
$lang['Edit API Key'] = 'Muokkaa API-avainta';
$lang['Expert mode'] = 'Asiantuntijatila';
$lang['Generate API Key'] = 'Luo API-avain';
$lang['Generate key'] = 'Luo avain';
$lang['When enabled, a common template is used for the login and registration pages, regardless of the theme.'] = 'Kun tämä on päällä, yhteistä sivupohjaa käytetään kirjautumis- ja rekisteröitymissivuilla, teemavalinnasta riippumatta.';
$lang['You can manage your API keys in your <a href="%s">account settings.</a>'] = 'Voit hallita API-avaimiasi <a href="%s">tiliasetuksissa.</a>';
$lang['You have no email address, so you will not be notified when your API key is about to expire.'] = 'Sinulla ei ole sähköpostiosoitetta, joten et saa ilmoitusta kun API-avaimesi on vanhenemassa.';
$lang['Your API key will expire in %d day.'] = 'API-avaimesi vanhenee %d päivän kuluessa.';
$lang['Your API key will expire in %d days.'] = 'API-avaimesi vanhenee %d päivässä.';
$lang['Your API key will expire soon'] = 'API-avaimesi vanhenee pian';
$lang['Your changes have been applied.'] = 'Muutokset on otettu käyttöön.';
$lang['Your password was successfully reset'] = 'Salasanasi nollaaminen onnistui';
$lang['Your password was successfully set'] = 'Salasanan asettaminen onnistui';
$lang['Your verification code'] = 'Vahvistukoodisi';
$lang['edit user preferences'] = 'Muokkaa käyttäjäasetuksia';
$lang['must not be empty'] = 'ei saa olla tyhjä';
$lang['you must choose a date'] = 'on valittava päivämäärä';
$lang['The email %s will be used to notify you when your API key is about to expire.'] = 'Sähköpostiosoitteeseen %s ilmoitetaan kun API-avaimesi on vanhenemassa.';
$lang['The secret key can no longer be displayed.'] = 'Salaisuutta ei voida enää näyttää.';
$lang['The secret will no longer be displayed. You must copy it to continue.'] = 'Salaisuutta ei enää näytetä. Sinun on kopioitava se jatkaaksesi.';
$lang['This API key was manually revoked on %s'] = 'API-avain peruttiin manuaalisesti %s';
$lang['To continue using the API, please renew your key before it expires.'] = 'Jatkaaksesi rajapinnan käyttöä, uusi avaimesi ennenkö se vanhenee.';
$lang['To manage your API keys, please log in with your username/password.'] = 'Hallitaksesi API-avaimiasi, kirjaudu käyttäjätunnuksella ja salasanalla.';
$lang['Too many attempts, please try later..'] = 'Liian monta yritystä, yritä myöhemmin uudelleen.';
$lang['Verification code'] = 'Vahvistuskoodi';
$lang['Verification successful! You can now choose a new password.'] = 'Vahvistus onnistui! Voit nyt valita uuden salasanan.';
$lang['Verify'] = 'Vahvista';
$lang['Return to <a href="identification.php" title="Sign in">Sign in</a>'] = 'Palaa <a href="identification.php" title="Sign in">kirjautumissivulle</a>';
$lang['Return to the gallery'] = 'Palaa galleriaan';
$lang['Revoke'] = 'Peru';
$lang['Revoked'] = 'Peruttu';
$lang['Save your ID and secret'] = 'Tallenna tunnus ja salaisuus';
$lang['Secret copied. Keep it in a safe place.'] = 'Salaisuus kopioitu. Säilytä se turvallisesti.';
$lang['Set my password'] = 'Aseta salasanani';
$lang['Show expired keys'] = 'Näytä vanhentuneet avaimet';
$lang['The api key has been successfully created.'] = 'API-avaimen luonti onnistui.';
$lang['If your account exists, a verification code has been sent to your email address.'] = 'Jos tilisi on olemassa, vahvistuskoodi on lähetetty sähköpostiosoitteeseesi.';
$lang['Impossible to copy automatically. Please copy manually.'] = 'Automaattinen kopiointi ei onnistu, kopioi käsin.';
$lang['Invalid verification code'] = 'Virheellinen vahvistuskoodi';
$lang['Last use'] = 'Edellinen käyttö';
$lang['Manage your account'] = 'Hallinoi tiliäisi';
$lang['Never'] = 'Ei koskaan';
$lang['New API Key'] = 'Uusi API-avain';
$lang['No expiration'] = 'Ei vanhenemista';
$lang['Options'] = 'Asetukset';
$lang['Custom date'] = 'Muu aika';
$lang['If this wasn\'t you, please change your password immediately or contact your webmaster.'] = 'Jos tämä et ollut sinä, vaihda salasanasi välittömästi ja/tai ole yhteydessä sivuston ylläpitäjään.';
$lang['If you changed your password because you think it was stolen, we recommend revoking your %d API keys <a href="%s">in your profile</a>.'] = 'Jos vaihdoit salasanasi koska luulet sen joutuneen vääriin käsiin, suosittelemme myös perumaan %d API-avainta <a href="%s">profiilisivun</a> kautta.';
$lang['If you do not receive the email, please contact your webmaster.'] = 'Jos sähköposti ei saavu, ota yhteyttä sivuston ylläpitäjään.';