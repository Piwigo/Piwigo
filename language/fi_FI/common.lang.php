...
$lang['Not repeat the slideshow'] = 'Ã„lä toista diaesitystä';
...
$lang['Send my connection settings by email'] = 'Lähetä yhteysasetukset sähköpostilla';
...
$lang['square'] = 'Neliö';
$lang['Successfully registered, you will soon receive an email with your connection settings. Welcome!'] = 'Rekisteröinti onnistui, saat kohta sähköpostissa yhteysasetukset. Tervetuloa käyttäjäksi!';
...
$lang['The RSS notification feed provides notification on news from this website : new photos, updated albums, new comments. Use a RSS feed reader.'] = 'RSS-syöte tarjoaa ilmoitukset uusista tapahtumista tällä sivustolla: uudet kuvat, päivitetyt albumit ja uudet kommentit. Käytä RSS -lukijaa.';
...
$lang['useful when password forgotten'] = 'hyödyllinen mikäli unohdat salasanasi';
...
$lang['You will receive a link to create a new password via email.'] = 'Saat sähköpostiisi linkin uuden salasanan luomista varten.';
