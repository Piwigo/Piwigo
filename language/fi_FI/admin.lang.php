...
$lang['%s ago'] = '%s sitten';
$lang['... or '] = '... tai';
$lang['%d years'] = '%d vuotta';
$lang['%d year'] = '%d vuosi';
$lang['%d week'] = '%d viikko';
$lang['%d weeks'] = '%d viikoa';
$lang['%d seconds'] = '%d sekuntia';
$lang['%d users deleted'] = '%d käyttäjää poistettu';
$lang['%d users'] = '%d käyttäjää';
$lang['%d user'] = '%d käyttäjä';
$lang['%d second'] = '%d sekunti';
$lang['%d photo was deleted'] = '%d kuva poistettu';
$lang['%d photos uploaded'] = '%d kuvaa ladattu';
$lang['%d photos were deleted'] = '%d kuvaa poistettu';
$lang['%d month'] = '%d kuukausi';
$lang['%d months'] = '%d kuukautta';
$lang['%d minute'] = '%d minuutti';
$lang['%d minutes'] = '%d minuuttia';
$lang['%d groups'] = '%d ryhmää';
