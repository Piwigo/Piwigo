...
$lang['You need to upgrade your system to take full advantage of the application else the application will not work correctly, or not at all'] = 'És necessari actualitzar el sistema per a poder treure partit de totes les funcionalitats de l\'aplicació. Fins que no s\'actualitzi, és possible que l\'aplicació no funioni correctament.';
