...
$lang['Check for upgrade'] = 'Comprovar si hi ha una nova versió disponible';
...
$lang['Manage tags'] = 'Gestinar etiquetes';
...
$lang['Page banner'] = 'Informació de la capçalera del lloc web';
...
$lang['Select at least one album'] = 'Seleccioni almenys un àlbum';
$lang['Select at least one photo'] = 'Seleccioni almenys una foto';
$lang['Select at least one user'] = 'Seleccioni almenys un usuari';
...
$lang['Virtual album deleted'] = 'L\'àlbum virtual s\'ha eliminat correctament';
...
$lang['manage album photos'] = 'Gestionar les fotos de l\'àlbum';
...
$lang['Execution time is out, treatment must be continue [Estimated time: %d seconds].'] = 'S\'ha superat el temps d\'execució. El tractament ha de continuar [Temps estimat: %d segons].';
...
$lang['Go to'] = 'Vés a';
$lang['Hello'] = 'Hola';
$lang['New photos were added'] = 'S\'han afegit noves fotos';
$lang['on'] = 'sobre';
$lang['between'] = 'entre';
$lang['and'] = 'i';
...
$lang['New photos added'] = 'Noves fotos afegides';
...
$lang['User %s [%s] was added to the subscription list.'] = 'L\'usuari %s [%s] ha estat afegit a la llista d\'inscripcions.';
...
$lang['User %s [%s] was not added to the subscription list.'] = 'L\'usuari %s [%s] no ha estat afegit a la llista d\'inscripcions.';
...
$lang['Edit photo information'] = 'Edita informació de la foto';
...
$lang['The file or directory cannot be accessed (either it does not exist or the access is denied)'] = 'No es pot accedir o a l\'arxiu o directori (potser no existeix o l\'accès està denegat)';
...
$lang['photos updated in the database'] = 'fotos actualitzades de la base de dades';
$lang['Search for new images in the directories'] = 'Cercar noves fotos en els directoris';
$lang['added'] = 'afegit';
...
$lang['synchronize files metadata with database photos informations'] = 'Sincronitzar les fotos de la base de dades amb els arxius de metadades';
...
$lang['add new photos to caddie'] = 'Afegir noves fotos al carret';
...
$lang['%d photos were deleted'] = '%d fotos eliminades';
...
$lang['Set as default theme for unregistered and new users'] = 'Establir com a tema predeterminat pels visitants no registrats i pels nous usuaris';
...
$lang['create a new album'] = 'Afegir un nou àlbum';
$lang['Album name'] = 'Nombre del álbum';
$lang['Album "%s" has been added'] = 'S\'ha afegit l\'àlbum "%s"';
$lang['Uploaded Photos'] = 'Fotos añadidas';
$lang['%d photos uploaded'] = '%d fotos afegides';
$lang['Privacy level set to "%s"'] = 'Nivel de confidencialidad "%s"';
$lang['Album "%s" now contains %d photos'] = 'L\'àlbum "%s" ara conté %d fotos';
$lang['Manage this set of %d photos'] = 'Administra aquest lot de %d fotos';
...
$lang['Help Me'] = 'Ajuda';
$lang['Impossible to activate this theme, the parent theme is missing: %s'] = 'Impossible habilitar aquest tema mentre no es trobi l\'arxiu %s';
...
$lang['Start pLoader and add your photos.'] = 'Engega pLoader i penja les teves fotos.';
...
$lang['By %s'] = 'Desenvolupat per %s';
$lang['Visit plugin site'] = 'Visita el lloc web del connector';
...
$lang['Impossible to deactivate this language, first set another language as default.'] = 'Per a poder deshabilitar aquest idioma cal abans definir-ne un altre per defecte';
$lang['Impossible to deactivate this language, you need at least one language.'] = 'Aquest és l\'únic idioma disponible de la galeria. Per a poder-lo deshabilitar cal abans habilitar-ne un altre.';
...
$lang['Unknown upload error'] = 'Hi ha hagut un error desconegut en pujar les fotos';
...
$lang['Batch Manager'] = 'Gestionar lots';
...
$lang['No photo selected, %d photos in current set'] = 'No hi ha cap foto seleccionada entre les %d fotos del lot';
$lang['All %d photos are selected'] = 'Totes les %d fotos han estat seleccionades';
...
$lang['Refresh photo set'] = 'Actualitzar el lot de fotos';
$lang['The whole page'] = 'Pàgina sencera';
$lang['The whole set'] = 'Tot el conjunt';
$lang['No photo in the current set.'] = 'No hi ha fotos en aquest lot.';
$lang['No photo selected, no action possible.'] = 'Seleccioni almenys una foto per a executar qualsevol acció.';
...
$lang['Album photos associated to the following albums: %s'] = 'Les fotos de l\'àlbum ha estat associades amb els àlbums següents: %s';
...
$lang['Visit theme site'] = 'Visitar el web del tema';
...
$lang['THIS PLUGIN IS NOW PART OF PIWIGO CORE! DELETE IT NOW.'] = 'AQUEST CONNECTOR ÉS ARA PART DEL CORE DE PIWIGO! DESINSTAL·LA\'L! ';
...
$lang['%s photos can not be regenerated'] = 'no es poden regenerar %s fotos';
...
$lang['You can\'t define a default photo order because you have a custom setting in your local configuration.'] = 'No es pot definir un ordre predeterminat de les fotos perquè hi ha establerta una configuració personalitzada a la configuració local de l\'aplicació.';
...
$lang['You are using the Flash uploader. Problems? Try the <a href="%s">Browser uploader</a> instead.'] = 'Utilitzar el <a href="%s">formulari HTML</a> per a carregar les fptps al servidor.';
$lang['You are using the Browser uploader. Try the <a href="%s">Flash uploader</a> instead.'] = 'Utilitzar el <a href="%s">formulari FLASH</a> per a carregar les fotos al servidor.';
...
$lang['By default, Piwigo will create a new websize from the HD (high definition) version of your photo.'] = 'Per defecte, Piwigo crearà una nova mida del web procedent de les fotos en mode d\'alta qualitat';
...
$lang['An error has occured during upgrade.'] = 'Hi ha hagut un error durant el procés d\'actualització.';
$lang['An error has occured during extract. Please check files permissions of your piwigo installation.<br><a href="%s">Click here to show log error</a>.'] = 'Impossible extreure els arxius. Si us plau, verifiqui els permisos dels arxius d\'instal·lació.<br><a href="%s">Faci clic aquí per veure el registre d\'errors</a>.';
...
$lang['Resize after upload'] = 'Redimensionar després de carregar la foto al servidor';
...
$lang['You can activate only one mobile theme.'] = 'Només habilitar-se un tema pel dispositiu mòbil.';
$lang['Zoom'] = 'Ampliar';
$lang['add a new watermark'] = 'afegeix una nova marca d\'aigua';
$lang['administrators'] = 'administradors';
$lang['apply automatic sort order'] = 'Ordenar automàticament';
...
$lang['Features include gallery browsing, album creation and photo upload.'] = 'Les característiques inclouen la navegació per la galeria, la creació d\'àlbum penjar imatges.';
$lang['For photo sizes with crop, such as "Square", Piwigo will do its best to include the center of interest.'] = 'Per a les fotos amb mides sesgades, per exemple les quadrades, Piwigo farà tot el possible per a ressaltar-ne el seu punt d\'interès.';
$lang['Grant selected groups'] = 'Permetre als grups seleccionats';
$lang['Manage permissions for group "%s"'] = 'Gestió de permisos per al grup "%s"';
...
$lang['Photo sizes with crop'] = 'Fotos amb mides sesgades';
...
$lang['The center of interest is the most meaningful zone in the photo.'] = 'El centre d\'interès és la zona més significativa d\'una foto.';
...
$lang['bottom left corner'] = 'Cantonada inferior esquerra';
$lang['bottom right corner'] = 'Cantonada inferior dreta';
...
$lang['top left corner'] = 'Cantonada superior esquerra';
