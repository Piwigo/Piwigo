...
$lang['Please check "plugins" folder and sub-folders permissions (CHMOD).'] = 'Si us plau, reviseu els permisos de la carpeta dels complements "plugins", així com a les seves subcarpetes (CHMOD).';
...
$lang['Visit plugin site'] = 'Visitar el web del complement';
...
$lang['The Piwigo export plugin allows you to create albums and export photos.'] = 'El complement Piwigo Export li permet crear àlbums i exportar fotos.';
$lang['The Piwigo publish Plug-in allows you to export and synchronize photos from Lightroom directly to your Piwigo photo gallery.'] = 'El complement Piwigo Publish et permet exportar i sincronitzar fotos des de Lightroom directament a la seva galeria de fotos Piwigo.';
...
$lang['To export your photos from digiKam to Piwigo, simply install digiKam and the Kipi-plugins.'] = 'Per a exportar les teves fotos des de digiKam a Piwigo, hauràs d\'instal·lar els complements digiKam i Kipi.';
