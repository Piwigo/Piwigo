...
$lang['Tag'] = 'Etiqueta';
$lang['Tags'] = 'Etiquetes';
$lang['The RSS notification feed provides notification on news from this website : new photos, updated albums, new comments. Use a RSS feed reader.'] = 'La font de redifusió amb format RSS et proporciona notificacions automàtiques de les novetats d\'aquest lloc web: noves fotos, actualitzacions en els àlbums, nous comentaris... Utilitza un lector de canal RSS.';
...
$lang['Anti-flood system : please wait for a moment before trying to post another comment'] = 'Sistema de prevenció anti col·lapse. Si us plau, espereu un moment abans de provar d\'enviar un altre comentari. El servidor està processant peticions d\'altres usuaris.';
...
$lang['display all photos in all sub-albums'] = 'Vista per elements';
...
$lang['display a set of random photos'] = 'visualitza un conjunt d\'imatges a l\'atzar';
...
$lang['Hello %s, your Piwigo photo gallery is empty!'] = 'Hola %s, la galeria fotogràfica és buida!';
...
$lang['Please enter your username or email address.'] = 'No t\'amoïnis. Introdueix el teu nom d\usuari o el correu electrònic que vas emprar per donar-te d\'alta.';
