...
$lang['%d album including'] = '%d kategoria zawierająca ';
$lang['%d albums including'] = '%d kategorii zawierających ';
$lang['%d physical'] = '%d fizycznie';
$lang['%d physical'] = '%d fizycznie';
$lang[' and %d virtual'] = ' i %d wirtualnie';
$lang[' and %d virtual'] = ' i %d wirtualnie';
$lang['%d album moved'] = '%d kategoria przeniesiona';
$lang['%d albums moved'] = '%d kategorii przeniesionych';
...
$lang['Apply to sub-albums'] = 'Zastosuj do podkategorii';
$lang['Associated'] = 'Powiązane';
$lang['Batch management'] = 'Zarządzanie batch';
$lang['Caddie management'] = 'Zarządzanie koszykiem';
$lang['Caddie'] = 'Koszyk';
$lang['Albums authorized thanks to group associations'] = 'Kategorie zautoryzowane dzięki powiązaniu z grupami';
$lang['Album manual order was saved'] = 'Zapisano ręcznie wykonaną kolejność kategorii';
$lang['Album elements associated to the following albums: %s'] = 'Elementy kategorii powiązane z następującymi kategoriami: %s';
...
$lang['Link all album elements to a new album'] = 'Podepnij wszystkie elementy kategorii do nowej kategorii';
$lang['Link all album elements to some existing albums'] = 'Podepnij wszystkie elementy kategorii do istniejącej kategorii';
$lang['Linked albums'] = 'Podpięte kategorie';
$lang['Lock gallery'] = 'Zablokuj galerię';
$lang['Maintenance'] = 'Przerwa techniczna';
$lang['Edit album permissions'] = 'Zarządzaj uprawnieniami dla kategorii';
...
$lang['Move albums'] = 'Przenieś kategorie';
$lang['Move'] = 'Przenieś';
$lang['Name'] = 'Nazwa';
$lang['New name'] = 'Nowa nazwa';
$lang['New parent album'] = 'Nowa nadrzędna kategoria';
...
$lang['Only private albums are listed'] = 'Tylko prywatne kategorie zostały wyświetlone';
$lang['Operating system'] = 'System operacyjny';
$lang['Options'] = 'Opcje';
$lang['Other private albums'] = 'Inne kategorie prywatne';
$lang['Page banner'] = 'Banner strony';
$lang['Parent album'] = 'Nadrzędna kategoria';
$lang['Path'] = 'Ścieżka';
$lang['Permalink'] = 'Link permanentny';
$lang['Permalink %s has been previously used by album %s. Delete from the permalink history first'] = 'Link permanentny %s został poprzednio wykorzystany przez %s. Najpierw usuń link z historii';
...
$lang['Permalink %s is already used by album %s'] = 'Link permanentny %s jest już używany przez kategorię %s';
...
$lang['Representation of albums'] = 'Representacja kategorii';
...
$lang['Select at least one album'] = 'Wybierz przynajmniej jedną kategorię';
...
$lang['Storage album'] = 'Miejsce przechowywania kategorii';
...
$lang['Version'] = 'Wersja';
$lang['Virtual albums to move'] = 'Kategorie wirtualne do przeniesienia';
$lang['Virtual album name'] = 'Nazwa kategorii wirtualnej';
...
$lang['You cannot move an album in its own sub album'] = 'Nie możnesz przenieść kategorii do jej własnej podkategorii';
$lang['You need to confirm deletion'] = 'Musisz potwierdzić usunięcie';
$lang['add tags'] = 'dodaj tagi';
$lang['Adviser'] = 'Doradca';
$lang['Associate to album'] = 'powiązane z kategorią';
$lang['associate to group'] = 'powiązane z grupą';
$lang['Authorized'] = 'Zautoryzowane';
$lang['Add a virtual album'] = 'Dodaj wirualną kategorię';
$lang['Authorize users to add comments on selected albums'] = 'Autoryzuj użytkowników by mogli dodawać komentarze do wybranych kategorii';
$lang['The name of an album must not be empty'] = 'Nazwa kategorii nie może być pusta';
$lang['Lock albums'] = 'Zablokuj kategorie';
$lang['Private'] = 'Kategoria prywatna';
$lang['Public'] = 'Kategoria publiczna';
$lang['Find a new representant by random'] = 'Znajdź losowo nowego reprezentanta';
$lang['Public / Private'] = 'Publiczne / Prywatne';
$lang['Manage authorizations for selected albums'] = 'Zarządzaj autoryzacjami dla wybranych kategorii';
$lang['Select uploadable albums'] = 'Zaznacz kategorie, do których można wgrywać';
$lang['Virtual album added'] = 'Dodano wirtualną kategorię';
$lang['Virtual album deleted'] = 'Usunięto wirtualną kategorię';
...
$lang['Date'] = 'Data';
$lang['delete album'] = 'usuń kategorię';
$lang['Dissociate from album'] = 'usuń powiązanie od kategorii';
$lang['dissociate from group'] = 'usuń powiązanie od grupy';
$lang['edit album permissions'] = 'edytuj uprawnienia kategorii';
$lang['Album updated successfully'] = 'Informacje o kategorii zaktualizowano pomyślnie.';
...
$lang['jump to album'] = 'przejdź do kategorii';
$lang['jump to image'] = 'przejdź do obrazu';
$lang['leave'] = 'opuść';
$lang['Lock'] = 'Zablokuj';
$lang['Locked'] = 'Zablokowane';
$lang['manage album elements'] = 'zarządzaj elementami kategorii';
$lang['manage sub-albums'] = 'zarządzaj podkategoriami';
...
$lang['Update albums informations'] = 'Aktualizuj informacje o kategoriach';
$lang['Update images informations'] = 'Aktualizuj informacje o obrazach';
$lang['Synchronize'] = 'Synchronizuj';
$lang['reduce to single existing albums'] = 'zredukuj do pojedynczej istniejącej kategorii';
$lang['Choose an option'] = 'Wybierz opcję';
$lang['display maximum informations (added albums and elements, deleted albums and elements)'] = 'wyświetlaj jak dużo informacji (dodane kategorie i elementy, usunięte kategorie i elementy)';
...
$lang['albums added in the database'] = 'kategorii dodanych do bazy danych';
...
$lang['Files with same name in more than one physical album'] = 'Pliki o tych samych nazwach w jednej lub więcej kategoriach';
...
$lang['edit album'] = 'edytuj informacje o kategorii';
$lang['nothing'] = 'nic';
...
$lang['No element in this album'] = 'Brak elementów w tej kategorii';
...
$lang['Drop into album'] = 'Wgraj do kategorii';
...
$lang['existing album'] = 'istniejąca kategoria';
$lang['create a new album'] = 'stwórz nową kategorię';
$lang['Album name'] = 'Nazwa kategorii';
