...
$lang['Read the release note'] = 'Leia as notas de lançamento';
$lang['What\'s new in version %s'] = 'O que há de novo na versão %s?';
$lang['When enabled, a common template is used for the login, registration and forgotten password pages, regardless of the theme. Some themes might use these templates even if you uncheck this option'] = 'Quando ativado, é utilizado um modelo comum para as páginas de início de sessão, registo e recuperação de palavras-passe, independentemente do tema. Alguns temas podem utilizar estes modelos mesmo que desmarque esta opção.';
$lang['Yes, let\'s proceed'] = 'Sim, vamos prosseguir.';
$lang['You are about to set %s as main user instead of %s, do you wish to continue ?'] = 'Está prestes a definir %s como utilizador principal em vez de %s. Deseja continuar?';
$lang['You are not authorised to change the main user, please ask your webmaster'] = 'Não tem autorização para alterar o utilizador principal. Por favor, peça autorização ao seu webmaster.';
$lang['You can now change the main user from %s to %s.'] = 'Agora pode alterar o utilizador principal de %s para %s.';
$lang['You cannot copy the password if the connection to this site is not secure.'] = 'Não pode copiar a palavra-passe se a ligação a este site não for segura.';
$lang['user_status_normal'] = 'Básico';
$lang['This user must first be defined as the webmaster before it can be upgraded to the main user'] = 'Este utilizador precisa de ser definido como webmaster antes de ser promovido a utilizador principal';
$lang['To be sure, please rewrite the word “%s” below'] = 'Para garantir, reescreva a palavra “%s” abaixo';
$lang['To set your password, visit the following address:'] = 'Para definir a sua palavra-passe, aceda ao seguinte endereço:';
$lang['Use Piwigo logo'] = 'Usar o logótipo do Piwigo';
$lang['Use custom logo (png, jpeg or svg)'] = 'Utilizar um logótipo personalizado (png, jpeg ou svg)';
$lang['Use standard Piwigo template for common pages.'] = 'Utilizar o modelo padrão do Piwigo para páginas comuns.';
$lang['Username successfully modified'] = 'Nome de utilizador modificado com sucesso';
$lang['We have found %d duplicate paths. Details provided by plugin Check Uploads'] = 'Encontrámos %d caminhos duplicados. Detalhes fornecidos pela extensão Verificar carregamentos';
$lang['Welcome to %s'] = 'Bem-vindo(a) ao %s';
$lang['%d photos were moved from the upload lounge to their albums'] = '%d fotos foram movidas da área de upload para os seus álbuns
';
$lang['%s is the new main user'] = '%s é o novo utilizador principal
';
$lang['A photo library administrator has created the following account for you:'] = 'Um administrador da biblioteca de fotografias criou a seguinte conta para si:';
$lang['Admins only'] = 'Somente administradores';
$lang['An activation link valid for %s has been sent to "%s". If the user doesn\'t receive the link, you can generate and copy a new one by editing the user and managing her password.'] = 'Um link de ativação válido para %s foi enviado para "%s". Se o link não for recebido, pode ser gerado um novo e copiado editando o utilizador e gerindo a sua palavra-passe.';
$lang['An activation link valid for %s was created but could not be sent. You can now copy the link below and send it to the user.'] = 'Um link de ativação válido para %s foi criado, mas não pôde ser enviado. Agora pode copiar o link abaixo e enviá-lo para o utilizador.';
$lang['Are you sure you want to delete "%d" comments?'] = 'Tem a certeza que pretende eliminar os comentários "%d"?';
$lang['Are you sure you want to delete comment #%s?'] = 'Tem a certeza que pretende eliminar o comentário #%s?';
$lang['Cannot send an email to this user because he doesn\'t have an email address'] = 'Não é possível enviar um e-mail a este utilizador porque não tem um endereço de e-mail.';
$lang['Change logo'] = 'Alterar logotipo';
$lang['Changing the main user'] = 'Alterar o utilizador principal';
$lang['Copied link'] = 'Link copiado';
$lang['Copy password'] = 'Copiar senha.';
$lang['Copy the link below and send it to the user so the password can be set.'] = 'Copie o link abaixo e envie para o utilizador para que a password possa ser definida.';
$lang['Copy the password link'] = 'Copiar link da palavra-passe';
$lang['Dark mode'] = 'Modo escuro';
$lang['Display Gallery title'] = 'Mostrar título da galeria';
$lang['Empty lounge'] = 'Sala de estar vazia';
$lang['If a photo in this album has the same filename, update the file without changing the photo\'s properties'] = 'Se uma fotografia neste álbum tiver o mesmo nome de ficheiro, atualize o ficheiro sem alterar as propriedades da fotografia';
$lang['Light mode'] = 'Modo claro';
$lang['Main user'] = 'Utilizador principal';
$lang['No comments selected, no actions possible.'] = 'Nenhum comentário selecionado, nenhuma ação possível.';
$lang['Ok, got it!'] = 'Ok, já percebi!';
$lang['Password copied'] = 'Senha copiada';
$lang['Personalization settings'] = 'Configurações de personalização';
$lang['Please complete all fields'] = 'Preencha todos os campos';
$lang['Resend password link'] = 'Reenviar link da palavra-passe';
$lang['Save all photos'] = 'Guardar todas as fotos';
$lang['Select a color theme for standard pages'] = 'Selecionar um tema de cores para as páginas padrão';
$lang['Set as main user'] = 'Definir como utilizador principal';
$lang['Standard pages'] = 'Páginas padrão';
$lang['Standard pages aren\'t activated, however you have %d active themes that will still use them. These themes are:'] = 'As páginas padrão não estão ativadas, mas tem %d temas ativos que ainda as utilizarão. Esses temas são:';
$lang['Standard pages header'] = 'Cabeçalho das páginas padrão';
$lang['The comment has been validated.'] = 'O comentário foi validado.';
$lang['The comments have been validated.'] = 'Os comentários foram validados.';
$lang['The passwords do not match'] = 'As senhas não coincidem';
$lang['There is currently %d photos in the lounge (upload buffer)'] = 'Existem %d fotos no lounge (upload buffer)';
$lang['This link is valid for %s. After this time, you will need to request a new link.'] = 'Este link é válido por %s. Após este período, terá de solicitar um novo link.';