...
$lang['Deletions'] = 'Elementos apagados';
...
$lang['Email admins when a comment requires validation'] = 'Notificar os administradores quando um comentário necessitar uma aprovação';
...
$lang['Link all album photos to a new album'] = 'Vincular (lincar) todos os elementos da categoria a uma nova categoria';
$lang['Link all album photos to some existing albums'] = 'Vincular (lincar) todos os elementos da categoria a alguma(s) categoria existente';
...
$lang['first photo added on %s'] = 'primeiro elemento adicionado em %s';
...
$lang['manage album photos'] = 'gerenciar os elementos da categoria';
...
$lang['display maximum informations (added albums and photos, deleted albums and photos)'] = 'exibir o máximo de informações (categorias e elementos adicionados, categorias e elementos apagados)';
...
$lang['photos updated in the database'] = 'elementos atualizados à base de dados';
...
$lang['User status'] = 'Estatuto de usuário';
...
$lang['Purge history detail'] = 'Limpar o detalhe do histórico';
...
$lang['Main "guest" user status is incorrect'] = 'O Estatuto de usuário do "visitante" principal está incorreto';
...
$lang['Main "webmaster" user status is incorrect'] = 'O estatuto do usuário principal "webmaster" está incorreto';
$lang['User "%s" created with "%s" like password'] = 'O usuário "%s" foi criado com "%s" como palavra-passe';
$lang['Status of user "%s" updated'] = 'Estatuto do usuário "%s" foi atualizado';
...
$lang['Reinitialize check integrity'] = 'Reiniciar verificar integridade';
$lang['Check all'] = 'marcar tudo';
$lang['Uncheck all'] = 'desmarcar tudo';
$lang['Check automatic corrections'] = 'verificar correções automáticas';
...
$lang['Plugin versions can\'t be checked'] = 'As versões de plugin não podem ser verificadas.';
...
$lang['No photo in this album'] = 'Nenhum elemento nesta categoria';
