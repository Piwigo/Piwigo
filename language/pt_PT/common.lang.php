...
$lang['created after %s (%s)'] = 'criada depois de %s (%s)';
$lang['created before %s (%s)'] = 'criada antes de %s (%s)';
...
$lang['day'][6] = 'Sábado';
$lang['Default'] = 'Padrão';
$lang['delete this photo from your favorites'] = 'Remover esta foto dos favoritos';
$lang['Delete'] = 'Apagar';
$lang['descending'] = 'decrescente';
$lang['Download'] = 'Descarregar';
$lang['Download this file'] = 'fazer descarga deste ficheiro';
$lang['edit'] = 'editar';
...
$lang['Maximum photo height'] = 'Altura máxima das fotos';
$lang['Maximum height must be a number superior to 50'] = 'A altura máxima das fotos deve ser um número maior que 50';
$lang['Maximum photo width'] = 'Largura máxima das fotos';
$lang['Maximum width must be a number superior to 50'] = 'A largura máxima das fotos deve ser um número maior que 50';
...
$lang['... or please deactivate this message, I will find my way by myself'] = '... ou, desactive esta mensagem por favor, encontrará o seu caminho por si.';
...
$lang['Someone requested that the password be reset for the following user account:'] = 'Alguém pediu a reinicialização da senha para a conta do utilizador seguinte :';
...
$lang['Successfully registered, you will soon receive an email with your connection settings. Welcome!'] = 'Registrado com sucesso! Você receberá, em breve, um e-mail com suas configurações de entrada. Bem-vindo(a)!';
...
$lang['Date created, new &rarr; old'] = 'Data de criação, recente &rarr; antiga';
