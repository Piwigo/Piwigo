...
$lang['Host'] = 'ホスト';
$lang['User'] = 'ユーザー';
$lang['user login given by your host provider'] = 'あなたのホスティング業者から提供されたデータベースユーザー名です。';
...
$lang['enter a login for webmaster'] = 'ウェブマスターのユーザIDを入力してください。';
$lang['webmaster login can\'t contain characters \' or "'] = 'ウェブマスターのユーザーIDには、「\'」または「"」を含まないでください。';
$lang['please enter your password again'] = 'もう一度あなたのパスワードを入力してください。';
$lang['Keep it confidential, it enables you to access administration panel'] = 'ウェブマスターパスワードは、秘密にしてください。ウェブマスターパスワードを使用して、管理パネルにアクセスできます。';
...
$lang['Note you can change your configuration by yourself and restart Piwigo after that.'] = '注：自分で設定を変更し、その後Piwigoを再起動できます。';
...
$lang['PHP version %s required (you are running on PHP %s)'] = 'PHPのバージョン%sが必要です（現在PHP %sを利用中です）';
