...
$lang['Upgrade from %s to %s'] = 'バージョン %s から %s にアップグレードする';
$lang['Statistics'] = '統計';
$lang['total upgrade time'] = '合計アップグレード時間';
$lang['total SQL time'] = '合計SQL時間';
$lang['SQL queries'] = 'SQLクエリー';
$lang['Upgrade informations'] = '更新情報';
$lang['perform a maintenance check'] = '問題がある場合、[管理 > 特別 > メンテナンス] でメンテナンスチェックを実行してください。';
$lang['deactivated plugins'] = '事前チェックで以下のプラグインが検出されました。再度有効にする前にプラグインのアップグレードを確認してください:';
$lang['upgrade login message'] = '管理者のみアップグレードを実行できます: 以下でログインしてください。';
...
$lang['only thumbnails prefix and webmaster mail saved'] = '以前の設定より、サムネイル接頭辞およびウェブマスターのメールアドレスのみ保存されました。';
