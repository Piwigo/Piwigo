...
$lang['Upgrade from %s to %s'] = 'Aktualizace z verze %s na %s';
...
$lang['perform a maintenance check'] = 'Proveďte kontrolu údržby v [Administrace>Ostatní>Údržba] pokud dojde k problému.';
$lang['deactivated plugins'] = 'Následující doplňky byly deaktivovány v rámci předběžných opatření. Předtím než je znovu aktivujete, zkontrolujte, jestli nebyly aktualizovány:';
$lang['upgrade login message'] = 'Jen administrátor smí spustit aktualizaci: prosím přihlašte se níže.';
...
$lang['only thumbnails prefix and webmaster mail saved'] = 'Z předchozí konfigurace byly zachovány pouze předpony náhledů a email adresa správce.';
