...
$lang['Activate icon "%s"'] = 'Omogoƒçi ikono "%s"';
$lang['Activate Navigation Bar'] = 'Omogoƒçi navigacijsko vrstico';
$lang['Activate Navigation Thumbnails'] = 'Omogoƒçi navigacijo za predoglede';
$lang['Activate'] = 'Omogoƒçi';
$lang['Activate icon "new" next to albums and pictures'] = 'Omogoƒçi ikono "novo" poleg albumov in slik';
$lang['Active Languages'] = 'Omogoƒçeni jeziki';
$lang['Active Plugins'] = 'Omogoƒçeni vtiƒçniki';
$lang['Active Themes'] = 'Omogoƒçene teme';
...
$lang['Complementary mail content'] = 'Komplementarna vsebina poöte';
$lang['Configuration'] = 'Konfiguracija';
$lang['confirm'] = 'potrdi';
$lang['Continue processing treatment'] = 'Nadaljuj z obdelavo';
$lang['Correction applied with error'] = 'Popravek nameöcen z napako';
$lang['Correction applied with success'] = 'Popravek uspeöno nameöcen';
...
$lang['Create a new site : (give its URL to create_listing_file.php)'] = 'Ustvari novo stran : (URL naj kaûe na create_listing_file.php)';
$lang['Create the "%s" directory at the root of your Piwigo installation'] = 'Ustvari imenik "%s" v korenu Piwigo inötalacije.';
...
$lang['Album manual order was saved'] = 'Rocna nastavitev sortiranja albuma, uspeöno shranjena';
$lang['Album name'] = 'Ime albuma';
$lang['Album updated successfully'] = 'Album uspeöno popravljen';
...
$lang['%d waiting for validation'] = '%d ƒçaka preverjanje';
...
$lang['%d member'] = '%d ƒçlan';
$lang['%d members'] = '%d ƒçlanov';
...
$lang['All optimizations have been successfully completed.'] = 'Vsi optimizacijski postopki uspeöno zakljuceni.';
$lang['all'] = 'vsi';
...
$lang['an error happened'] = 'priölo je do napake';
$lang['An error occured during extraction (%s).'] = 'Priölo je do napake med ekstrahiranjem (%s).';
$lang['An information email was sent to group "%s"'] = 'Informativni mail je bil poslan skupini "%s"';
$lang['and'] = 'in';
$lang['Anomaly'] = 'Nepravilnost';
$lang['General statistics'] = 'Sploöna statistika';
...
$lang['guest'] = 'gost';
$lang['Guests'] = 'Gosti';
$lang['height must be a number superior to'] = 'viöina mora biti ötevilka, vecja od ';
...
$lang['Are you sure to install this upgrade? You must verify if this version does not need uninstallation.'] = 'Ali res ûelite namestiti posodobitev ? Potrebno je preveriti, ce nova verzija ne zahteva odstranitev trenutno nameöcene.';
$lang['Are you sure you want to delete this plugin?'] = 'Ali res ûelite odstraniti  vticnik?';
$lang['Are you sure you want to install this plugin?'] = 'Ali res ûelite namestiti  vticnik?';
...
$lang['%s has been successfully updated.'] = '%s je bil uspe≈°no posodobljen.';
...
$lang['All extensions are up to date.'] = 'Vse razöiritve so posodobljene.';
...
$lang['An error has occured during extract. Please check files permissions of your piwigo installation.<br><a href="%s">Click here to show log error</a>.'] = 'Priölo je do napake med ekstrahiranjem. Prosim preverite pravice datotek, vaöe piwigo inötalacije.<br><a href="%s">Za prikaz loga, kliknite tukaj.</a>.';
$lang['An error has occured during upgrade.'] = 'Priölo je do napake med nadgrajevanjem.';
$lang['Approximate maximum resolution: %dM pixels (that\'s %dx%d pixels).'] = 'Pribliûna maksimalna resolucija: %dM pik (to je %dx%d pik).';
$lang['By default, Piwigo will create a new websize from the HD (high definition) version of your photo.'] = ' Privzeto bo Piwigo ustvaril nove web slike  iz HD locljivosti vaöih slik.';


$lang['Can\'t connect to server.'] = 'Ne morem vzpostaviti povezave s stre≈ænikom.';
$lang['Can\'t create temporary file.'] = 'Ne morem ustvariti zaƒçasne datoteke.';
...
$lang['Adobe Photoshop Lightroom is a photography software designed to manage large quantities of digital images and doing post production work.'] = 'Adobe Photoshop Lightroom je fotografski program, ki je namenjen upravljanju velikega ≈°tevila digitalnih fotografij ter za kasnej≈°e urejanje.';
$lang['Aperture is a powerful tool to refine images and manage massive libraries on Mac.'] = 'Aperture je zmogljivo orodje za izbolj≈°avo fotografij in za upravljanje velikih knji≈ænic na Mac sistemih';
...
$lang['Activate comments'] = 'Omogoƒçi komentarje';
$lang['%d week'] = '%d teden';
...
$lang['<em>Piwigo for iOS</em> application empowers you to connect to your Piwigo gallery from your iPhone, iPad or iPod Touch, create some albums and upload several photos at once.'] = '<em>Piwigo za iOS</em> je aplikacija, ki vam omogoƒçi povezavo z va≈°o Piwigo galerijo preko iOS naprave (iPhone, iPad ali iPod Touch) . Ustvarite nove albume in nalo≈æite veƒç fotografij hkrati.';
$lang['<em>Piwigo for Android</em> application empowers you to connect your Android phone or table to your Piwigo gallery, create some albums and upload several photos at once.'] = '<em>Piwigo za Android</em> je aplikacija, ki vam omogoƒçi povezavo z va≈°o Piwigo galerijo preko Andriod naprave. Ustvarite nove albume in nalo≈æite veƒç fotografij hkrati.';
$lang['%d physicals'] = ' %d fiziƒçen';
