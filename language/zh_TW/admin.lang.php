...
$lang['Deletions'] = '刪除';
$lang['Deny selected groups'] = '拒絕所選組';
...
$lang['Save to permalink history'] = '儲存到固定鏈接的歷史記錄中';
...
$lang['The name of a group must not contain " or \' or be empty.'] = '組名不能包含 " 或 \' 並不能為空白。';
...
$lang['Local'] = '本地';
$lang['Remote'] = '遠端';
$lang['update the database from files'] = '根據檔案對數據庫進行更新';
$lang['status'] = '狀態';
$lang['Directory'] = '目錄夾';
$lang['sub-albums'] = '子相冊';
...
$lang['albums added in the database'] = '相冊已增加到數據庫';
...
$lang['Ratio'] = '比例'; 
$lang['Rename'] = '重新命名'; 
$lang['This group will be set to default'] = '該組別將被設定為預設';
$lang['This group will be unset to default'] = '該組別不再被使用為預設';
