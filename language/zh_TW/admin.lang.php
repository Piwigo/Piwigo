...
$lang['An activation link valid for %s was created but could not be sent. You can now copy the link below and send it to the user.'] = '給 %s 的啟用連結已經產生，但無法寄出。您可以複製下面的連結再以其他方式傳送給該使用者。';
$lang['This link is valid for %s. After this time, you will need to request a new link.'] = '此連結的有效期限為 %s。在此之後，您需要要求新的連結。';
