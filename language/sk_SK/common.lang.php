...
$lang['%d comment to validate'] = '%d komentár k validácii';
$lang['%d comments to validate'] = '%d komentárov k validácii';
$lang['%d new comment'] = '%d nový komentár';
$lang['%d new comments'] = '%d nových komentárov';
...
$lang['Contact webmaster'] = 'Kontaktovať administrátora';
...
$lang['Email address is missing. Please specify an email address.'] = 'Chýba e-mailová adresa';
...
$lang['edit'] = 'Editovať';
$lang['wrong date'] = 'Chybné dátum';
$lang['excluded'] = 'Vybrať z výberu';
$lang['My favorites'] = 'Obľúbené';
$lang['display my favorites pictures'] = 'Zobrazí Vaše obľúbené fotografie';
$lang['Favorites'] = 'Obľúbené';
$lang['First'] = 'Prvá';
$lang['The gallery is locked for maintenance. Please, come back later.'] = 'Galéria je uzamknutá z dôvodu administrácie. Skúste to prosím neskôr.';
...
$lang['in %d sub-category'] = 'v %d pod-kategórii';
$lang['in %d sub-categories'] = 'v %d pod-kategóriach';
$lang['included'] = 'vrátane';
$lang['Invalid password!'] = 'Zlé heslo!';
$lang['Language'] = 'Jazyk';
...
$lang['display all elements in all sub-categories'] = 'Zobraziť všetky objekty v pod-kategóriach';
...
$lang['Recent categories'] = 'Nová kategória';
...
$lang['Please, enter a login'] = 'Zadejte prosím prihlasovacie údaje';
...
$lang['return to homepage'] = 'Späť na úvodnú stranu';
...
$lang['set as category representative'] = 'Nastaviť kategóriu ako reprezentatívnu';
...
$lang['Bad status for user "guest", using default status. Please notify the webmaster.'] = 'Zlý stav pre používateľa "hosť", bude použitý východzí stav. Prosím informujte administrátora.';

$lang['Administrator, webmaster and special user cannot use this method'] = 'Administrátor nemôže použiť túto metódu.';
...
$lang['Cookies are blocked or not supported by your browser. You must enable cookies to connect.'] = 'Cookies sú buď blokované, alebo nie sú povolené vo Vašom prehliadači. Musíte povoliť cookies, aby bolo možné se prihlásiť.';
...
$lang['Welcome to your Piwigo photo gallery!'] = 'Vitajte vo Vašej Piwigo foto galérii!';
...
$lang['Hello %s, your Piwigo photo gallery is empty!'] = 'Vitajte %s, Vaša Piwigo foto galéria je prázdna!';
