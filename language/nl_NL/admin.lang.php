...
$lang['No filter on album. Select one or type to search'] = 'Geen filter op album. Selecteer er een of typ er een om te zoeken';
...
$lang['Time has come to update your Piwigo with version %s, go to %s'] = 'De tijd is gekomen om uw Piwigo bij te werken naar versie %s, gaat u naar %s';
