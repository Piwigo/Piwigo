...
$lang['Include history data (Warning: server memory limit may be exceeded)'] = 'Bevat geschiedenis-data (Pas op: de geheugen-limiet van de server kan overschreden worden).';
