...
$lang['Default gallery language'] = 'Standard gallerispråk';
...
$lang['It will be shown to the visitors. It is necessary for website administration'] = 'Det vil vises for besøkende. Det er nødvendig med websider-administrasjon';
$lang['Connection to server succeed, but it was impossible to connect to database'] = 'Tilkobling til server er i orden, men tilkobling til databasen er ikke mulig';
...
$lang['Database table prefix'] = 'Databasetabellers prefix';
$lang['database tables names will be prefixed with it (enables you to manage better your tables)'] = 'databasetabellers navn kommer til å få prefix (gjør deg i bedre stand til å behandle tabellene)';
...
$lang['please enter your password again'] = 'vennligst skriv passord en gang til';
$lang['Keep it confidential, it enables you to access administration panel'] = 'Hold det hemmelig, dette gir deg tilgang til administrasjonspanelet';
...
$lang['Visitors will be able to contact site administrator with this mail'] = 'Besøkende vil kunne bruke denne epostadressen for å kontakte administrator.';
$lang['PHP 5 is required'] = 'PHP 5.2 er nødvendig';
$lang['It appears your webhost is currently running PHP %s.'] = 'Det kan se ut som om din web-tilbyder kjører PHP %s.';
