...
$lang['%d user comment rejected'] = '%d brukerkommentar avvist';
$lang['%d user comments rejected'] = '%d brukerkommentarer avvist';
$lang['%d user comment validated'] = '%d brukerkommentar validert';
...
$lang['Add/delete a permalink'] = 'Legg til/slett en permalenke';
$lang['Add a tag'] = 'Legg til et merke';
$lang['Add a user'] = 'Legg til en bruker';
$lang['Add group'] = 'Legg til gruppe';
$lang['Add'] = 'Legg til';
$lang['Allow user registration'] = 'Godkjenn brukerregistrering';
$lang['Apply to sub-albums'] = 'Legg til i grunn-album';
$lang['Associated'] = 'Sammenlignbar';
$lang['Caddie management'] = 'Behandling av kurven';
$lang['Caddie'] = 'Kurv';
$lang['Albums authorized thanks to group associations'] = 'Album autorisert grunnet gruppetilhørighet';
$lang['Album manual order was saved'] = 'Album manuell sorteringsrekkefølge ble lagret';
...
$lang['Delete selected tags'] = 'Slett valgte merker';
...
$lang['Display options'] = 'Visningsalternativer';
$lang['Dissociated'] = 'Adskilt';
$lang['Does not represent'] = 'Er ikke gjeldende';
$lang['Edit selected tags'] = 'Rediger valgte merker';
$lang['Edit tags'] = 'Rediger merker';
...
$lang['Link all album photos to a new album'] = 'Lenke alle bilder i et album til et nytt album';
$lang['Link all album photos to some existing albums'] = 'Lenke alle bilder i et album til eksisterende album';
$lang['Linked albums'] = 'Lenkede album';
...
$lang['Manage tags'] = 'Håndter merker';
...
$lang['New parent album'] = 'Nytt ovenforliggende album';
$lang['New tag'] = 'Nytt merke';
...
$lang['Parent album'] = 'Ovenforliggende album';
$lang['Path'] = 'Sti';
$lang['Permalink'] = 'Permalenke';
$lang['Permalink %s has been previously used by album %s. Delete from the permalink history first'] = 'Permalenken %s har nylig blitt brukt av albumet %s. Slett dette fra permalenkehistorien først';
$lang['The permalink name must be composed of a-z, A-Z, 0-9, "-", "_" or "/". It must not be numeric or start with number followed by "-"'] = 'Navnet til permalenke må bestå av a-å, A-Å, 0-9, "-", "_" eller "/". Det kan ikke være numerisk eller begynne med et tall etterfulgt av "-"';
$lang['Permalink %s is already used by album %s'] = 'Permalenken %s er allerede i bruk av album %s';
$lang['Permalink history'] = 'Permalenkehistorie';
$lang['Permalinks'] = 'Permalenker';
$lang['Permission denied'] = 'Nektet tillatelse';
...
$lang['Save to permalink history'] = 'Lagre til permalenkehistorie';
...
$lang['Tag "%s" already exists'] = 'Merke "%s" eksisterer allerede';
$lang['Tag "%s" was added'] = 'Merke "%s" har blitt lagt til';
$lang['Tag selection'] = 'Utvalg av merker';
$lang['The %d following tags were deleted'] = 'Følgende %d merker har blitt slettet';
$lang['Unable to check for upgrade.'] = 'Ikke mulig å sjekke for oppdatering.';
$lang['Uninstall'] = 'Avinstaller';
$lang['Use the default photo sort order'] = 'bruk standard bildesortering';
$lang['User comments validation'] = 'Validering av brukerkommentar';
$lang['Users'] = 'Brukere';
...
$lang['You are running on development sources, no check possible.'] = 'Du kjører på utviklingskildekode, kontroll er ikke mulig.';
$lang['You cannot delete your account'] = 'Du kan ikke slette din konto';
$lang['You cannot move an album in its own sub album'] = 'Du kan ikke flytte et album i sitt eget grunnalbum';
$lang['You need to confirm deletion'] = 'Du må bekrefte sletting';
$lang['Add tags'] = 'Legg til merker';
...
$lang['Information data registered in database'] = 'Informasjonsdata registrert i database';
...
$lang['Album updated successfully'] = 'Album oppdatert';
...
$lang['This name is already used by another group.'] = 'Dette navnet er allerede i bruk i en annen gruppe.';
...
$lang['User'] = 'Bruker';
$lang['Complementary mail content'] = 'Kompletterende epost-innhold';
...
$lang['between'] = 'mellom';
$lang['and'] = 'og';
$lang['The webmaster has subscribed you to receiving notifications by mail.'] = 'Webmaster har satt deg opp for beskjeder via epost.';
$lang['You have subscribed to receiving notifications by mail.'] = 'Du har satt deg opp for beskjeder vi epost.';
...
$lang['You have unsubscribed from receiving notifications by mail.'] = 'Du har fjernet deg for beskjeder vi epost.';
$lang[', click on'] = ', klikk på';
$lang['To unsubscribe'] = 'for å fjerne nyhetsbrev';
$lang['With blank value, gallery title will be used'] = 'Om blank verdi, vil galleritittelen bli brukt';
$lang['Notification'] = 'Påminnelser';
$lang['Error when sending email to %s [%s].'] = 'Feil ved sending av epost til %s [%s].';
$lang['Mail sent to %s [%s].'] = 'Epost sendt til %s [%s].';
$lang['%d mail was sent.'] = '%d epost har blitt sendt.';
$lang['%d mails were sent.'] = '%d eposter har blitt sendt.';
$lang['%d mail was not sent.'] = '%d epost har ikke blitt sendt.';
$lang['%d mails were not sent.'] = '%d eposter har ikke blitt sendt.';
$lang['No mail to send.'] = 'Ingen epost å sende.';
$lang['There is no available subscribers to mail.'] = 'Det er ingen abonnenter å varsle via epost.';
...
$lang['No user to send notifications by mail.'] = 'Ingen brukere å medele via epost.';
$lang['New photos added'] = 'Nye bilder er lagt til';
$lang['Subscribe to notification by mail'] = 'Abonner for varsling via epost';
$lang['Unsubscribe from notification by mail'] = 'Fjern abonnent på varsling via epost';
...
$lang['Send mail as'] = 'Send epost som';
$lang['Send mail to users'] = 'Send epost til brukere';
$lang['Send'] = 'Send';
...
$lang['Warning: subscribing or unsubscribing will send mails to users'] = 'Advarsel: Påmelding eller avmelding vil sende epost til brukere';
$lang['Send mail on HTML format'] = 'Send epost i HTML-format';
$lang['Include display of recent photos grouped by dates'] = 'Inkluder visning av siste bilder gruppert etter dato';
...
$lang['Title'] = 'Tittel';
$lang['Album list management'] = 'Behandling av albumliste';
$lang['Piwigo configuration'] = 'Piwigo konfigurasjon';
$lang['Edit album'] = 'Rediger album';
$lang['Group management'] = 'Gruppebehandling';
$lang['User list'] = 'Brukerliste';
$lang['Database synchronization with files'] = 'Database synkronisering med filer';
$lang['all'] = 'alle';
$lang['height must be a number superior to'] = 'høyde må være et tall høyere en';
$lang['width must be a number superior to'] = 'bredde må være et tall høyere en';
...
$lang['average time'] = 'gjennomsnittlig tid';
$lang['total time'] = 'totaltid';
$lang['for this file format'] = 'for dette filformat';
$lang['unit mode'] = 'singel-modus';
$lang['Unlocked'] = 'Opplåst';
$lang['unset'] = 'ubestemt';
$lang['Update albums informations'] = 'Oppdater albuminformasjon';
...
$lang['albums deleted in the database'] = 'album slettet i databasen';
...
$lang['photos informations synchronized with files metadata'] = 'elementer synkronisert med filenes metadata';
...
$lang['added'] = 'lagt til';
$lang['Metadata synchronization results'] = 'Metadatas synkroniseringsresultat';
...
$lang['Toggle \'default group\' property'] = 'Reverser \'standardgruppens\' egenskaper';
...
$lang['An information email was sent to group "%s"'] = 'Informasjons-epost sendt til gruppe "%s"';
$lang['Send an information email to group members'] = 'Send en informasjons-epost til gruppemedlemmer';
$lang['Group'] = 'Gruppe';
$lang['[%s] Visit album %s'] = '[%s] besøk album %s';
$lang['Hello,'] = 'Hallo,';
$lang['See you soon.'] = 'Vi sees senere.';
$lang['Discover album:'] = 'Utforsk album:';
$lang['Mail content'] = 'Innhold av epost';
$lang['none'] = 'ingen';
$lang['high'] = 'høy';
$lang['other'] = 'andre';
...
$lang['Hour'] = 'Time';
$lang['guest'] = 'gjest';
$lang['default values'] = 'standardverdi';
...
$lang['%d anomaly has been detected.'] = '%d unormalitet har blitt oppdaget.';
...
$lang['the wiki'] = 'wiki';
$lang['%s value is not correct file because exif are not supported'] = '%s verdier feil da exif ikke støttes';
...
$lang['Main "guest" user status is incorrect'] = 'Hovedbruker "gjest" brukerstatus er feil';
$lang['Default user does not exist'] = 'Standardbruker finnes ikke';
$lang['Main "webmaster" user does not exist'] = 'Hovedbruker "webmaster" finnes ikke';
$lang['Main "webmaster" user status is incorrect'] = 'Hovedbruker "webmaster" brukerstatus er feil';
$lang['User "%s" created with "%s" like password'] = 'Bruker "%s" laget med "%s" som passord';
$lang['Status of user "%s" updated'] = 'Status for bruker "%s" oppdatert';
...
$lang['Reinitialize check integrity'] = 'Re-initialiser integritets jekk';
...
$lang['Other plugins'] = 'Andre tilgjengelige tilleggsverktøy';
$lang['Last revisions'] = 'Siste revisjoner';
...
$lang['Plugin has been successfully copied'] = 'Tilleggsverktøyet har blitt kopiert';
$lang['Can\'t create temporary file.'] = 'Midlertidig fil kan ikke lages.';
$lang['Can\'t download archive.'] = 'Arkiv kan ikke nedlastes.';
...
$lang['Subscribe %s to Piwigo Announcements Newsletter'] = 'Abonner %s på Piwigo nyhetsbrev';
$lang['Purge search history'] = 'Tøm søkehistorikk';
$lang['Hide'] = 'Gjem';
...
$lang['Cannot delete the old permalink !'] = 'Gammel permalenke kan ikke slettes!';
$lang['Hit'] = 'Treff';
$lang['Tools'] = 'Verktøy';
$lang['Photos'] = 'Foto';
$lang['Themes'] = 'Temaer';
...
$lang['Create the "%s" directory at the root of your Piwigo installation'] = 'Lag mappe "%s" i roten av din Piwigo installasjon';
$lang['Give write access (chmod 777) to "%s" directory at the root of your Piwigo installation'] = 'Gi skrivetilgang (chmod 777) til "%s" mappe i roten av din Piwigo-installasjon';
...
$lang['%d photos uploaded'] = '%d bilder er lastet opp';
...
$lang['Image Quality'] = 'Bildekvalitet';
...
$lang['Add write access to the "%s" directory'] = 'Legg til skrivetilgang på "%s" mappe';
...
$lang['Impossible to delete this theme. Other themes depends on it: %s'] = 'Dette temaet kan ikke slettes, da andre temaer er avhengig av det: %s';
...
$lang['Photo Page'] = 'Bildeside';
$lang['Activate Navigation Bar'] = 'Aktiver navigasjonfelt';
$lang['Activate Navigation Thumbnails'] = 'Aktiver navigasjon miniatyrbilder';
$lang['Activate icon "%s"'] = 'Aktiver ikon "%s"';
$lang['Photo Properties'] = 'Bildeegenskaper';
...
$lang['Select at least one comment'] = 'Velg minst en kommentar';
...
$lang['By %s'] = 'Av %s';
$lang['Visit plugin site'] = 'Besøk tilleggsprogramets side';
...
$lang['Set as default language for unregistered and new users'] = 'Sett som standardspråk for uregistrerte og nye brukerer';
$lang['Add Photos'] = 'Legg til bilder';
$lang['The following tag was deleted'] = 'Følgende merke er slettet';
...
$lang['Order of menubar items has been updated successfully.'] = 'Sorteringen av menyelementer har blitt opppdatert.';
...
$lang['Unknown upload error'] = 'Ukjent opplastingsfeil';
...
$lang['Batch Manager'] = 'Handlinger for bilder i kurven';
...
$lang['Set creation date'] = 'Sett opprettelsesdato';
...
$lang['No photo selected, %d photos in current set'] = 'Ingen bilder valgt, %d bilde i forrige sett';
...
$lang['No photo in the current set.'] = 'Ingen bilder i gjeldende sesjon.';
$lang['No photos selected, no actions possible.'] = 'Ingen bilder valgt, handling umulig.';
$lang['Choose an action'] = 'Velg handling';
$lang['remove author'] = 'fjern forfatter';
$lang['Type here the author name'] = 'Skriv forfatternavn her';
...
$lang['With no tag'] = 'Uten merke';
$lang['Album photos associated to the following albums: %s'] = 'Albumets bilder assosiert til følgende album: %s';
$lang['Delete orphan tags'] = 'Slett foreldreløse merker';
$lang['delete photo'] = 'slett bilde';
$lang['Orphan tags deleted'] = 'Foreldreløse merker slettet';
$lang['Week starts on'] = 'Uke starter på';
$lang['You have %d orphan tags: %s.'] = 'Du har %d foreldreløse merker: %s.';
...
$lang['Visit theme site'] = 'Besøk temaside'; 
$lang['Visit language site'] = 'Besøk språkside'; 
...
$lang['All extensions are up to date.'] = 'Alle tilleggsprogram er oppdatert.';
...
$lang['... or '] = '... eller';
$lang['Allowed file types: %s.'] = 'Tilatte filtyper: %s.';
...
$lang['Approximate maximum resolution: %dM pixels (that\'s %dx%d pixels).'] = 'Ca. max oppløsning: %dM punkter (dvs. %dx%d punkter).';
...
$lang['Merge selected tags'] = 'Flett valgte merker';
$lang['Merge tags'] = 'Flett merker';
$lang['new'] = 'ny';
$lang['No results'] = 'Ingen resultater';
$lang['Photo %s of %s'] = 'Bilde %s av %s';
$lang['Photo name'] = 'Bildenavn';
$lang['Reset ignored updates'] = 'Nullstill ignorerte oppdateringer';
$lang['Restore default configuration. You will lose your plugin settings!'] = 'Gjenopprett standardkonfigurasjon. Du vil miste innstillingene til tilleggene.';
...
$lang['No destination tag selected'] = 'Ingen målmerke valgt';
...
$lang['Select at least two tags for merging'] = 'Velg minst to merker for fletting';
$lang['Select the destination tag'] = 'Velg målmerke';
...
$lang['Tags <em>%s</em> merged into tag <em>%s</em>'] = 'Merkene <em>%s</em> er flettet med merke <em>%s</em>';
...
$lang['Features include gallery browsing, album creation and photo upload.'] = 'Funksjoner inkluderer blaing i gallerier, opprette album og laste opp bilder.';
...
$lang['No order field selected'] = 'Ingen rekkefølge er valgt';
$lang['Duplicate selected tags'] = 'Dupliser valgte merker';
$lang['Name of the duplicate'] = 'Navn på duplikat';
$lang['Source tag'] = 'Kildemerke';
$lang['Tag "%s" is now a duplicate of "%s"'] = 'Merke "%s" er nå en kopi av "%s"';
...
$lang['Type here the name of the new group'] = 'Skriv navnet på den nye gruppen her';
$lang['between %.2f and %.2f'] = 'mellom %.2f og %.2f';
$lang['between %d and %d pixels'] = 'mellom %d og %d punkter';
...
$lang['Select at least one tag'] = 'Velg minst ett merke';
$lang['Basic settings'] = 'Generelle innstillinger';
$lang['General'] = 'Generelt';
$lang['Mail theme'] = 'Epost-tema';
...
$lang['Impossible to deactivate the default theme.'] = 'Umulig å deaktivere standardtema';
$lang['Mail address is mandatory for registration'] = 'Epost-adresse er påkrevd ved registrering';
...
$lang['Each email sent will contain its own automatic authentication key on links, valid for %s.'] = 'Hver epost som sendes vil inneholde sin egen automatiske autentiseringsnøkkel til lenker, gyldig i %s.';
...
$lang['No user is permitted to see this private album'] = 'Ingen brukere har tillatelse til å se denne private album';
$lang['Orphans'] = 'Eierløs';
$lang['Recipients'] = 'Mottakere';
$lang['Y Repeat'] = 'Y Gjenta';
$lang['Display form'] = 'Visningstype';
$lang['No tags selected, no actions possible.'] = 'Ikke noe merke valgt, ingen handling er mulig';
...
$lang['Compute %d missing checksums'] = 'Beregn %d manglende sjekksummer';
...
$lang['Display category date'] = 'Vis kategoridato';
