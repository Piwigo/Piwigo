...
$lang['Use the default photo sort order'] = 'bruk standard bilde sortering';
...
$lang['The settings for the guest are from the %s user'] = 'Innstillinger for gjesten er fra %s bruker';
