...
$lang['Thumbnails'] = '썸네일';
$lang['User "%s" has no email address, password reset is not possible'] = '사용자 "%s"의 이메일 정보가 없어, 비밀번호 초기화가 불가능합니다.';
$lang['User: %s'] = '사용자: %s';
...
$lang['Do you really want to revoke the "%s" API key?'] = '정말 "%s" API 키를 취소하시겠습니까?';
...
$lang['API Key has been successfully revoked.'] = 'API 키가 성공적으로 취소되었습니다.';
$lang['%d visits'] = '%d 회 방문';
...
$lang['Your API key will expire in %d days.'] = 'API 키가 %d 일 후에 만료됩니다.';
...
$lang['If you changed your password because you think it was stolen, we recommend revoking your %d API keys <a href="%s">in your profile</a>.'] = '비밀번호가 도난당했다고 생각되어 변경하신 경우, <a href="%s">프로필에서</a> %d개의 API 키를 취소하시길 권장합니다.';
