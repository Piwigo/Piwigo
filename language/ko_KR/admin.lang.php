...
$lang['Add a filter'] = '필터 조건 추가';
$lang['Add a tag'] = '태그 추가';
$lang['You are running the latest version of Piwigo.'] = '최신 버전의 Piwigo를 사용하고 있습니다.';
...
$lang['Purge search history'] = '검색 기록 삭제';
$lang['Remove from caddie'] = '캐디에서 제거';
$lang['Synchronize metadata'] = '메타데이터 동기화';
$lang['Update albums informations'] = '앨범 정보 업데이트';
$lang['Update photos information'] = '사진 정보 업데이트';
...
$lang['Photos'] = '사진';
$lang['Delete multiple size images'] = '여러 크기 사진 삭제';
$lang['Purge compiled templates'] = '컴파일된 템플릿 삭제';
$lang['Purge history summary'] = '기록 요약 정보 삭제';
$lang['Purge never used notification feeds'] = '사용하지 않은 알림 피드 삭제';
$lang['Purge sessions'] = '세션 삭제';
$lang['Purge user cache'] = '사용자 캐시 삭제';
$lang['Purge history detail'] = '기록 세부 정보 삭제';
...
$lang['Comments for all'] = '모든 사용자에 댓글 허용';
...
$lang['Mail address is mandatory for registration'] = '등록을 위해서는 이메일 주소가 필수입니다';
$lang['Email admins when a new user registers'] = '신규 사용자 등록 시 관리자에게 이메일 발송';
$lang['Rating by guests'] = '게스트에게 평점 허용';
...
$lang['Directory'] = '디렉토리';
$lang['Directory does not exist'] = '디렉토리가 존재하지 않습니다';
$lang['Downloads'] = '다운로드';
...
$lang['Guest cannot be deleted'] = '게스트 계정은 삭제할 수 없음';
$lang['Guests'] = '게스트';
$lang['Rate'] = '등급';
...
$lang['Reinitialize check integrity'] = '무결성 검사 재설정';
$lang['Maintenance'] = '유지보수';
$lang['overrides existing values with empty ones'] = '기존 데이터를 빈 데이터로 덮어쓰기';
...
$lang['%d of %d photos selected'] = '사진 %d장(총 %d장)이 선택되었습니다';
$lang['%d photos'] = '사진 %d장';
...
$lang['Add write access to the "%s" directory'] = '"%s" 디렉토리에 쓰기 권한 추가';
...
$lang['Activate create mode to create and select an album'] = '앨범을 생성하고 선택하기 위해 만들기 모드를 활성화합니다';
...
$lang['Create the "%s" directory at the root of your Piwigo installation'] = 'Piwigo 설치 루트 디렉토리에 "%s" 디렉토리를 생성하세요.';
...
$lang['Description'] = '설명';
$lang['Details'] = '상세';
$lang['Detect and avoid duplicates during upload'] = '업로드 과정에서 중복을 감지하고 방지합니다';
...
$lang['For photo sizes with crop, such as "Square", Piwigo will do its best to include the center of interest.'] = '"정사각형"과 같이 자르기가 적용된 사진 크기의 경우, Piwigo는 관심 영역의 중심을 포함하도록 최선을 다합니다.';
...
$lang['Search for new images in the directories'] = '디렉토리에서 새 이미지 검색';
...
$lang['Name of the duplicate'] = '복제본 이름';
...
$lang['Global Gallery Actions'] = '갤러리 작업';
$lang['Go to'] = '이동';
...
$lang['Has access to all administration functionnalities. Can manage both configuration and content.'] = '모든 관리 기능 접근 권한 있음. 설정 및 콘텐츠 전체 관리 가능.';
$lang['Hello'] = '안녕하세요';
$lang['Hello,'] = '안녕하세요,';
$lang['Help Me'] = '도움말';
...
$lang['test'] = '테스트';
$lang['synchronize files metadata with database photos informations'] = '데이터베이스의 사진 정보와 파일 메타데이터를 동기화';
...
$lang['User "%s" dissociated from this group'] = '"%s" 사용자가 그룹에서 분리됨';
$lang['User'] = '사용자';
...
$lang['There is multiple image in the database with the following names : %s.'] = '%s라는 이름으로 검색된 여러 개의 이미지가 있습니다.';
...
$lang['The name of directories and files must be composed of letters, numbers, "-", "_" or "."'] = '디렉토리 및 파일 이름은 문자, 숫자, "-", "_" 또는 "."만 사용 가능합니다.';
...
$lang['The file or directory cannot be accessed (either it does not exist or the access is denied)'] = '파일 또는 디렉토리에 접근할 수 없습니다(존재하지 않거나 접근이 거부됨)';
...
$lang['We have found %d duplicate paths. Details provided by plugin Check Uploads'] = '%d개의 경로가 비정상적으로 중복되어 있는 것으로 확인되었습니다. Check Uploads 플러그인을 사용하여 확인해 주세요.';
...
$lang['include photos with lower privacy level'] = '개인정보 수준이 더 낮은 사진 포함';
...
$lang['image(s) contains unsaved changes'] = '개 이미지에 저장되지 않은 변경 사항이 있습니다';
...
$lang['Tag "%s" is now a duplicate of "%s"'] = '"%s1" 태그는 이제 "%s"의 복사본입니다.';
$lang['Subscribe'] = '구독';
...
$lang['Purge Actions'] = '삭제 작업';
$lang['Purge Cache'] = '캐시 삭제';
$lang['Piwigo core'] = 'Piwigo 코어';
