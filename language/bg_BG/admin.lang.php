...
$lang['All plugins are up to date.'] = 'Всички разширения са актуализирани.';
...
$lang['Plugins which need upgrade'] = 'Разширения налични за обновяване';
...
$lang['Following plugins may not be compatible with the new version of Piwigo:'] = 'Тези разширения може да не са съвместими с новата версия на Piwigo:';
...
$lang['Prepared time for list of users to send mail is limited. Others users are not listed.'] = 'Времето,за подготвка на списъка с потребителите, на които ще бъде изпратена поща е ограничен. Други потребители не са изброени.';
...
$lang['Purge compiled templates'] = 'Почестване на съставните шаблони';
...
$lang['digiKam is an advanced digital photo management free software for Linux, Windows, and MacOSX.'] = 'digiKam e разширен фото менаджер и безплатен софтуер за Linux, Windows и MacOSX.';
...
$lang['Refresh photo set'] = 'Обнови зададената снимка';
$lang['Start pLoader and add your photos.'] = 'Стартиране pLoader и добавяне на снимките Ви.';
$lang['Repair and optimize database'] = 'Възстановяване и оптимизация на базата';
$lang['Reinitialize check integrity'] = 'Повторна проверка на цялостта';
$lang['Photo unreachable or no support'] = 'Снимката недостъпна или неподържан формат';
$lang['Permission granted thanks to a group'] = 'Достъп гарантиран благодарине на група';
...
$lang['Order of menubar items has been updated successfully.'] = 'Заявката с елементи в менюбар-а е актуализирана успешно';
$lang['Optional URL keyword'] = 'Незадължителна URL ключова дума';
$lang['On your Linux, simply install Shotwell with your package manager and the activate Piwigo publishing option.'] = 'Във Linux, просто инсталирайте Shotwell с вашият мениджър за управление на пакетите и след това активирайте Piwigo опция за публикуване.';
...
$lang['Select the destination tag'] = 'Изберете носочващия таг';
...
$lang['Select at least two tags for merging'] = 'Изберете поне два тага за обединяване';
...
$lang['Save to permalink history'] = 'Запази история на пармалинковете';
$lang['Reset ignored updates'] = 'Нулиране игнорираните ъпдейти';
$lang['Represents'] = 'Е миниатюра за';
$lang['The %d following tags were deleted'] = 'Следните %d тагове бяха изтрити';
$lang['Templates configuration has been recorded.'] = 'Конфигурацията на темата беше записана.';
$lang['Tags <em>%s</em> merged into tag <em>%s</em>'] = 'Тагове <em>%s</em> обединени в тагове <em>%s</em>';
$lang['Tag "%s" is now a duplicate of "%s"'] = 'Таг "%s" сега се дублира с "%s"';
$lang['Tag "%s" was added'] = 'Таг "%s" беше добавен';
$lang['Remove from caddie'] = 'Премахни от caddie';
$lang['Remote'] = 'Дистанционно';
$lang['Released on'] = 'Издадено от';
$lang['Rating by guests'] = 'Рейтинг от гост';
...
$lang['The following tag was deleted'] = 'Избраният таг е изтрит';
$lang['Orphan tags deleted'] = 'Необвързаните тагове изтрити';
$lang['Obsolete Plugins'] = 'Остаряли разширения';
$lang['Rate date'] = 'Дата на оценяване';
$lang['Purge sessions'] = 'Почистване на сесиите';
$lang['Purge search history'] = 'Почистване на историята на търсене';
$lang['Purge never used notification feeds'] = 'Почистване на никога нейзползвани полета';
$lang['Purge history summary'] = 'Почистване на историята общо';
$lang['Purge history detail'] = 'Почистване на историята детайли';
...
$lang['Virtual albums to move'] = 'Виртуалнни албуми за местене';
...
$lang['photos candidates for metadata synchronization'] = 'снимки кандидати за синхронизация на метатаговете';
...
$lang['Privacy level set to "%s"'] = 'Зададено ниво на достър "%s"';
$lang['Piwigo export plugin for Aperture'] = 'Piwigo публикува плъгин за Aperture';
