...
$lang['%d users deleted'] = '%d کاربر حذف شدند';
$lang['%d user'] = "%d کاربر";
$lang['%d users'] = "%d کاربر";
$lang['%d waiting for validation'] = '%d در انتظار پذیرش';
$lang['Actions'] = 'کارها';
$lang['Activate'] = 'فعال کردن';
$lang['Add/delete a permalink'] = 'افزودن/حذف لینک ثابت';
...
$lang['Delete Representant'] = 'حذف عکس ریزه‌ی آلبوم';
$lang['Delete selected tags'] = 'حذف برچسب‌های انتخاب شده';
$lang['Delete selected users'] = 'حذف کاربران انتخاب شده';
...
$lang['Permalink %s has been previously used by album %s. Delete from the permalink history first'] = 'لینک ثابت %s پیش از این در آلبوم %s استفاده شده بود. نخست آن را از تاریخچه‌ی لینک‌های ثابت حذف کنید';
...
$lang['Users'] = "کاربران";
$lang['Validate'] = 'پذیرش';
$lang['Validation'] = 'پذیرش';
$lang['Version'] = 'نگارش';
$lang['Virtual albums to move'] = 'آلبوم‌های مجازی در حال جابجایی';
$lang['Virtual album name'] = 'نام آلبوم مجازی';
$lang['Webmaster cannot be deleted'] = 'مدیرکل قابل حذف نیست';
...
$lang['You cannot delete your account'] = 'نمی‌توانید حساب خود را حذف کنید';
...
$lang['Virtual album deleted'] = 'آلبوم مجازی حذف شد';
...
$lang['group "%s" updated'] = 'گروه «%s» به‌روز شد';
...
$lang['%d parameters were updated.'] = '%d پارامتر به‌روز شدند.';
$lang['%d user was not updated.'] = '%d کاربر به‌روز نشد.';
$lang['%d users were not updated.'] = '%d کاربر به‌روز نشدند.';
...
$lang['%d user was updated.'] = '%d کاربر به روز شد.';
$lang['%d users were updated.'] = '%d کاربر به‌روز شدند.';
...
$lang['delete'] = 'حذف';
$lang['delete this site and all its attached elements'] = 'حذف این سایت با تمام اطلاعات مربوط به آن';
...
$lang['display maximum informations (added albums and photos, deleted albums and photos)'] = 'نمایش حداکثر اطلاعات (آلبوم‌ها و عکس‌های افزوده شده، آلبوم‌ها و عکس‌های حذف شده)';
...
$lang['albums deleted in the database'] = 'آلبوم از پایگاه داده حذف شدند';
$lang['photos deleted from the database'] = 'عکس از پایگاه داده حذف شدند';
...
$lang['%d lines filtered'] = '%d خط فیلتر شدند';
$lang['%d guest'] = '%d مهمان';
$lang['%d guests'] = '%d مهمان';
$lang['Hour'] = "ساعت";
$lang['guest'] = 'مهمان';
$lang['default values'] = 'مقدار های پیشفرض';
$lang['Guest cannot be deleted'] = 'مهمان قابل حذف نیست';
$lang['Default user cannot be deleted'] = 'کاربر پیشفرض قابل حذف نیست';
...
$lang['%d anomaly has been corrected.'] = '%d ناهنجاری برطرف شد.';
$lang['%d anomalies have been detected corrected.'] = '%d ناهنجاری شناسایی و برطرف شدند.';
$lang['%d anomaly has not been corrected.'] = '%d ناهنجاری برطرف نشد.';
$lang['%d anomalies have not been corrected.'] = '%d ناهنجاری برطرف نشدند.';
...
$lang['Ignore selected anomalies'] = 'نادیده گرفتن ناهنجاری‌های انتخاب شده';
$lang['Refresh'] = 'تازه کردن (Refresh)';
$lang['The anomaly will be ignored until next application version'] = 'ناهنجاری تا نگارش بعدی نادیده گرفته خواهد شد';
$lang['Correction the anomaly will cancel the fact that it\'s ignored'] = 'ناهنجاری برطرف شده دیگر نادیده گرفته نمی‌شود';
$lang['%d anomaly has been ignored.'] = '%d ناهنجاری نادیده گرفته شد.';
$lang['%d anomalies have been ignored.'] = '%d ناهنجاری نادیده گرفته شدند.';
...
$lang['Are you sure you want to delete this plugin?'] = 'آیا می‌خواهید این افزونه را حذف کنید؟';
...
$lang['No photo can be deleted'] = 'هیچ عکسی قابل حذف نیست';
$lang['Delete selected photos'] = 'حذف عکس‌های انتخاب شده';
$lang['%d photo was deleted'] = '%d عکس حذف شد';
$lang['%d photos were deleted'] = '%d عکس حذف شدند';
...
$lang['Allow users to delete their own comments'] = 'کاربران بتوانند دیدگاه‌های خود را حذف کنند';
$lang['Email administrators when a comment is modified'] = 'فرستادن ایمیل به مدیران هنگامی که دیدگاهی ویرایش می‌شود';
$lang['Email administrators when a comment is deleted'] = 'فرستادن ایمیل به مدیران هنگامی که دیدگاهی حذف می‌شود';
$lang['Cannot delete the old permalink !'] = 'لینک ثابت قدیمی نمی‌تواند حذف شود.';
$lang['Hit'] = "نمایش";
$lang['Tools'] = 'ابزار ها';
$lang['Photos'] = 'عکس ها';
$lang['Themes'] = 'قالب ها';
...
$lang['Delete this theme'] = 'حذف این زمینه';
...
$lang['Impossible to delete this theme. Other themes depends on it: %s'] = 'امکان حذف این زمینه وجود ندارد، زیرا زمینه‌های دیگری به آن نیاز دارند: %s';
...
$lang['%d of %d photos selected'] = '%d از %d عکس انتخاب شد';
...
$lang['Orphan tags deleted'] = 'برچسب‌های بی‌ریشه حذف شدند';
...
$lang['Height'] = 'طول';
$lang['Ignore All'] = 'نادیده گرفتن همه';
$lang['Ignore this update'] = 'نادیده گرفتن این به‌روزرسانی';
...
$lang['(this tag will be deleted)'] = '(این برچسب حذف خواهد شد)';
...
$lang['Reset ignored updates'] = 'بازنشانی به‌روزرسانی‌های نادیده گرفته شده';
...
$lang['This is a minor update, with only bug corrections.'] = 'این یک به‌روزرسانی کوچک است که در آن چند مشکل برطرف شده‌اند.';
...
$lang['Delete multiple size images'] = 'حذف عکس‌های چند سایزه';
...
$lang['%d of %d users selected'] = '%d از %d كاربر انتخاب شد';
...
$lang['Delete %d orphan photos'] = 'حذف %d عکس بی‌ریشه';
$lang['Orphans'] = 'بی‌ریشه‌ها';
$lang['Delete album "%s".'] = 'حذف آلبوم «%s».';
...
$lang['delete only album, not photos'] = 'فقط آلبوم بدون عکس حذف شود ';
...
$lang['delete album and the %d orphan photos'] = 'آلبوم و %d عکس بی‌ریشه حذف شوند';
$lang['orphans to delete'] = 'عکس‌های بی‌ریشه آماده‌ی حذف';
$lang['delete album and all %d photos, even the %d associated to other albums'] = 'آلبوم و تمامی %d عکس آن حذف شوند، حتی %d عکسی که مربوط به آلبوم‌های دیگر هستند';
$lang['(determined from photos)'] = '(تعیین شده از روی عکس‌ها)';
$lang['Confirm deletion'] = 'تایید پاک کردن';
$lang['Delete album "%s" and its %d sub-albums.'] = 'آلبوم «%s» و %d زیرآلبوم آن حذف شوند.';
...
$lang['%d pictures in sub-albums'] = '%d عکس در زیرآلبوم‌ها';
...
$lang['Nov'] = 'نوامبر';
$lang['Oct'] = 'اکتبر';
$lang['Tag name'] = 'نام برچسب';
$lang['Save'] = 'ذخیره';
$lang['Portraits'] = 'پرتره‌ها';
$lang['Piwigo core'] = 'هسته‌ی Piwigo';
$lang['Ok, got it!'] = 'اوکی، متوجه شدم!';
$lang['Manage users'] = 'مدیریت کاربران';
$lang['Formats'] = 'فرمت‌ها';
$lang['Downloaded'] = 'دانلود شده';
$lang['Core'] = 'هسته';
$lang['Changes saved'] = 'تغییرات ذخیره شدند';
$lang['Change logo'] = 'تغییر لوگو';
$lang['An error has occured'] = 'خطایی رخ داد';
$lang['Album search tool'] = 'ابزار جستجوی آلبوم';
$lang['Added on %s'] = 'اضافه شده در %s';
$lang['Tag "%s" created'] = 'برچسب «%s» ساخته شد';
$lang['Sep'] = 'سپتامبر';
$lang['Select'] = 'انتخاب';
$lang['Password copied'] = 'گذرواژه کپی شد';
$lang['Other'] = 'دیگر';
$lang['Merge'] = 'ترکیب';
$lang['Main user'] = 'کاربر اصلی';
$lang['Language'] = 'زبان';
$lang['Image'] = 'تصویر';
$lang['Edit photo #%s'] = 'ویرایش عکس #%s';
$lang['Delete them'] = 'حذف شوند';
$lang['Delete tags \{%s\}?'] = 'برچسب‌های \{%s\} حذف شوند؟';
$lang['Delete tag "%s"?'] = 'برچسب «%s» حذف شود؟';
$lang['Delete album'] = 'حذف آلبوم';
$lang['Copy password'] = 'کپی کردن گذرواژه';
$lang['Copied link'] = 'لینک کپی شده';
$lang['Modified'] = 'ویرایش شده';
$lang['More information'] = 'اطلاعات بیشتر';
$lang['Selected user'] = 'کاربر انتخاب شده';
$lang['Selection mode'] = 'حالت انتخاب';
$lang['Update'] = 'به‌روزرسانی';
$lang['Use Piwigo logo'] = 'استفاده از لوگوی Piwigo';
$lang['Videos'] = 'ویدیوها';
$lang['Welcome!'] = 'خوش آمدید!';
$lang['no photo'] = 'بدون عکس';
$lang['Activated plugin list'] = 'فهرست افزونه‌های فعال';
$lang['Admins only'] = 'فقط مدیران';
$lang['Auto-update'] = 'به‌روزرسانی خودکار';
$lang['Change Password'] = 'تغییر گذرواژه';
$lang['Copy the password link'] = 'کپی کردن لینک گذرواژه';
$lang['Create and select'] = 'ایجاد و انتخاب';
$lang['Dark mode'] = 'حالت تیره';
$lang['Dec'] = 'دسامبر';
$lang['Discover'] = 'کشف';
$lang['Edited on %s'] = 'ویرایش شده در %s';
$lang['Email Adress'] = 'آدرس ایمیل';
$lang['Expand'] = 'گسترش';
$lang['Group added'] = 'گروه اضافه شد';
$lang['Group renamed'] = 'نام گروه تغییر کرد';
$lang['Light mode'] = 'حالت روشن';
$lang['New user added'] = 'کاربر جدید اضافه شد';
$lang['Open in gallery'] = 'باز کردن در گالری';
$lang['Purge Cache'] = 'خالی کردن حافظه‌ی پنهان';
$lang['Show'] = 'نمایش';
$lang['System Activities'] = 'فعالیت‌های سیستم';
$lang['Version %s'] = 'نگارش %s';
$lang['%d including sub-albums'] = '%d همراه با زیرآلبوم‌ها';