...
$lang['Number of rates'] = 'تعداد امتياز ها';
$lang['Number of thumbnails to create'] = 'تعداد عکس ريزه برای ايجاد کردن';
...
$lang['Permalink %s has been previously used by album %s. Delete from the permalink history first'] = 'لینک ثابت %s پیش از این برای آلبوم %s تعیین شده بود. ابتدا اين لينک ثابت را از تاريخچه پاک کنید';
...
$lang['Last revisions'] = 'آخرین بازبينى';
...
$lang['manual order'] = 'مرتب کردن دستی';
$lang['Albums automatically sorted'] = 'آلبوم ها به صورت خودکار مرتب شد';
...
$lang['The whole set'] = 'تمامی عکس ها';
...
$lang['THIS PLUGIN IS NOW PART OF PIWIGO CORE! DELETE IT NOW.'] = '<b>این پلاگین در حال حاضر بخشی از هسته ی PIWIGO میباشد! هرچه سریع تر آن را پاک کنید!<b/>';
