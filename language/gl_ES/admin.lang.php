...
$lang['Use the default photo sort order (defined in the configuration file)'] = 'Usar a orde de selección das fotos predeterminada (definida no ficheiro de configuración)';
