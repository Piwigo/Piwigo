...
$lang['Permalinks'] = 'Fasthlekkir';
$lang['Permalink history'] = 'Saga fasthlekkja';
$lang['Permalink %s is already used by album %s'] = 'Fasthlekkur %s er nú þegar notaður af albúmi %s';
$lang['Permalink %s has been previously used by album %s. Delete from the permalink history first'] = 'Fasthlekkur %s hefur áður verið notaður af albúmi %s. Eyddu því fyrst úr fasthlekk sögunni';
$lang['Permalink'] = 'Fasthlekkur';
...
$lang['The permalink name must be composed of a-z, A-Z, 0-9, "-", "_" or "/". It must not be numeric or start with number followed by "-"'] = 'Heiti fasthlekkjar verður að vera samsett úr a-ö, A-Ö, 0-9, "-", "_" eða "/". Það má ekki vera tölulegt eða byrja á tölu og þar á eftir "-"';
...
$lang['Save to permalink history'] = 'Vista í fasthlekkjasögu';
...
$lang['Privacy level set to "%s"'] = 'Persónuverndarstig stillt á "%s"';
$lang['Privacy level'] = 'Persónuverndarstig';
...
$lang['include photos with lower privacy level'] = 'innihalda myndir með lægra persónuverndarstigi';
