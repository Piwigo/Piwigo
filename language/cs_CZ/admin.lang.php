...
$lang['Caddie'] = 'Košík';
$lang['Albums authorized thanks to group associations'] = 'Kategorie schváleny díky skupinovým spojením';
...
$lang['Only private albums are listed'] = 'Jsou zobrazeny pouze soukromé kategorie';
$lang['Operating system'] = 'Operační systém';
$lang['Options'] = 'Nastavení';
$lang['Other private albums'] = 'Další soukromé kategorie';
$lang['Page banner'] = 'Banner stránky';
$lang['Parent album'] = 'Rodičovská kategorie';
$lang['Path'] = 'Cesta';
$lang['Permalink'] = 'Pernamentní spojení';
$lang['Permalink %s has been previously used by album %s. Delete from the permalink history first'] = 'Pernamentní spojení %s bylo předtím použito kategorií %s. Nejprve smažte z historie spojení.';
...
$lang['Permalink %s is already used by album %s'] = 'Pernamentní spojení je již využíváno kategorií %s';
...
$lang['Representation of albums'] = 'Reprezentantativní fotografie pro kategorii';
...
$lang['You cannot move an album in its own sub album'] = 'Nelze přesunout kategorii do její vlastní podkategorie';
...
$lang['Authorize users to add comments on selected albums'] = 'Povolit uživatelům komentovat vybrané kategorie';
...
$lang['Manage authorizations for selected albums'] = 'Nastavit oprávnění pro vybrané kategorie';
$lang['Select uploadable albums'] = 'Zvolit kategorie s možností nahrávání obsahu';
...
$lang['reduce to single existing albums'] = 'Převést do jediné existující kategorie';
$lang['Choose an option'] = 'Zvolit nastavení';
$lang['display maximum informations (added albums and elements, deleted albums and elements)'] = 'Zobrazit veškeré informace informací (přidané a odstraněné kategorie a položky)';
...
$lang['albums added in the database'] = 'kategorií přidáno do databáze';
...
$lang['Files with same name in more than one physical album'] = 'Soubory se stejným názvem ve více než jedné fyzické kategorii';
...
$lang['edit album'] = 'upravit informace o kategorii';
...
$lang['Drop into album'] = 'Zpět do kategorie';
...
$lang['existing album'] = 'stávající kategorie';
$lang['create a new album'] = 'Založit novou Kategorii';
