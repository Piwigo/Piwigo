...
$lang['The RSS notification feed provides notification on news from this website : new photos, updated albums, new comments. Use a RSS feed reader.'] = 'Die RSS Mittteilung beinhaltet Neuigkeiten von dieser Website: neue Fotos, aktualisierte Alben, neue Kommentare. Benutze einen RSS feed reader.';
...
$lang['in %d sub-albums'] = 'in %d Sub-Alben';
...
$lang['Maximum width must be a number superior to 50'] = 'Die Breite der Bilder muss größer als 50 sein';
$lang['display a calendar by creation date'] = 'zeige einen Kalender nach Erstellungsdatum';
$lang['display all photos in all sub-albums'] = 'zeige alle Fotos in allen Sub-Alben';
...
$lang['Photos posted within the last %d day.'] = 'Fotos eingestellt im letzen %d Tag.';
$lang['Photos posted within the last %d days.'] = 'Fotos eingestellt in den letzen %d Tagen.';
...
$lang['Show file metadata'] = 'Zeige die Meta-Daten in der Datei';
...
$lang['mail address must be like xxx@yyy.eee (example : jack@altern.org)'] = 'E-Mail-Adresse muss in der Form xxx@yyy.eee (Beispiel: jack@altern.org) sein';
...
$lang['representative'] = 'repräsentativ';
...
$lang['set as album representative'] = 'als Vorschaubild des Albums setzen';
...
$lang['%d photo is also linked to current tags'] = '%d Foto ist auch mit diesen Stichworten verbunden';
$lang['%d photos are also linked to current tags'] = '%d Fotos sind auch mit diesen Stichworten verbunden';
...
$lang['Here are your connection settings'] = 'Das sind deine Verbindungseinstellungen';
$lang['If you think you\'ve received this email in error, please contact us at %s'] = 'Solltest du die E-Mail unerwünscht erhalten haben, kontaktiere uns unter %s';
$lang['large'] = 'groß';
$lang['medium'] = 'mittel';
...
$lang['Successfully registered, you will soon receive an email with your connection settings. Welcome!'] = 'Erfolgreich registriert, du wirst in Kürze eine E-Mail mit deinen Zugangdaten erhalten. Herzlich Willkommen!';
$lang['Thank you for registering at %s!'] = 'Danke für Deine Registrierung bei %s';
$lang['thumb'] = 'miniatur';
