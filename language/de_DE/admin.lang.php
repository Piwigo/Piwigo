...
$lang['The original image quality must be a number between %d and %d'] = 'Die original Bildqualität muss eine Zahl zwischen %d und %d sein';
$lang['The original maximum height must be a number between %d and %d'] = 'Die original Maximalhöhe muss eine Zahl zwischen %d und %d sein';
$lang['The original maximum width must be a number between %d and %d'] = 'Die original Maximalbreite muss eine Zahl zwischen %d und %d sein';
