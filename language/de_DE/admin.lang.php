...
$lang['%d tag'] = '%d Suchbegriff';
$lang['%d tags'] = '%d Suchbegriffe';
...
$lang['Add a tag'] = 'Suchbegriff hinzufügen';
...
$lang['Edit selected tags'] = 'Markierte Suchbegriffe bearbeiten';
$lang['Edit tags'] = 'Suchbegriffe bearbeiten';
...
$lang['Manage tags'] = 'Suchbegriffe verwalten';
...
$lang['New tag'] = 'Neuer Suchbegriff';
...
$lang['Permalink %s is already used by album %s'] = 'Permalink %s wird schon vom Album %s verwendet';
$lang['Permalink history'] = 'Permalink-Verlauf';
...
$lang['Save to permalink history'] = 'Speichere im Permalink-Verlauf';
...
$lang['Tag "%s" already exists'] = 'Suchbegriff »%s« existiert bereits';
$lang['Tag "%s" was added'] = 'Suchbegriff »%s« wurde hinzugefügt';
$lang['Tag selection'] = 'Suchbegriffsauswahl';
$lang['The %d following tags were deleted'] = 'Die %d folgenden Suchbegriffe wurden gelöscht';
...
$lang['remove tags'] = 'Suchbegriffe entfernen';
...
$lang['Purge history detail'] = 'Verlaufsinträge löschen';
$lang['Purge history summary'] = 'Verlaufszusammenfassung löschen';
...
$lang['The anomaly will be ignored until next application version'] = 'Der Fehler wird ignoriert bis zur nächsten Version der Anwendung';
...
$lang['Purge search history'] = 'Suchverlauf löschen';
...
$lang['Delete this theme'] = 'Diese Vorlage löschen';
...
$lang['Help Me'] = 'Hilfe';
$lang['Impossible to activate this theme, the parent theme is missing: %s'] = 'Es ist nicht möglich, diese Vorlage zu aktivieren, da die übergeordnete Vorlage %s fehlt';
$lang['Impossible to delete this theme. Other themes depends on it: %s'] = 'Es ist nicht möglich, diese Vorlage zu löschen; andere Vorlagen basieren darauf: %s';
$lang['Inactive Themes'] = 'Inaktive Vorlagen';
$lang['Install on your computer,'] = 'Auf Ihrem Computer installieren,';
$lang['Make this theme available to users'] = 'Diese Vorlage den Benutzern zur Verfügung stellen';
...
$lang['Theme has been successfully installed'] = 'Vorlage wurde erfolgreich installiert';
...
$lang['Language has been successfully installed'] = 'Sprachdatei wurde erfolgreich installiert';
$lang['Select:'] = 'Auswahl:';
$lang['None'] = 'Nichts';
$lang['Invert'] = 'Invertieren';
$lang['Impossible to deactivate this theme, you need at least one theme.'] = 'Es ist nicht möglich, diese Vorlage zu deaktivieren, mindestens eine Vorlage wird benötigt.';
...
$lang['Bound Theme'] = 'Verbundene Vorlage';
...
$lang['The following tag was deleted'] = 'Folgender Suchbegriff wurde gelöscht';
...
$lang['This theme was not designed to be directly activated'] = 'Diese Vorlage kann nicht direkt aktiviert werden';
...
$lang['Delete orphan tags'] = 'Nicht benutzte Suchbegriffe entfernen';
$lang['delete photo'] = 'Foto entfernen';
$lang['Orphan tags deleted'] = 'Nicht benutzte Suchbegriffe wurden gelöscht';
$lang['Week starts on'] = 'Die Woche beginnt mit';
$lang['You have %d orphan tags: %s.'] = 'Sie haben %d nicht benutzte Suchbegriffe: %s.';
$lang['Remove from caddie'] = 'Aus Sammelkorb entfernen';
$lang['Themes which need upgrade'] = 'Vorlagen welche aktualisiert werden sollten';
$lang['Languages which need upgrade'] = 'Sprachen welche aktualisiert werden sollten';
$lang['All themes are up to date.'] = 'Alle Vorlagen sind auf dem neuesten Stand.';
...
$lang['Visit theme site'] = 'Vorlagenseite anzeigen';
...
$lang['Following themes may not be compatible with the new version of Piwigo:'] = 'Folgende Vorlagen sind möglicherweise nicht mit der neuen Piwigo-Version kompatibel:';
...
$lang['Some themes and plugins may be not available yet.'] = 'Einige Vorlagen und Erweiterungen sind nun leider nicht mehr verfügbar.';
...
$lang['Zoom'] = 'Zoom';
$lang['(this tag will be deleted)'] = '(dieser Suchbegriff wird gelöscht)';
$lang['... or '] = '... oder&nbsp;';
$lang['Allowed file types: %s.'] = 'Erlaubte Dateitypen: %s.';
$lang['By default, Piwigo will create a new websize from the HD (high definition) version of your photo.'] = 'Standardmäßig erstellt Piwigo eine für das Web optimierte Ansicht der HD-Version (hochauflösende Version) Ihres Fotos.';
...
$lang['Merge selected tags'] = 'Markierte Suchbegriffe zusammenführen';
$lang['Merge tags'] = 'Suchbegriffe zusammenführen';
$lang['No destination tag selected'] = 'Kein Zielsuchbegriff gewählt';
$lang['Photo %s of %s'] = 'Bild %s of %s';
$lang['Select an album'] = 'Ein Album auswählen';
$lang['Select at least two tags for merging'] = 'Zum Zusammenführen mindestens zwei Suchbegriffe auswählen';
$lang['Select the destination tag'] = 'Zielsuchbegriff auswählen';
$lang['show details'] = 'Details zeigen';
$lang['Start Upload'] = 'Upload starten';
$lang['Tags <em>%s</em> merged into tag <em>%s</em>'] = 'Suchbegriffe <em>%s</em> mit <em>%s</em> zusammengeführt';
...
$lang['With no tag'] = 'Ohne Suchbegriff';
...
$lang['Source tag'] = 'Suchbegriff Quelle';
$lang['Tag "%s" is now a duplicate of "%s"'] = 'Der Suchbegriff »%s« ist jetzt ein Duplikat von »%s«';
$lang['Landscape'] = 'Querformat';
$lang['Minimum height'] = 'Mindesthöhe';
$lang['Minimum width'] = 'Mindestbreite';
$lang['Panorama'] = 'Panorama';
$lang['Portrait'] = 'Hochkant';
$lang['Manage photos'] = 'Fotos verwalten';
$lang['View in gallery'] = 'Galerieansicht';
...
$lang['No groups selected, no actions possible.'] = 'Keine Gruppen ausgewählt, Aktion kann nicht durchgeführt werden';
...
$lang['Select at least one tag'] = 'Mindestens einen Suchbegriff auswählen';
...
$lang['The settings for the guest are from the %s user'] = 'Die Einstellungen für den Gast stammen vo Benutzer "%s"';
...
$lang['No tags selected, no actions possible.'] = 'Kein Suchbegriff ausgewählt, keine Aktion möglich.';
...
$lang['Select tags'] = 'Suchbegriffe auswählen';
...
$lang['delete album and all %d photos, even the %d associated to other albums'] = 'Album löschen und alle %d Fotos, auch die %d welche mit anderen Alben verbunden sind';
...
$lang['Display album date period'] = 'Zeitspanne welche mit dem Album verknüpft ist anzeigen, z.B. << vom 12. bis 15. Juli 2018 ';
...
$lang['or'] = 'oder';
$lang['Display category date'] = 'Kategoriedatum anzeigen';
...
$lang['You have %d orphan tags %s'] = 'Sie haben %d nicht benutzte Suchbegriffe: %s';
$lang['%s other tags available..'] = '%s weitere Suchbegriffe vorhanden...';
$lang['<b>%d</b> albums found'] = '<b>%d</b> Alben gefunden';
$lang['<b>%d</b> tag selected'] = '<b>%d</b> Suchbegriff ausgewählt';
$lang['<b>%d</b> tag found'] = '<b>%d</b> Suchbegriff gefunden';
$lang['<b>%d</b> tags found'] = '<b>%d</b> Suchbegriffe gefunden';
...
$lang[' (copy)'] = '(kopieren)';
$lang['The other tags will be removed'] = 'Die anderen Suchbegriffe werden entfernt';
...
$lang['Select all %d tags'] = 'Alle %d Suchbegriffe auswählen';
...
$lang['Tag "%s" created'] = 'Suchbegriff »%s« erstellt';
$lang['Tag "%s" succesfully deleted'] = 'Suchbegriff \»%s\« erfolgreich gelöscht';
$lang['Tag "%s1" renamed in "%s2"'] = 'Suchbegriff \"»%s1\« umbenannt in \»%s2\«';
$lang['Tag Manager'] = 'Suchbegriffsverwaltung';
$lang['Tag(s) \{%s1\} succesfully merged into "%s2"'] = 'Suchbegriff(e) \{%s1\} wurde(n) erfolgreich in »%s2« zusammengeführt';
$lang['Tags \{%s\} succesfully deleted'] = 'Suchbegriffe \{%s\} erfolgreich gelöscht';
$lang['The %d tags on this page are selected'] = 'Die Suchbegriffe %d auf dieser Seite sind ausgewählt';
...
$lang['Manage album photos'] = 'Albumfotos verwalten';
$lang['Manage sub-albums'] = 'Unteralben verwalten';
$lang['Manage users with user manager'] = 'Verwalten von Benutzern mit der Benutzerverwaltung';
...
$lang['No tag found'] = 'Kein Suchbegriff gefunden';
...
$lang['Cache'] = 'Cache';
$lang['Choose which tag to merge these tags into'] = 'Wählen Sie, in welchem Suchbegriff diese Suchbegriffe zusammengeführt werden sollen';
$lang['Clear Selection'] = 'Auswahl löschen';
$lang['Compare mode'] = 'Vergleichsmodus';
$lang['Created on %s'] = 'Erstellt am %s';
$lang['Delete album'] = 'Album löschen';
$lang['Delete orphan tags ?'] = 'Verwaiste Suchbegriffe löschen?';
$lang['Delete tag "%s"?'] = 'Suchbegriff "%s" löschen?';
$lang['Delete tags \{%s\}?'] = 'Suchbegriffe löschen \{%s\}?';
...
$lang['No research in progress'] = 'Keine Neusuche in Gange';
$lang['No search in progress'] = 'Keine Suche in Gange';
$lang['Object'] = 'Objekt';
...
$lang['Show plugins compatible with previous version of Piwigo'] = 'Plugins anzeigen welche mit früheren Versionen von Piwigo kompatibel sind';
...
// + mic 2023.09
$lang['Posted the %s'] = 'Veröffentlicht am %s';
$lang['Visit history'] = 'Verlauf ansehen';
$lang['Allow comments for sub-albums'] = 'Kommentare für Unteralben erlaubt';
$lang['Disallow comments for sub-albums'] = 'Kommentare für Unteralben nicht erlaubt';
$lang['%d including sub-albums'] = 'Inklusive %d Unteralben';
$lang['%d in whole branch'] = '%d in allen Alben';
$lang['Created'] = 'Erstellt';
$lang['Modified'] = 'Geändert';
$lang['Locked album'] = 'Album ist gesperrt';
$lang['Activate button "%s"'] = 'Button "%s" aktivieren';
