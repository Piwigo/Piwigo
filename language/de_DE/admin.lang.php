...
$lang['The %d following tags were deleted'] = 'Die %d folgenden Stichworte wurden gelöscht';
...
$lang['manage sub-albums'] = 'verwalten Sie die Unteralben';
...
$lang['The webmaster has unsubscribed you from receiving notifications by mail.'] = 'Der Webmaster hat dich für die E-Mail-Benachrichtigung ausgetragen';
...
$lang['Warning: subscribing or unsubscribing will send mails to users'] = 'WARNUNG: Hinzufügen oder Entfernen von Benutzern zur Mailingliste erwirkt eine automatische E-Mail an den Betreffenden';
...
$lang['The file or directory cannot be accessed (either it does not exist or the access is denied)'] = 'Auf diese Datei/diesen Ordner kann nicht zugegriffen werden. (Entweder existiert sie/er nicht oder der Zugriff wurde verweigert)';
...
$lang['directories + files'] = 'Ordner + Dateien';
...
$lang['The name of directories and files must be composed of letters, numbers, "-", "_" or "."'] = 'Ordner- und Dateinamen müssen aus Buchstaben oder den Zeichen "-", "_" oder "." bestehen';
...
$lang['%d anomalies have been detected corrected.'] = '%d Anomalien wurden behoben.';
...
$lang['You might go to plugin list to install and activate it.'] = 'Gehen Sie zur "Liste der Plugins", um installierte Plugins zu aktivieren.';
...
$lang['Please check "plugins" folder and sub-folders permissions (CHMOD).'] = 'Überprüfen Sie die Zugriffsrechte des Ordners "plugins" und seiner Unterordner (CHMOD).';
...
$lang['Photos'] = 'Fotos';
$lang['Themes'] = 'Themen';
$lang['Instructions to use Piwigo'] = 'Instruktionen, um Piwigo zu benutzen';
...
$lang['Create the "%s" directory at the root of your Piwigo installation'] = 'Erstelle den "%s" Ordner im Hauptordner (root) Ihrer Piwigo-Installation';
$lang['Give write access (chmod 777) to "%s" directory at the root of your Piwigo installation'] = 'Geben Sie dem Ordner "%s" im Hauptordner (root) Ihrer Piwigo-Installation Schreibrechte (chmod 777)';
...
$lang['Delete orphan tags'] = 'Lösche nicht benutzte Stichworte';
$lang['delete photo'] = 'lösche Foto';
$lang['Orphan tags deleted'] = 'Nicht benutzte Stichworte wurden gelöscht';
$lang['Week starts on'] = 'Die Woche beginnt mit';
$lang['You have %d orphan tags: %s.'] = 'Sie haben %d nicht benutzte Stichworte: %s.';
$lang['Remove from caddie'] = 'Vom Sammelkorb entfernen';
$lang['Themes which need upgrade'] = 'Themen, die aktualisiert werden müssen';
$lang['Languages which need upgrade'] = 'Sprachen, die ein Update brauchen';
...
$lang['By default, Piwigo will create a new websize from the HD (high definition) version of your photo.'] = 'Standardmäßig erstellt Piwigo eine für das Web optimierete Ansicht der HD-Version (hochaufgelösten Version) Ihres Fotos.';
...
$lang['Merge selected tags'] = 'Gewählte Stichworte zusammenführen';
$lang['Merge tags'] = 'Stichworte zusammenführen';
$lang['No destination tag selected'] = 'Kein Ziel-Stichwort gewählt';
$lang['Photo %s of %s'] = 'Bild %s of %s';
$lang['Select an album'] = 'Wähle ein Album';
$lang['Select at least two tags for merging'] = 'Wähle wenigstens 2 Stichworte zum Zusammenführen';
...
$lang['Add tags'] = 'Stichwort hinzufügen';
...
$lang['digiKam is an advanced digital photo management free software for Linux, Windows, and MacOSX.'] = 'digiKam ist ein fortschrittliches Bildverwaltungsprogramm für Linux, Windows und MacOSX. digikam ist freie Software.';
