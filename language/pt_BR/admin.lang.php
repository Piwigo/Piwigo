...
$lang['Include history data (Warning: server memory limit may be exceeded)'] = 'Inclua dados do histórico (Cuidado: limite de memória do servidor poderá ser ultrapassado).';
...
$lang['No tag selected, no action possible.'] = 'Nenhuma etiqueta selecionada, nenhuma ação possível.';
