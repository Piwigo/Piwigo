...
$lang['To be sure, please rewrite the word “%s” below'] = 'Para ter certeza, reescreva a palavra “%s” abaixo';
$lang['To set your password, visit the following address:'] = 'Para definir sua senha, visite o seguinte endereço:';
$lang['Username successfully modified'] = 'Nome de usuário modificado com sucesso';
$lang['Welcome to %s'] = 'Bem-vindo ao %s';
$lang['What\'s new in version %s'] = 'O que há de novo na versão %s?';
$lang['Yes, let\'s proceed'] = 'Sim, vamos prosseguir';
$lang['You are about to set %s as main user instead of %s, do you wish to continue ?'] = 'Você está prestes a definir %s como usuário principal em vez de %s, deseja continuar?';
$lang['You are not authorised to change the main user, please ask your webmaster'] = 'Você não está autorizado a alterar o usuário principal, pergunte ao seu webmaster';
$lang['You can now change the main user from %s to %s.'] = 'Agora você pode alterar o usuário principal de %s para %s.';
$lang['You cannot copy the password if the connection to this site is not secure.'] = 'Você não pode copiar a senha se a conexão com este site não for segura.';
$lang['%s is the new main user'] = '%s é o novo usuário principal';
$lang['A photo library administrator has created the following account for you:'] = 'Um administrador de biblioteca de fotos criou a seguinte conta para você:';
$lang['An activation link valid for %s has been sent to "%s". If the user doesn\'t receive the link, you can generate and copy a new one by editing the user and managing her password.'] = 'Um link de ativação válido para %s foi enviado para "%s". Se o link não for recebido, um novo pode ser gerado e copiado editando o usuário e gerenciando sua senha.';
$lang['An activation link valid for %s was created but could not be sent. You can now copy the link below and send it to the user.'] = 'Um link de ativação válido para %s foi criado, mas não pôde ser enviado. Agora você pode copiar o link abaixo e enviá-lo ao usuário.';
$lang['Cannot send an email to this user because he doesn\'t have an email address'] = 'Não é possível enviar um e-mail para este usuário porque ele não tem um endereço de e-mail';
$lang['Changing the main user'] = 'Alterando o usuário principal';
$lang['Copied link'] = 'Link copiado';
$lang['Copy password'] = 'Copiar senha';
$lang['Copy the link below and send it to the user so the password can be set.'] = 'Copie o link abaixo e envie ao usuário para que a senha possa ser definida.';
$lang['Copy the password link'] = 'Copie o link da senha';
$lang['Main user'] = 'Usuário principal';
$lang['Ok, got it!'] = 'Ok, entendi!';
$lang['Password copied'] = 'Senha copiada';
$lang['Please complete all fields'] = 'Por favor, preencha todos os campos';
$lang['Read the release note'] = 'Leia a nota de lançamento';
$lang['Resend password link'] = 'Reenviar link de senha';
$lang['Set as main user'] = 'Definir como usuário principal';
$lang['The passwords do not match'] = 'As senhas não correspondem';
$lang['This link is valid for %s. After this time, you will need to request a new link.'] = 'Este link é válido por %s. Após esse tempo, você precisará solicitar um novo link.';
$lang['This user must first be defined as the webmaster before it can be upgraded to the main user'] = 'Este usuário deve primeiro ser definido como webmaster antes de poder ser atualizado para o usuário principal';
$lang['When enabled, a common template is used for the login, registration and forgotten password pages, regardless of the theme. Some themes might use these templates even if you uncheck this option'] = 'Quando ativado, um modelo comum (padrão) é usado para as páginas de login, registro e senha esquecida, independentemente do tema em uso. Alguns temas podem usar esses modelos mesmo se você desmarcar esta opção.';
$lang['Use standard Piwigo template for common pages.'] = 'Use o padrão (template) do Piwigo para páginas comuns.';
...
$lang['Save all photos'] = 'Salvar todas as fotos';
$lang['No comments selected, no actions possible.'] = 'Nenhum comentário selecionado, nenhuma ação é possível.';
$lang['Are you sure you want to delete comment #%s?'] = 'Tem certeza de que deseja excluir o comentário #%s?';
$lang['Are you sure you want to delete "%d" comments?'] = 'Tem certeza de que deseja excluir "%d" comentários?';
$lang['We have found %d duplicate paths. Details provided by plugin Check Uploads'] = 'Encontramos %d caminhos duplicados. Detalhes fornecidos pelo plugin "Checkup Uploads".';
$lang['There is currently %d photos in the lounge (upload buffer)'] = 'Faltam %d fotos para carregar (relação de upload)';
...
$lang['Use custom logo (png, jpeg or svg)'] = 'Use um logotipo personalizado (png, jpeg ou svg)';
$lang['Use Piwigo logo'] = 'Use Piwigo logo';
$lang['Standard pages header'] = 'Cabeçalho de páginas padrão';
$lang['Standard pages aren\'t activated, however you have %d active themes that will still use them. These themes are:'] = 'As páginas padrão não estão ativadas, porém você tem %d temas ativos que ainda as utilizarão. Esses temas são:';
$lang['Standard pages'] = 'Páginas padrão';
$lang['Select a color theme for standard pages'] = 'Selecione um tema de cores para as páginas padrão.';
