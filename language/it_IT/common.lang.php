...
$lang['display most visited pictures'] = 'mostra le foto più viste';
...
$lang['mail address must be like xxx@yyy.eee (example : jack@altern.org)'] = 'l\'indirizzo email deve essere del tipo xxx@yyy.eee (ad esempio: jack@altern.org)';
...
$lang['Search for Author'] = 'Cercare per Autore';
...
$lang['Bad status for user "guest", using default status. Please notify the webmaster.'] = 'Lo stato dell\'utente "guest" non è conforme, viene usato lo stato di default. Vogliate avvertire il webmaster.';
...
$lang['a user use already this mail address'] = 'un utente usa già questo indirizzo email';
