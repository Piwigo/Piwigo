...
$lang['Accelerate diaporama speed'] = 'Accelera la proiezione';
...
$lang['Change my password'] = 'Cambia la mia password';
...
$lang['Click here if your browser does not automatically forward you'] = 'Clicca qui se non sei reindirizzato automaticamente';
...
$lang['Cookies are blocked or not supported by your browser. You must enable cookies to connect.'] = 'I cookies sono bloccati o non supportati dal tuo browser. Attiva i cookie per connetterti.';
...
$lang['group by letters'] = 'raggruppare per lettera';
$lang['guest'] = 'ospite';
...
$lang['If this was a mistake, just ignore this email and nothing will happen.'] = 'Se si tratta di un errore, ignorare questa email: la richiesta non sarà presa in considerazione.';
$lang['in %d sub-album'] = 'nel sub-album %d';
$lang['in %d sub-albums'] = 'nel sub-album %d';
...
$lang['stop the slideshow'] = 'fermare lo slideshow';
...
$lang['Albums listed here match your search by word. Click on one to browse by album.'] = 'Gli album in questa lista corrispondono alla tua ricerca per parola. Clicca su uno di questi per navigarlo.';
...
$lang['Pre-established filters are proposed, but you can add or remove them using the "Choose filters" button.'] = 'Vengono proposti filtri preimpostati, ma puoi aggiungerne o cancellarne utilizzando il pulsante "Scegli filtro".';
$lang['Search in :'] = 'Cerca in:';
$lang['Search in this set'] = 'Cerca in questo set';
$lang['Tags found'] = 'Tag trovati';
$lang['Tags listed here match your search by word. Click on one to browse by tag.'] = 'I tag elencati qui corrispondono alla parola da te cercata. Clicca su uno di questi per navigarlo.';
...
$lang['There are no creation dates available for the photos currently filtered'] = 'Non ci sono date di creazione disponibili per le fotografie al momento filtrate';
