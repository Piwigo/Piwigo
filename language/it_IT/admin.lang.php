...
$lang['Repair and optimize database'] = 'Riparare o ottimizzare il database';
...
$lang['categories deleted in the database'] = 'categorie eliminate dal database';
...
$lang['categories added in the database'] = 'categorie aggiunte nel database';
...
$lang['The anomaly will be ignored until next application version'] = 'L\'anomalia verr� ignorata fino alla prossima versione dell\'applicazione';
$lang['Correction the anomaly will cancel the fact that it\'s ignored'] = 'La correzione dell\'anomalia annuler� il fatto che sia ignorata';
...
$lang['Keep in touch with Piwigo project, subscribe to Piwigo Announcement Newsletter. You will receive emails when a new release is available (sometimes including a security bug fix, it\'s important to know and upgrade) and when major events happen to the project. Only a few emails a year.'] = 'Rimanete in contatto con il progetto Piwigo, iscrivetevi alla neswletter di Piwigo Announcement. Riceverete un\'email quando una nuova versione sar� disponibile (a volte un bug di sicurezza viene corretto, è importante saperlo e quind aggiornare) e quando capita di grandi eventi del progetto. Solo alcune emails all\'anno';
