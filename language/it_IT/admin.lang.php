...
$lang['Add a user'] = 'Aggiungi un utente';
$lang['Add group'] = 'Aggiungi gruppo';
$lang['Add'] = 'Aggiungi';
$lang['Allow user registration'] = 'Consenti registrazione di nuovi utenti';
...
$lang['Delete Representant'] = 'Elimina la copertina album';
$lang['Delete selected tags'] = 'Elimina i tag selezionati';
$lang['Delete selected users'] = 'Elimina gli utenti selezionati';
...
$lang['Edit selected tags'] = 'Modifica i tag selezionati';
$lang['Edit tags'] = 'Modifica i tag';
$lang['Email admins when a new user registers'] = 'Invia email agli amministratori dell\'iscrizione di un nuovo utente';
$lang['Email admins when a valid comment is entered'] = 'Invia email agli amministratori della presenza di un nuovo commento';
...
$lang['Manage tags'] = 'Gestisci i tag';
$lang['Members'] = 'Membri';
...
$lang['The permalink name must be composed of a-z, A-Z, 0-9, "-", "_" or "/". It must not be numeric or start with number followed by "-"'] = 'Il permalink deve essere composto unicamente dai caratteri seguenti a-z A-Z 0-9, "-", "_" o "/". Non deve essere numerico o iniziare con un numero seguito da "-"';
...
$lang['You need to confirm deletion'] = 'Dovete confermare l\'eliminazione';
...
$lang['Lock albums'] = 'Blocca gli album';
...
$lang['Date'] = 'Data';
$lang['delete album'] = 'elimina l\'album';
...
$lang['High definition enabled'] = 'Permetti download';
$lang['File'] = 'File';
...
$lang['Send mail as'] = 'Invia l\'email come';
...
$lang['Available only with HTML format'] = 'Disponibile solamente con il formato HTML';
...
$lang['created'] = 'creato';
$lang['delete this site and all its attached elements'] = 'elimina questo sito e tutte le informazioni relative';
$lang['an error happened'] = 'si è verificato un\'errore';
$lang['Local'] = 'Locale';
$lang['Remote'] = 'Remoto';
$lang['update the database from files'] = 'aggiornare il database con i file';
$lang['status'] = 'stato';
...
$lang['Edit album'] = 'Modifica album';
$lang['Group management'] = 'Gestione gruppi';
$lang['User list'] = 'Elenco utenti';
$lang['Database synchronization with files'] = 'Sincronizzazione database con i file';
$lang['all'] = 'tutto';
...
$lang['unit mode'] = 'Modalità singola';
$lang['Unlocked'] = 'Sbloccati';
$lang['unset'] = 'svuota';
...
$lang['synchronize files structure with database'] = 'Sincronizza la struttura dei file con il database';
$lang['synchronize files metadata with database photos informations'] = 'sincronizza il database delle foto con i metadati dei file';
$lang['even already synchronized photos'] = 'anche le foto già sincronizzate';
$lang['Used metadata'] = 'Metadati usati';
$lang['The name of directories and files must be composed of letters, numbers, "-", "_" or "."'] = 'Il nome delle directory e dei file deve essere composto da lettere, numeri, "-", "_" o "."';
...
$lang['%d anomalies have been detected corrected.'] = '%d anomalie individuate e corrette.';
...
$lang['%s value is not correct file because exif are not supported'] = 'Il valore %s non è corretto perchè i file con dati EXIF non sono supportati';
...
$lang['Plugins which need upgrade'] = 'Plugin da aggiornare';
$lang['Plugin list'] = 'Elenco dei plugin';
$lang['Check for updates'] = 'Controlla aggiornamenti';
$lang['Other plugins'] = 'Altri plugin disponibili';
$lang['Last revisions'] = 'Ultimi aggiornamenti';
$lang['Are you sure you want to delete this plugin?'] = 'Siete sicuri di volere eliminare questo plugin?';
...
$lang['You are running the latest version of Piwigo.'] = 'Stai già usando l\'ultima versione di Piwigo.';
...
$lang['You need to upgrade your system to take full advantage of the application else the application will not work correctly, or not at all'] = 'Dovete aggiornare il vostro sistema per poter sfruttare completamente l\'applicazione, altrimenti questa non funzionerà correttamente, o non funzionerà affatto';
...
$lang['nothing'] = 'niente';
$lang['overrides existing values with empty ones'] = 'Sovrascrivi i valori esistenti con valori vuoti';
...
$lang['Allow users to edit their own comments'] = 'Permetti agli utenti di modificare i propri commenti';
$lang['Allow users to delete their own comments'] = 'Permetti agli utenti di eliminare i propri commenti';
...
$lang['Cannot delete the old permalink !'] = 'Non è possibile eliminare il vecchio permalink!';
$lang['Hit'] = 'Punteggio';
$lang['Tools'] = 'Tools';
$lang['Photos'] = 'Foto';
$lang['Themes'] = 'Temi';
...
$lang['Upload Photos'] = 'Carica foto';
...
$lang['Select files'] = 'Seleziona file';
...
$lang['Delete this theme'] = 'Elimina questo tema';
...
$lang['Impossible to delete this theme. Other themes depends on it: %s'] = 'Impossibile eliminare questo tema. Altri temi dipendono da esso: %s';
...
$lang['Start pLoader and add your photos.'] = 'Avvia pLoader e aggiungi le foto.';
$lang['Switch to clear or dark colors for administration'] = 'Tema chiaro o scuro per l\'amministrazione';
...
$lang['Uninstalled Plugins'] = 'Plugin disinstallati';
$lang['By %s'] = 'Da %s';
$lang['Visit plugin site'] = 'Visita il sito del plugin';
$lang['Active Languages'] = 'Lingue attivate';
$lang['Delete this language'] = 'Elimina questa lingua';
...
$lang['In your php.ini file, the upload_max_filesize (%sB) is bigger than post_max_size (%sB), you should change this setting'] = 'Nel vostro file php.ini, la variabile upload_max_filesize (%sB) è più grande di post_max_size (%sB), dovreste modificare questa impostazione';
...
$lang['Batch Manager'] = 'Gestione massiva';
...
$lang['Add a filter'] = 'Aggiungi un filtro';
...
$lang['remove title'] = 'elimina titolo';
...
$lang['You have %d orphan tags: %s.'] = 'Avete %d tag orfani: %s.';
$lang['Delete orphan tags'] = 'Elimina i tag orfani';
...
$lang['Obsolete Plugins'] = 'Plugin obsoleti';
...
$lang['Activate icon "new" next to albums and pictures'] = 'Visualizza l\'icona "nuovo" a fianco degli album e delle foto';
$lang['You can\'t define a default photo order because you have a custom setting in your local configuration.'] = 'Non puoi impostare l\'ordine predefinito delle foto perché c\'è un\'impostazione personalizzata nella configurazione locale.';
...
$lang['Approximate maximum resolution: %dM pixels (that\'s %dx%d pixels).'] = 'Risoluzione massima approssimativa: %dM pixel (sia %dx%d pixel)';
$lang['Manage Permissions'] = 'Gestisci i permessi';
$lang['Photo %s of %s'] = 'Foto %s su %s';
$lang['show details'] = 'mostra dettagli';
...
$lang['Tags <em>%s</em> merged into tag <em>%s</em>'] = 'I tag <em>%s</em> sono stati uniti nel tag <em>%s</em>';
...
$lang['Save visits in history for'] = 'Salva storia delle visite per ';
...
$lang['cancel manual order'] = 'annulla l\'ordinamento manuale';
$lang['Cancel'] = 'Annulla';
$lang['List'] = 'Lista';
...
$lang['Delete multiple size images'] = 'Elimina immagini con dimensioni multiple';
...
$lang['Ratio'] = 'Rapporto';
$lang['between %d and %d pixels'] = 'tra %d e %d pixel';
...
$lang['Storage used'] = 'Memoria utilizzata';
$lang['Dashboard'] = 'Dashboard';
$lang['checksum'] = 'checksum';
$lang['delete album and all %d photos, even the %d associated to other albums'] = 'elimina l\'album et tutte le %d foto, comprese le %d associate ad altri album';
$lang['delete only album, not photos'] = 'elimina solo l\'album, e non le foto';
$lang['orphans to delete'] = 'orfane da eliminare';
$lang['delete album and the %d orphan photos'] = 'elimina l\'album e le %d immagini orfane';
...
$lang['Delete album "%s" and its %d sub-albums.'] = 'Elimina l\'album "%s" e i suoi %d sub-album.';
$lang['It only takes a few clicks.'] = 'Ciò si fa in pochi click';
$lang['Delete album "%s".'] = 'Elimina l\'album "%s"';
...
$lang['Album search tool'] = 'Strumento di ricerca album';
$lang['Are you sure you want to delete all sizes?'] = 'Sei sicuro di voler eliminare tutte le dimensioni?';
...
$lang['Are you sure you want to delete the ratings of the user "%s"?'] = 'Sei sicuro di voler eliminare i giudizi dell\'utente "%s"?';
...
$lang['Are you sure you want to delete this site?'] = 'Sei sicuro di voler eliminare questo sito?';
...
$lang['Are you sure you want to delete this theme?'] = 'Sei sicuro di voler eliminare questo tema?';
$lang['Are you sure you want to delete this?'] = 'Sei sicuro di volerlo eliminare?';
...
$lang['Display'] = 'Visualizza';
$lang['Displays a banner to install or open the official Piwigo app'] = 'Visualizza un banner per installare e/o aprire l\'App ufficiale di Piwigo';
...
$lang['Please upgrade your PHP version before any update.'] = 'Dovrai aggiornare PHP prima di poter aggiornare Piwigo.';
...
$lang['%d users added'] = '%d utenti aggiunti';
$lang['%d users edited'] = '%d utenti editati';
$lang['%d users logged in'] = '%d utenti connessi';
$lang['%d users logged out'] = '%d utenti disconnessi';
...
$lang['Users not logged in will have these settings applied, these settings are used by default for new users'] = 'Gli utenti non connessi avranno queste impostazioni applicate, queste impostazioni sono utilizzate per default per i nuovi utenti';
$lang['Upload Formats'] = 'Formati caricamento';
...
$lang['Place last'] = 'Metti alla fine';
$lang['Place first'] = 'Metti all\'inizio';
...
$lang['Locked albums are disabled for maintenance. Only administrators can view them in the gallery. Lock this album will also lock his Sub-albums'] = 'Gli album si possono bloccare per la manutenzione. Solo gli amministratori possono vederli nella galleria. Il blocco di questo album bloccherà anche i sub-album.';
...
$lang['Some photos are missing from your file system. Details provided by plugin Check Uploads'] = 'Alcune fotografie sono scomparse dal tuo file System. Dettagli forniti dal plugin Controlla Caricamenti.';
...
$lang['Comments allowed for sub-albums'] = 'Commenti consentiti per sotto-album.';
$lang['Comments disallowed for sub-albums'] = 'Commenti non permessi per sotto-album.';
$lang['Created'] = 'Creato';
$lang['Detect and avoid duplicates during upload'] = 'Individua ed evita duplicati nel corso del caricamento.';
$lang['Disallow comments for sub-albums'] = 'Non permettere commenti per sotto-album.';
...
$lang['Change logo'] = 'Cambio logo';
$lang['Dark mode'] = 'Modalità scura';
$lang['Display Gallery title'] = 'Mostra il titolo della galleria';
$lang['Light mode'] = 'Modalità chiara';
$lang['Personalization settings'] = 'Impostazioni personalizzate';
$lang['Select a color theme for standard pages'] = 'Seleziona una colorazione tematica per le pagine standard';
$lang['Standard pages'] = 'Pagine standard';
$lang['Standard pages aren\'t activated, however you have %d active themes that will still use them. These themes are:'] = 'Le pagine standard non sono attivate, comunque hai %d temi attivi che ancora le utilizzeranno. Tali temi sono:';
$lang['Standard pages header'] = 'Intestazione delle pagine standard';
$lang['Use Piwigo logo'] = 'Utilizza il logo di Piwigo';
$lang['Use custom logo (png, jpeg or svg)'] = 'Utilizza logo personalizzato (png, jpeg o svg)';
$lang['Follow the update guide'] = 'Segui la guida sull\'aggiornamento';
$lang['Two container updates are available'] = 'Sono disponibili due aggiornamenti del container';
$lang['You are about to delete %s groups, are you sure?'] = 'Stai per eliminare %s gruppi, sei sicuro?';