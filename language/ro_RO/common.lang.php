...
$lang['Tag'] = 'Etichetă';
$lang['Tags'] = 'Etichete';
$lang['The RSS notification feed provides notification on news from this website : new photos, updated albums, new comments. Use a RSS feed reader.'] = 'Notificarea RSS feed prevede notificarea cu privire la noutăţile din acest site: poze noi, categorii actualizate, noi comentarii. Folosiţi un RSS feed reader.';
...
$lang['display this album'] = 'prezintă imagini de la rădăcina acestei categorii';
...
$lang['Maximum photo height'] = 'Înălţimea maximă a imaginii';
$lang['Maximum height must be a number superior to 50'] = 'Înălţimea maximă trebuie să fie mai mare de 50';
$lang['Maximum photo width'] = 'Lăţimea maximă a imaginilor';
...
$lang['display all photos in all sub-albums'] = 'afişează toate elementele în toate sub-categoriile';
...
$lang['The number of photos per row must be a not null scalar'] = 'Numărul de imagini pe linie trebuie să fie un număr întreg nenul';
$lang['Number of photos per row'] = 'Numărul de miniaturi pe linie';
...
$lang['Photos posted within the last %d day.'] = 'Elemente postate în ultima %d zi.';
$lang['Photos posted within the last %d days.'] = 'Elemente postate în ultimele %d zile.';
...
$lang['%d photo is also linked to current tags'] = '%d Imaginea este de asemenea legată de etichetele actuale';
